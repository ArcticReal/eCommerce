...
public class DeleteDataResourceAttribute extends Command {

private String toBeDeletedId;
public DeleteDataResourceAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("DataResourceAttribute", UtilMisc.toMap("dataResourceAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new DataResourceAttributeDeleted(success);
