...
public class DeleteContentRole extends Command {

private String toBeDeletedId;
public DeleteContentRole(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ContentRole", UtilMisc.toMap("contentRoleId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ContentRoleDeleted(success);
