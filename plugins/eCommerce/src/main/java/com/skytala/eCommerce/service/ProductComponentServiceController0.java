...
@RestController
@RequestMapping("/service/ProductComponentController0")
public class ProductComponentServiceController0{
	...
	public ResponseEntity<Object> createFeaturePrice(HttpSession session, @RequestParam(value="currencyUomId") String currencyUomId, @RequestParam(value="price") BigDecimal price, @RequestParam(value="productPriceTypeId") String productPriceTypeId, @RequestParam(value="fromDate", required=false) Timestamp fromDate, @RequestParam(value="lastModifiedByUserLogin", required=false) String lastModifiedByUserLogin, @RequestParam(value="createdDate", required=false) Timestamp createdDate, @RequestParam(value="lastModifiedDate", required=false) Timestamp lastModifiedDate, @RequestParam(value="productFeatureId", required=false) String productFeatureId, @RequestParam(value="createdByUserLogin", required=false) String createdByUserLogin, @RequestParam(value="thruDate", required=false) Timestamp thruDate) {
