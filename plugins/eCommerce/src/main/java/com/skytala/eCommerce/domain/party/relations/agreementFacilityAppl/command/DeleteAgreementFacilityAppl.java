...
public class DeleteAgreementFacilityAppl extends Command {

private String toBeDeletedId;
public DeleteAgreementFacilityAppl(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("AgreementFacilityAppl", UtilMisc.toMap("agreementFacilityApplId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new AgreementFacilityApplDeleted(success);
