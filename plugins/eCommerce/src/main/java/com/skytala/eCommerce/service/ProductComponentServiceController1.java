...
@RestController
@RequestMapping("/service/ProductComponentController1")
public class ProductComponentServiceController1{
	...
	public ResponseEntity<Object> createInventoryItemLabelAppl(HttpSession session, @RequestParam(value="inventoryItemId") String inventoryItemId, @RequestParam(value="inventoryItemLabelId") String inventoryItemLabelId, @RequestParam(value="inventoryItemLabelTypeId") String inventoryItemLabelTypeId, @RequestParam(value="sequenceNum", required=false) long sequenceNum) {
	...
	public ResponseEntity<Object> createFacilityContactMechPurpose(HttpSession session, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="facilityId") String facilityId, @RequestParam(value="contactMechPurposeTypeId") String contactMechPurposeTypeId, @RequestParam(value="contactMechId") String contactMechId) {
	...
	public ResponseEntity<Object> updateInventoryItem(HttpSession session, @RequestParam(value="inventoryItemId") String inventoryItemId, @RequestParam(value="softIdentifier", required=false) long softIdentifier, @RequestParam(value="binNumber", required=false) String binNumber, @RequestParam(value="oldAvailableToPromise", required=false) BigDecimal oldAvailableToPromise, @RequestParam(value="quantityOnHandTotal", required=false) BigDecimal quantityOnHandTotal, @RequestParam(value="datetimeManufactured", required=false) Timestamp datetimeManufactured, @RequestParam(value="expireDate", required=false) Timestamp expireDate, @RequestParam(value="oldQuantityOnHand", required=false) BigDecimal oldQuantityOnHand, @RequestParam(value="partyId", required=false) String partyId, @RequestParam(value="containerId", required=false) String containerId, @RequestParam(value="availableToPromiseTotal", required=false) BigDecimal availableToPromiseTotal, @RequestParam(value="inventoryItemTypeId", required=false) String inventoryItemTypeId, @RequestParam(value="locationSeqId", required=false) String locationSeqId, @RequestParam(value="facilityId", required=false) String facilityId, @RequestParam(value="comments", required=false) String comments, @RequestParam(value="serialNumber", required=false) long serialNumber, @RequestParam(value="productId", required=false) String productId, @RequestParam(value="lotId", required=false) String lotId, @RequestParam(value="uomId", required=false) String uomId, @RequestParam(value="accountingQuantityTotal", required=false) BigDecimal accountingQuantityTotal, @RequestParam(value="ownerPartyId", required=false) String ownerPartyId, @RequestParam(value="activationValidThru", required=false) Timestamp activationValidThru, @RequestParam(value="activationNumber", required=false) long activationNumber, @RequestParam(value="currencyUomId", required=false) String currencyUomId, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="unitCost", required=false) BigDecimal unitCost, @RequestParam(value="datetimeReceived", required=false) Timestamp datetimeReceived) {
	...
	public ResponseEntity<Object> updateInventoryItemLabel(HttpSession session, @RequestParam(value="inventoryItemLabelId") String inventoryItemLabelId, @RequestParam(value="inventoryItemLabelTypeId", required=false) String inventoryItemLabelTypeId, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Object> updateInventoryItemLabelAppl(HttpSession session, @RequestParam(value="inventoryItemId") String inventoryItemId, @RequestParam(value="inventoryItemLabelTypeId") String inventoryItemLabelTypeId, @RequestParam(value="inventoryItemLabelId", required=false) String inventoryItemLabelId, @RequestParam(value="sequenceNum", required=false) long sequenceNum) {
