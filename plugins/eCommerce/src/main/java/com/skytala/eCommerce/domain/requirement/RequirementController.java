package com.skytala.eCommerce.domain.requirement;
...
import com.skytala.eCommerce.domain.requirement.command.AddRequirement;
import com.skytala.eCommerce.domain.requirement.command.DeleteRequirement;
import com.skytala.eCommerce.domain.requirement.command.UpdateRequirement;
import com.skytala.eCommerce.domain.requirement.event.RequirementAdded;
import com.skytala.eCommerce.domain.requirement.event.RequirementDeleted;
...
import com.skytala.eCommerce.domain.requirement.query.FindRequirementsBy;
...
public class RequirementController {
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{requirementId}")
