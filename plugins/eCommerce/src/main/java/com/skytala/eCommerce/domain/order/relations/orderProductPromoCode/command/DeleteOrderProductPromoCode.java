...
public class DeleteOrderProductPromoCode extends Command {

private String toBeDeletedId;
public DeleteOrderProductPromoCode(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderProductPromoCode", UtilMisc.toMap("orderProductPromoCodeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderProductPromoCodeDeleted(success);
