package com.skytala.eCommerce.domain.product.relations.productGeo;
...
import com.skytala.eCommerce.domain.product.relations.productGeo.command.AddProductGeo;
import com.skytala.eCommerce.domain.product.relations.productGeo.command.DeleteProductGeo;
import com.skytala.eCommerce.domain.product.relations.productGeo.command.UpdateProductGeo;
import com.skytala.eCommerce.domain.product.relations.productGeo.event.ProductGeoAdded;
import com.skytala.eCommerce.domain.product.relations.productGeo.event.ProductGeoDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productGeo.query.FindProductGeosBy;
