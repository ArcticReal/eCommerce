package com.skytala.eCommerce.domain.order.relations.custRequestParty;
...
import com.skytala.eCommerce.domain.order.relations.custRequestParty.command.AddCustRequestParty;
import com.skytala.eCommerce.domain.order.relations.custRequestParty.command.DeleteCustRequestParty;
import com.skytala.eCommerce.domain.order.relations.custRequestParty.command.UpdateCustRequestParty;
import com.skytala.eCommerce.domain.order.relations.custRequestParty.event.CustRequestPartyAdded;
import com.skytala.eCommerce.domain.order.relations.custRequestParty.event.CustRequestPartyDeleted;
import com.skytala.eCommerce.domain.order.relations.custRequestParty.event.CustRequestPartyFound;
import com.skytala.eCommerce.domain.order.relations.custRequestParty.event.CustRequestPartyUpdated;
...
import com.skytala.eCommerce.domain.order.relations.custRequestParty.query.FindCustRequestPartysBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/custRequestPartys")
public class CustRequestPartyController {
	...
	public boolean updateCustRequestParty(HttpServletRequest request) throws Exception {
		...
		if (updateCustRequestParty(custRequestPartyToBeUpdated, null).getStatusCode()
...
//		custRequestPartyToBeUpdated.setnull(null);
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/custRequestParty/\" plus one of the following: "
				+ "";
