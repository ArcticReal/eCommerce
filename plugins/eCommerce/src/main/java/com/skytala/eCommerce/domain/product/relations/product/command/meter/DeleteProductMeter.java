...
public class DeleteProductMeter extends Command {

private String toBeDeletedId;
public DeleteProductMeter(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductMeter", UtilMisc.toMap("productMeterId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductMeterDeleted(success);
