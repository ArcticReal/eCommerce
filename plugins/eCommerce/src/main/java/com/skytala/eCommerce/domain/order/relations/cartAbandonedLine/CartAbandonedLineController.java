...
@RestController
@RequestMapping("/cartAbandonedLines")
...
//		cartAbandonedLineToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{cartAbandonedLineId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{cartAbandonedLineId}")
