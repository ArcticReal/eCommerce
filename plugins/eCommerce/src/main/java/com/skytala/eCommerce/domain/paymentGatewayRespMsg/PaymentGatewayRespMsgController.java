package com.skytala.eCommerce.domain.paymentGatewayRespMsg;
...
import com.skytala.eCommerce.domain.paymentGatewayRespMsg.command.AddPaymentGatewayRespMsg;
import com.skytala.eCommerce.domain.paymentGatewayRespMsg.command.DeletePaymentGatewayRespMsg;
import com.skytala.eCommerce.domain.paymentGatewayRespMsg.command.UpdatePaymentGatewayRespMsg;
import com.skytala.eCommerce.domain.paymentGatewayRespMsg.event.PaymentGatewayRespMsgAdded;
import com.skytala.eCommerce.domain.paymentGatewayRespMsg.event.PaymentGatewayRespMsgDeleted;
import com.skytala.eCommerce.domain.paymentGatewayRespMsg.event.PaymentGatewayRespMsgFound;
import com.skytala.eCommerce.domain.paymentGatewayRespMsg.event.PaymentGatewayRespMsgUpdated;
import com.skytala.eCommerce.domain.paymentGatewayRespMsg.mapper.PaymentGatewayRespMsgMapper;
import com.skytala.eCommerce.domain.paymentGatewayRespMsg.model.PaymentGatewayRespMsg;
import com.skytala.eCommerce.domain.paymentGatewayRespMsg.query.FindPaymentGatewayRespMsgsBy;
