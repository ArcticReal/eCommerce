package com.skytala.eCommerce.domain.product.relations.productFacility;
...
import com.skytala.eCommerce.domain.product.relations.productFacility.command.AddProductFacility;
import com.skytala.eCommerce.domain.product.relations.productFacility.command.DeleteProductFacility;
import com.skytala.eCommerce.domain.product.relations.productFacility.command.UpdateProductFacility;
import com.skytala.eCommerce.domain.product.relations.productFacility.event.ProductFacilityAdded;
import com.skytala.eCommerce.domain.product.relations.productFacility.event.ProductFacilityDeleted;
import com.skytala.eCommerce.domain.product.relations.productFacility.event.ProductFacilityFound;
import com.skytala.eCommerce.domain.product.relations.productFacility.event.ProductFacilityUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productFacility.query.FindProductFacilitysBy;
