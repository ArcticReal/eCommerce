...
@RestController
@RequestMapping("/zipSalesTaxLookups")
...
//		zipSalesTaxLookupToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{zipSalesTaxLookupId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{zipSalesTaxLookupId}")
