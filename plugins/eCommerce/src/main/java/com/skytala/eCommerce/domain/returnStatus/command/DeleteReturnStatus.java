...
public class DeleteReturnStatus extends Command {

private String toBeDeletedId;
public DeleteReturnStatus(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ReturnStatus", UtilMisc.toMap("returnStatusId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ReturnStatusDeleted(success);
