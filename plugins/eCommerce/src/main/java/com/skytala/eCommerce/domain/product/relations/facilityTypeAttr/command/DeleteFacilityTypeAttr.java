...
public class DeleteFacilityTypeAttr extends Command {

private String toBeDeletedId;
public DeleteFacilityTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("FacilityTypeAttr", UtilMisc.toMap("facilityTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new FacilityTypeAttrDeleted(success);
