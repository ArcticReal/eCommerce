...
@RestController
@RequestMapping("/electronicTexts")
...
//		electronicTextToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{electronicTextId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{electronicTextId}")
