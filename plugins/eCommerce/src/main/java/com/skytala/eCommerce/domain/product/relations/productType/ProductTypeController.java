package com.skytala.eCommerce.domain.product.relations.productType;
...
import com.skytala.eCommerce.domain.product.relations.productType.command.AddProductType;
import com.skytala.eCommerce.domain.product.relations.productType.command.DeleteProductType;
import com.skytala.eCommerce.domain.product.relations.productType.command.UpdateProductType;
import com.skytala.eCommerce.domain.product.relations.productType.event.ProductTypeAdded;
import com.skytala.eCommerce.domain.product.relations.productType.event.ProductTypeDeleted;
import com.skytala.eCommerce.domain.product.relations.productType.event.ProductTypeFound;
import com.skytala.eCommerce.domain.product.relations.productType.event.ProductTypeUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productType.query.FindProductTypesBy;
