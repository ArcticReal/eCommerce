...
public class DeleteAgreementAttribute extends Command {

private String toBeDeletedId;
public DeleteAgreementAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("AgreementAttribute", UtilMisc.toMap("agreementAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new AgreementAttributeDeleted(success);
