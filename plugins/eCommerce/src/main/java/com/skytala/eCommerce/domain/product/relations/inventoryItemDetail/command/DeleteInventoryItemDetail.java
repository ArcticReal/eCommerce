...
public class DeleteInventoryItemDetail extends Command {

private String toBeDeletedId;
public DeleteInventoryItemDetail(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("InventoryItemDetail", UtilMisc.toMap("inventoryItemDetailId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new InventoryItemDetailDeleted(success);
