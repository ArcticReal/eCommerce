...
//		orderShipmentToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{orderShipmentId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{orderShipmentId}")
