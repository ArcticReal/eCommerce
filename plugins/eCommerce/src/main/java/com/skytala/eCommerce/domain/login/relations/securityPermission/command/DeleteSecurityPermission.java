...
public class DeleteSecurityPermission extends Command {

private String toBeDeletedId;
public DeleteSecurityPermission(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("SecurityPermission", UtilMisc.toMap("securityPermissionId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new SecurityPermissionDeleted(success);
