...
public class DeleteRoleType extends Command {

private String toBeDeletedId;
public DeleteRoleType(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("RoleType", UtilMisc.toMap("roleTypeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new RoleTypeDeleted(success);
