package com.skytala.eCommerce.domain.content.relations.contentRevision;
...
import com.skytala.eCommerce.domain.content.relations.contentRevision.command.AddContentRevision;
import com.skytala.eCommerce.domain.content.relations.contentRevision.command.DeleteContentRevision;
import com.skytala.eCommerce.domain.content.relations.contentRevision.command.UpdateContentRevision;
import com.skytala.eCommerce.domain.content.relations.contentRevision.event.ContentRevisionAdded;
import com.skytala.eCommerce.domain.content.relations.contentRevision.event.ContentRevisionDeleted;
import com.skytala.eCommerce.domain.content.relations.contentRevision.event.ContentRevisionFound;
import com.skytala.eCommerce.domain.content.relations.contentRevision.event.ContentRevisionUpdated;
...
import com.skytala.eCommerce.domain.content.relations.contentRevision.query.FindContentRevisionsBy;
