package com.skytala.eCommerce.domain.accounting.relations.invoiceTypeAttr;
...
import com.skytala.eCommerce.domain.accounting.relations.invoiceTypeAttr.command.AddInvoiceTypeAttr;
import com.skytala.eCommerce.domain.accounting.relations.invoiceTypeAttr.command.DeleteInvoiceTypeAttr;
import com.skytala.eCommerce.domain.accounting.relations.invoiceTypeAttr.command.UpdateInvoiceTypeAttr;
import com.skytala.eCommerce.domain.accounting.relations.invoiceTypeAttr.event.InvoiceTypeAttrAdded;
import com.skytala.eCommerce.domain.accounting.relations.invoiceTypeAttr.event.InvoiceTypeAttrDeleted;
...
import com.skytala.eCommerce.domain.accounting.relations.invoiceTypeAttr.query.FindInvoiceTypeAttrsBy;
...
public class InvoiceTypeAttrController {
	...
	public boolean updateInvoiceTypeAttr(HttpServletRequest request) throws Exception {
		...
		if (updateInvoiceTypeAttr(invoiceTypeAttrToBeUpdated, null).getStatusCode()
...
//		invoiceTypeAttrToBeUpdated.setnull(null);
