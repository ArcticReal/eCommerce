...
public class DeleteBudgetRole extends Command {

private String toBeDeletedId;
public DeleteBudgetRole(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("BudgetRole", UtilMisc.toMap("budgetRoleId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new BudgetRoleDeleted(success);
