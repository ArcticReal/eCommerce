...
public class DeletePicklistStatusHistory extends Command {

private String toBeDeletedId;
public DeletePicklistStatusHistory(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PicklistStatusHistory", UtilMisc.toMap("picklistStatusHistoryId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PicklistStatusHistoryDeleted(success);
