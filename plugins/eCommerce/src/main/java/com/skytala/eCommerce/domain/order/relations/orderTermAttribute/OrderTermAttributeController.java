package com.skytala.eCommerce.domain.order.relations.orderTermAttribute;
...
import com.skytala.eCommerce.domain.order.relations.orderTermAttribute.command.AddOrderTermAttribute;
import com.skytala.eCommerce.domain.order.relations.orderTermAttribute.command.DeleteOrderTermAttribute;
import com.skytala.eCommerce.domain.order.relations.orderTermAttribute.command.UpdateOrderTermAttribute;
import com.skytala.eCommerce.domain.order.relations.orderTermAttribute.event.OrderTermAttributeAdded;
import com.skytala.eCommerce.domain.order.relations.orderTermAttribute.event.OrderTermAttributeDeleted;
import com.skytala.eCommerce.domain.order.relations.orderTermAttribute.event.OrderTermAttributeFound;
import com.skytala.eCommerce.domain.order.relations.orderTermAttribute.event.OrderTermAttributeUpdated;
...
import com.skytala.eCommerce.domain.order.relations.orderTermAttribute.query.FindOrderTermAttributesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/orderTermAttributes")
...
//		orderTermAttributeToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{orderTermAttributeId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{orderTermAttributeId}")
