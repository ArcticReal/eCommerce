...
public class DeleteOrderContent extends Command {

private String toBeDeletedId;
public DeleteOrderContent(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderContent", UtilMisc.toMap("orderContentId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderContentDeleted(success);
