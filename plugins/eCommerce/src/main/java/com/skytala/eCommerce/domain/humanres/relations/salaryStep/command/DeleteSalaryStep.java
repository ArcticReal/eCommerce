...
public class DeleteSalaryStep extends Command {

private String toBeDeletedId;
public DeleteSalaryStep(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("SalaryStep", UtilMisc.toMap("salaryStepId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new SalaryStepDeleted(success);
