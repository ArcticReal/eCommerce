...
public class DeletePartyResume extends Command {

private String toBeDeletedId;
public DeletePartyResume(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyResume", UtilMisc.toMap("partyResumeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyResumeDeleted(success);
