package com.skytala.eCommerce.domain.product.relations.productPromoCond;
...
import com.skytala.eCommerce.domain.product.relations.productPromoCond.command.AddProductPromoCond;
import com.skytala.eCommerce.domain.product.relations.productPromoCond.command.DeleteProductPromoCond;
import com.skytala.eCommerce.domain.product.relations.productPromoCond.command.UpdateProductPromoCond;
import com.skytala.eCommerce.domain.product.relations.productPromoCond.event.ProductPromoCondAdded;
import com.skytala.eCommerce.domain.product.relations.productPromoCond.event.ProductPromoCondDeleted;
import com.skytala.eCommerce.domain.product.relations.productPromoCond.event.ProductPromoCondFound;
import com.skytala.eCommerce.domain.product.relations.productPromoCond.event.ProductPromoCondUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productPromoCond.query.FindProductPromoCondsBy;
