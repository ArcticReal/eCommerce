...
public class DeleteFinAccountRole extends Command {

private String toBeDeletedId;
public DeleteFinAccountRole(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("FinAccountRole", UtilMisc.toMap("finAccountRoleId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new FinAccountRoleDeleted(success);
