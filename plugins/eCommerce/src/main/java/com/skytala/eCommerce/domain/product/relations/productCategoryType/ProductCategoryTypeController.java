package com.skytala.eCommerce.domain.product.relations.productCategoryType;
...
import com.skytala.eCommerce.domain.product.relations.productCategoryType.command.AddProductCategoryType;
import com.skytala.eCommerce.domain.product.relations.productCategoryType.command.DeleteProductCategoryType;
import com.skytala.eCommerce.domain.product.relations.productCategoryType.command.UpdateProductCategoryType;
import com.skytala.eCommerce.domain.product.relations.productCategoryType.event.ProductCategoryTypeAdded;
import com.skytala.eCommerce.domain.product.relations.productCategoryType.event.ProductCategoryTypeDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productCategoryType.query.FindProductCategoryTypesBy;
