...
@RestController
@RequestMapping("/userLoginPasswordHistorys")
...
//		userLoginPasswordHistoryToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{userLoginPasswordHistoryId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{userLoginPasswordHistoryId}")
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/userLoginPasswordHistory/\" plus one of the following: "
				+ "";
