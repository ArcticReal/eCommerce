...
public class DeleteTerminationReason extends Command {

private String toBeDeletedId;
public DeleteTerminationReason(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("TerminationReason", UtilMisc.toMap("terminationReasonId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new TerminationReasonDeleted(success);
