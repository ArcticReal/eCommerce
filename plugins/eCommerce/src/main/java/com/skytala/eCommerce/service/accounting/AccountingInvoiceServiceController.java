...
public class AccountingInvoiceServiceController{
	...
	public ResponseEntity<Map<String, Object>> checkInvoicePaymentApplications(HttpSession session, @RequestParam(value="invoiceId") String invoiceId) {
	...
	public ResponseEntity<Map<String, Object>> updateInvoiceTypeAttr(HttpSession session, @RequestParam(value="invoiceTypeId") String invoiceTypeId, @RequestParam(value="attrName") String attrName, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceForOrder(HttpSession session, @RequestParam(value="orderId") String orderId, @RequestParam(value="billItems") List billItems, @RequestParam(value="invoiceId", required=false) String invoiceId, @RequestParam(value="eventDate", required=false) Timestamp eventDate) {
	...
	public ResponseEntity<Map<String, Object>> updateInvoiceAttribute(HttpSession session, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="attrName") String attrName, @RequestParam(value="attrDescription", required=false) String attrDescription, @RequestParam(value="attrValue", required=false) Long attrValue) {
	...
	public ResponseEntity<Map<String, Object>> setInvoiceStatus(HttpSession session, @RequestParam(value="statusId") String statusId, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="statusDate", required=false) Timestamp statusDate, @RequestParam(value="paidDate", required=false) Timestamp paidDate) {
	...
	public ResponseEntity<Map<String, Object>> calculateInvoicedAdjustmentTotal(HttpSession session, @RequestParam(value="orderAdjustment") org.apache.ofbiz.entity.GenericValue orderAdjustment) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceContactMech(HttpSession session, @RequestParam(value="contactMechPurposeTypeId") String contactMechPurposeTypeId, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="contactMechId") String contactMechId) {
	...
	public ResponseEntity<Map<String, Object>> deleteInvoiceContentType(HttpSession session, @RequestParam(value="invoiceContentTypeId") String invoiceContentTypeId) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceNote(HttpSession session, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="noteId") String noteId) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceRole(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="partyId") String partyId, @RequestParam(value="datetimePerformed", required=false) Timestamp datetimePerformed, @RequestParam(value="percentage", required=false) BigDecimal percentage) {
	...
	public ResponseEntity<Map<String, Object>> autoGenerateInvoiceFromExistingInvoice(HttpSession session, @RequestParam(value="recurrenceInfoId") String recurrenceInfoId) {
	...
	public ResponseEntity<Map<String, Object>> massChangeInvoiceStatus(HttpSession session, @RequestParam(value="statusId") String statusId, @RequestParam(value="invoiceIds") List invoiceIds) {
	...
	public ResponseEntity<Map<String, Object>> importInvoice(HttpSession session, @RequestParam(value="organizationPartyId") String organizationPartyId, @RequestParam(value="uploadedFile", required=false) java.nio.ByteBuffer uploadedFile) {
	...
	public ResponseEntity<Map<String, Object>> updateInvoiceContentType(HttpSession session, @RequestParam(value="invoiceContentTypeId") String invoiceContentTypeId, @RequestParam(value="parentTypeId", required=false) String parentTypeId, @RequestParam(value="hasTable", required=false) String hasTable, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceTerm(HttpSession session, @RequestParam(value="textValue", required=false) String textValue, @RequestParam(value="termDays", required=false) Long termDays, @RequestParam(value="termTypeId", required=false) String termTypeId, @RequestParam(value="description", required=false) String description, @RequestParam(value="invoiceId", required=false) String invoiceId, @RequestParam(value="invoiceItemSeqId", required=false) String invoiceItemSeqId, @RequestParam(value="uomId", required=false) String uomId, @RequestParam(value="termValue", required=false) BigDecimal termValue) {
	...
	public ResponseEntity<Map<String, Object>> deleteInvoiceItemTypeAttr(HttpSession session, @RequestParam(value="invoiceItemTypeId") String invoiceItemTypeId, @RequestParam(value="attrName") String attrName) {
	...
	public ResponseEntity<Map<String, Object>> invoiceSequenceRestart(HttpSession session, @RequestParam(value="partyAcctgPreference") org.apache.ofbiz.entity.GenericValue partyAcctgPreference, @RequestParam(value="partyIdFrom", required=false) String partyIdFrom, @RequestParam(value="roleTypeId", required=false) String roleTypeId, @RequestParam(value="recurrenceInfoId", required=false) String recurrenceInfoId, @RequestParam(value="invoiceTypeId", required=false) String invoiceTypeId, @RequestParam(value="dueDate", required=false) Timestamp dueDate, @RequestParam(value="description", required=false) String description, @RequestParam(value="billingAccountId", required=false) String billingAccountId, @RequestParam(value="invoiceDate", required=false) Timestamp invoiceDate, @RequestParam(value="contactMechId", required=false) String contactMechId, @RequestParam(value="currencyUomId", required=false) String currencyUomId, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="paidDate", required=false) Timestamp paidDate, @RequestParam(value="referenceNumber", required=false) String referenceNumber, @RequestParam(value="invoiceId", required=false) String invoiceId, @RequestParam(value="invoiceMessage", required=false) String invoiceMessage, @RequestParam(value="partyId", required=false) String partyId) {
	...
	public ResponseEntity<Map<String, Object>> deleteInvoiceAttribute(HttpSession session, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="attrName") String attrName) {
	...
	public ResponseEntity<Map<String, Object>> deleteInvoiceItemTypeMap(HttpSession session, @RequestParam(value="invoiceItemMapKey") String invoiceItemMapKey, @RequestParam(value="invoiceTypeId") String invoiceTypeId) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceItemAssocType(HttpSession session, @RequestParam(value="parentTypeId", required=false) String parentTypeId, @RequestParam(value="hasTable", required=false) String hasTable, @RequestParam(value="invoiceItemAssocTypeId", required=false) String invoiceItemAssocTypeId, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> deleteInvoiceType(HttpSession session, @RequestParam(value="invoiceTypeId") String invoiceTypeId) {
	...
	public ResponseEntity<Map<String, Object>> createInvoicesFromShipment(HttpSession session, @RequestParam(value="shipmentId") String shipmentId, @RequestParam(value="eventDate", required=false) Timestamp eventDate) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceForOrderAllItems(HttpSession session, @RequestParam(value="orderId") String orderId) {
	...
	public ResponseEntity<Map<String, Object>> createInvoicesFromShipments(HttpSession session, @RequestParam(value="shipmentIds") List shipmentIds, @RequestParam(value="createSalesInvoicesForDropShipments", required=false) Boolean createSalesInvoicesForDropShipments, @RequestParam(value="eventDate", required=false) Timestamp eventDate) {
	...
	public ResponseEntity<Map<String, Object>> createInvoicesFromReturnShipment(HttpSession session, @RequestParam(value="shipmentId") String shipmentId) {
	...
	public ResponseEntity<Map<String, Object>> updateInvoiceItemAssoc(HttpSession session, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="invoiceItemSeqIdFrom") String invoiceItemSeqIdFrom, @RequestParam(value="invoiceIdFrom") String invoiceIdFrom, @RequestParam(value="invoiceItemSeqIdTo") String invoiceItemSeqIdTo, @RequestParam(value="invoiceItemAssocTypeId") String invoiceItemAssocTypeId, @RequestParam(value="invoiceIdTo") String invoiceIdTo, @RequestParam(value="partyIdFrom", required=false) String partyIdFrom, @RequestParam(value="amount", required=false) BigDecimal amount, @RequestParam(value="quantity", required=false) BigDecimal quantity, @RequestParam(value="partyIdTo", required=false) String partyIdTo, @RequestParam(value="thruDate", required=false) Timestamp thruDate) {
	...
	public ResponseEntity<Map<String, Object>> resetOrderItemBillingAndOrderAdjustmentBillingOnCancelInvoice(HttpSession session, @RequestParam(value="invoiceId") String invoiceId) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceItemTypeMap(HttpSession session, @RequestParam(value="invoiceItemMapKey") String invoiceItemMapKey, @RequestParam(value="invoiceTypeId") String invoiceTypeId, @RequestParam(value="invoiceItemTypeId", required=false) String invoiceItemTypeId) {
	...
	public ResponseEntity<Map<String, Object>> getNextInvoiceId(HttpSession session, @RequestParam(value="partyIdFrom", required=false) String partyIdFrom, @RequestParam(value="roleTypeId", required=false) String roleTypeId, @RequestParam(value="recurrenceInfoId", required=false) String recurrenceInfoId, @RequestParam(value="invoiceTypeId", required=false) String invoiceTypeId, @RequestParam(value="dueDate", required=false) Timestamp dueDate, @RequestParam(value="description", required=false) String description, @RequestParam(value="billingAccountId", required=false) String billingAccountId, @RequestParam(value="invoiceDate", required=false) Timestamp invoiceDate, @RequestParam(value="contactMechId", required=false) String contactMechId, @RequestParam(value="currencyUomId", required=false) String currencyUomId, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="paidDate", required=false) Timestamp paidDate, @RequestParam(value="referenceNumber", required=false) String referenceNumber, @RequestParam(value="invoiceId", required=false) String invoiceId, @RequestParam(value="invoiceMessage", required=false) String invoiceMessage, @RequestParam(value="partyId", required=false) String partyId) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceTermAttribute(HttpSession session, @RequestParam(value="invoiceTermId") String invoiceTermId, @RequestParam(value="attrName") String attrName, @RequestParam(value="attrDescription", required=false) String attrDescription, @RequestParam(value="attrValue", required=false) Long attrValue) {
	...
	public ResponseEntity<Map<String, Object>> invoiceSequenceEnforced(HttpSession session, @RequestParam(value="partyAcctgPreference") org.apache.ofbiz.entity.GenericValue partyAcctgPreference, @RequestParam(value="partyIdFrom", required=false) String partyIdFrom, @RequestParam(value="roleTypeId", required=false) String roleTypeId, @RequestParam(value="recurrenceInfoId", required=false) String recurrenceInfoId, @RequestParam(value="invoiceTypeId", required=false) String invoiceTypeId, @RequestParam(value="dueDate", required=false) Timestamp dueDate, @RequestParam(value="description", required=false) String description, @RequestParam(value="billingAccountId", required=false) String billingAccountId, @RequestParam(value="invoiceDate", required=false) Timestamp invoiceDate, @RequestParam(value="contactMechId", required=false) String contactMechId, @RequestParam(value="currencyUomId", required=false) String currencyUomId, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="paidDate", required=false) Timestamp paidDate, @RequestParam(value="referenceNumber", required=false) String referenceNumber, @RequestParam(value="invoiceMessage", required=false) String invoiceMessage, @RequestParam(value="partyId", required=false) String partyId) {
	...
	public ResponseEntity<Map<String, Object>> createCommissionInvoices(HttpSession session, @RequestParam(value="invoiceIds") List invoiceIds, @RequestParam(value="partyIds", required=false) List partyIds) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceTypeAttr(HttpSession session, @RequestParam(value="invoiceTypeId") String invoiceTypeId, @RequestParam(value="attrName") String attrName, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceFromReturn(HttpSession session, @RequestParam(value="returnId") String returnId, @RequestParam(value="billItems", required=false) List billItems) {
	...
	public ResponseEntity<Map<String, Object>> setInvoicesToReadyFromShipment(HttpSession session, @RequestParam(value="shipmentId") String shipmentId) {
	...
	public ResponseEntity<Map<String, Object>> isInvoiceInForeignCurrency(HttpSession session, @RequestParam(value="invoiceId") String invoiceId) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceAttribute(HttpSession session, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="attrName") String attrName, @RequestParam(value="attrDescription", required=false) String attrDescription, @RequestParam(value="attrValue", required=false) Long attrValue) {
	...
	public ResponseEntity<Map<String, Object>> deleteInvoiceItemAttribute(HttpSession session, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="invoiceItemSeqId") String invoiceItemSeqId, @RequestParam(value="attrName") String attrName) {
	...
	public ResponseEntity<Map<String, Object>> readyInvoices(HttpSession session, @RequestParam(value="invoicesCreated") List invoicesCreated) {
	...
	public ResponseEntity<Map<String, Object>> updateInvoiceItemAssocType(HttpSession session, @RequestParam(value="invoiceItemAssocTypeId") String invoiceItemAssocTypeId, @RequestParam(value="parentTypeId", required=false) String parentTypeId, @RequestParam(value="hasTable", required=false) String hasTable, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> removeInvoiceItemAssocOnCancelInvoice(HttpSession session, @RequestParam(value="invoiceId") String invoiceId) {
	...
	public ResponseEntity<Map<String, Object>> copyInvoice(HttpSession session, @RequestParam(value="invoiceIdToCopyFrom") String invoiceIdToCopyFrom, @RequestParam(value="invoiceId", required=false) String invoiceId) {
	...
	public ResponseEntity<Map<String, Object>> updateInvoiceType(HttpSession session, @RequestParam(value="invoiceTypeId") String invoiceTypeId, @RequestParam(value="parentTypeId", required=false) String parentTypeId, @RequestParam(value="hasTable", required=false) String hasTable, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceStatus(HttpSession session, @RequestParam(value="statusId") String statusId, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="statusDate", required=false) Timestamp statusDate) {
	...
	public ResponseEntity<Map<String, Object>> getInvoice(HttpSession session, @RequestParam(value="invoiceId") String invoiceId) {
	...
	public ResponseEntity<Map<String, Object>> sampleInvoiceAffiliateCommission(HttpSession session, @RequestParam(value="paymentId") String paymentId) {
	...
	public ResponseEntity<Map<String, Object>> removeInvoiceRole(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceContent(HttpSession session, @RequestParam(value="invoiceContentTypeId") String invoiceContentTypeId, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="ownerContentId", required=false) String ownerContentId, @RequestParam(value="contentId", required=false) String contentId, @RequestParam(value="contentTypeId", required=false) String contentTypeId, @RequestParam(value="description", required=false) String description, @RequestParam(value="mimeTypeId", required=false) String mimeTypeId, @RequestParam(value="childLeafCount", required=false) Long childLeafCount, @RequestParam(value="privilegeEnumId", required=false) String privilegeEnumId, @RequestParam(value="dataSourceId", required=false) String dataSourceId, @RequestParam(value="lastModifiedByUserLogin", required=false) String lastModifiedByUserLogin, @RequestParam(value="dataResourceId", required=false) String dataResourceId, @RequestParam(value="createdByUserLogin", required=false) String createdByUserLogin, @RequestParam(value="templateDataResourceId", required=false) String templateDataResourceId, @RequestParam(value="lastModifiedDate", required=false) Timestamp lastModifiedDate, @RequestParam(value="instanceOfContentId", required=false) String instanceOfContentId, @RequestParam(value="serviceName", required=false) String serviceName, @RequestParam(value="customMethodId", required=false) String customMethodId, @RequestParam(value="characterSetId", required=false) String characterSetId, @RequestParam(value="thruDate", required=false) Timestamp thruDate, @RequestParam(value="contentName", required=false) Long contentName, @RequestParam(value="fromDate", required=false) Timestamp fromDate, @RequestParam(value="createdDate", required=false) Timestamp createdDate, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="localeString", required=false) String localeString, @RequestParam(value="decoratorContentId", required=false) String decoratorContentId, @RequestParam(value="childBranchCount", required=false) Long childBranchCount) {
	...
	public ResponseEntity<Map<String, Object>> updateInvoiceItemAttribute(HttpSession session, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="invoiceItemSeqId") String invoiceItemSeqId, @RequestParam(value="attrName") String attrName, @RequestParam(value="attrDescription", required=false) String attrDescription, @RequestParam(value="attrValue", required=false) Long attrValue) {
	...
	public ResponseEntity<Map<String, Object>> deleteInvoiceTermAttribute(HttpSession session, @RequestParam(value="invoiceTermId") String invoiceTermId, @RequestParam(value="attrName") String attrName) {
	...
	public ResponseEntity<Map<String, Object>> getInvoiceRunningTotal(HttpSession session, @RequestParam(value="invoiceIds") List invoiceIds, @RequestParam(value="organizationPartyId", required=false) String organizationPartyId) {
	...
	public ResponseEntity<Map<String, Object>> deleteInvoiceItemAssocType(HttpSession session, @RequestParam(value="invoiceItemAssocTypeId") String invoiceItemAssocTypeId) {
	...
	public ResponseEntity<Map<String, Object>> addtax(HttpSession session, @RequestParam(value="invoiceId") String invoiceId) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceItemTypeAttr(HttpSession session, @RequestParam(value="invoiceItemTypeId") String invoiceItemTypeId, @RequestParam(value="attrName") String attrName, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceFromOrder(HttpSession session, @RequestParam(value="orderId") String orderId) {
	...
	public ResponseEntity<Map<String, Object>> deleteInvoiceContactMech(HttpSession session, @RequestParam(value="contactMechPurposeTypeId") String contactMechPurposeTypeId, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="contactMechId") String contactMechId) {
	...
	public ResponseEntity<Map<String, Object>> createInvoiceContentType(HttpSession session, @RequestParam(value="invoiceContentTypeId", required=false) String invoiceContentTypeId, @RequestParam(value="parentTypeId", required=false) String parentTypeId, @RequestParam(value="hasTable", required=false) String hasTable, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> deleteInvoiceTypeAttr(HttpSession session, @RequestParam(value="invoiceTypeId") String invoiceTypeId, @RequestParam(value="attrName") String attrName) {
	...
	public ResponseEntity<Map<String, Object>> updateInvoiceItemTypeAttr(HttpSession session, @RequestParam(value="invoiceItemTypeId") String invoiceItemTypeId, @RequestParam(value="attrName") String attrName, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> updateInvoiceTermAttribute(HttpSession session, @RequestParam(value="invoiceTermId") String invoiceTermId, @RequestParam(value="attrName") String attrName, @RequestParam(value="attrDescription", required=false) String attrDescription, @RequestParam(value="attrValue", required=false) Long attrValue) {
	...
	public ResponseEntity<Map<String, Object>> cancelInvoice(HttpSession session, @RequestParam(value="invoiceId") String invoiceId) {
	...
	public ResponseEntity<Map<String, Object>> deleteInvoiceNote(HttpSession session, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="noteId") String noteId) {
	...
	public ResponseEntity<Map<String, Object>> sendInvoicePerEmail(HttpSession session, @RequestParam(value="sendTo") String sendTo, @RequestParam(value="sendFrom") String sendFrom, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="other", required=false) String other, @RequestParam(value="bodyText", required=false) String bodyText, @RequestParam(value="subject", required=false) String subject, @RequestParam(value="sendCc", required=false) String sendCc) {
	...
	public ResponseEntity<Map<String, Object>> copyInvoiceToTemplate(HttpSession session, @RequestParam(value="invoiceTypeId") String invoiceTypeId, @RequestParam(value="invoiceId") String invoiceId) {
	...
	public ResponseEntity<Map<String, Object>> getInvoicesFilterByAssocType(HttpSession session, @RequestParam(value="invoiceList") List invoiceList, @RequestParam(value="invoiceItemAssocTypeId") String invoiceItemAssocTypeId) {
	...
	public ResponseEntity<Map<String, Object>> createSalesInvoicesFromDropShipment(HttpSession session, @RequestParam(value="shipmentId") String shipmentId) {
	...
	public ResponseEntity<Map<String, Object>> deleteInvoiceTerm(HttpSession session, @RequestParam(value="invoiceTermId") String invoiceTermId) {
	...
	public ResponseEntity<Map<String, Object>> removeInvoiceItem(HttpSession session, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="invoiceItemSeqId") String invoiceItemSeqId) {
	...
	public ResponseEntity<Map<String, Object>> updateInvoiceItem(HttpSession session, @RequestParam(value="invoiceId") String invoiceId, @RequestParam(value="invoiceItemSeqId") String invoiceItemSeqId, @RequestParam(value="amount", required=false) BigDecimal amount, @RequestParam(value="quantity", required=false) BigDecimal quantity, @RequestParam(value="productId", required=false) String productId, @RequestParam(value="overrideOrgPartyId", required=false) String overrideOrgPartyId, @RequestParam(value="productFeatureId", required=false) String productFeatureId, @RequestParam(value="taxableFlag", required=false) String taxableFlag, @RequestParam(value="taxAuthorityRateSeqId", required=false) String taxAuthorityRateSeqId, @RequestParam(value="overrideGlAccountId", required=false) String overrideGlAccountId, @RequestParam(value="description", required=false) String description, @RequestParam(value="uomId", required=false) String uomId, @RequestParam(value="invoiceItemTypeId", required=false) String invoiceItemTypeId, @RequestParam(value="inventoryItemId", required=false) String inventoryItemId, @RequestParam(value="taxAuthPartyId", required=false) String taxAuthPartyId, @RequestParam(value="parentInvoiceId", required=false) String parentInvoiceId, @RequestParam(value="parentInvoiceItemSeqId", required=false) String parentInvoiceItemSeqId, @RequestParam(value="taxAuthGeoId", required=false) String taxAuthGeoId, @RequestParam(value="salesOpportunityId", required=false) String salesOpportunityId) {
	...
	public ResponseEntity<Map<String, Object>> updateInvoiceItemTypeMap(HttpSession session, @RequestParam(value="invoiceItemMapKey") String invoiceItemMapKey, @RequestParam(value="invoiceTypeId") String invoiceTypeId, @RequestParam(value="invoiceItemTypeId", required=false) String invoiceItemTypeId) {
	...
	public ResponseEntity<Map<String, Object>> removeInvoiceContent(HttpSession session, @RequestParam(value="invoiceContentTypeId") String invoiceContentTypeId, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="contentId") String contentId, @RequestParam(value="invoiceId") String invoiceId) {
