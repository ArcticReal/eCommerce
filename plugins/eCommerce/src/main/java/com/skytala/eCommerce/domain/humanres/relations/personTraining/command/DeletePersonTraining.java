...
public class DeletePersonTraining extends Command {

private String toBeDeletedId;
public DeletePersonTraining(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PersonTraining", UtilMisc.toMap("personTrainingId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PersonTrainingDeleted(success);
