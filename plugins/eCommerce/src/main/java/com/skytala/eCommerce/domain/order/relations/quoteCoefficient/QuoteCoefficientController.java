package com.skytala.eCommerce.domain.order.relations.quoteCoefficient;
...
import com.skytala.eCommerce.domain.order.relations.quoteCoefficient.command.AddQuoteCoefficient;
import com.skytala.eCommerce.domain.order.relations.quoteCoefficient.command.DeleteQuoteCoefficient;
import com.skytala.eCommerce.domain.order.relations.quoteCoefficient.command.UpdateQuoteCoefficient;
import com.skytala.eCommerce.domain.order.relations.quoteCoefficient.event.QuoteCoefficientAdded;
import com.skytala.eCommerce.domain.order.relations.quoteCoefficient.event.QuoteCoefficientDeleted;
import com.skytala.eCommerce.domain.order.relations.quoteCoefficient.event.QuoteCoefficientFound;
import com.skytala.eCommerce.domain.order.relations.quoteCoefficient.event.QuoteCoefficientUpdated;
...
import com.skytala.eCommerce.domain.order.relations.quoteCoefficient.query.FindQuoteCoefficientsBy;
