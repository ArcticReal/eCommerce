...
public class DeleteOrderStatus extends Command {

private String toBeDeletedId;
public DeleteOrderStatus(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderStatus", UtilMisc.toMap("orderStatusId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderStatusDeleted(success);
