...
public class DeleteApplicationSandbox extends Command {

private String toBeDeletedId;
public DeleteApplicationSandbox(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ApplicationSandbox", UtilMisc.toMap("applicationSandboxId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ApplicationSandboxDeleted(success);
