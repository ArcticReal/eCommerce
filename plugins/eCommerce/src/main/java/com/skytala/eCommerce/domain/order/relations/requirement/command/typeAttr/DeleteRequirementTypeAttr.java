...
public class DeleteRequirementTypeAttr extends Command {

private String toBeDeletedId;
public DeleteRequirementTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("RequirementTypeAttr", UtilMisc.toMap("requirementTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new RequirementTypeAttrDeleted(success);
