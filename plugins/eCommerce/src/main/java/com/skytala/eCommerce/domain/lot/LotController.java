package com.skytala.eCommerce.domain.lot;
...
import com.skytala.eCommerce.domain.lot.command.AddLot;
import com.skytala.eCommerce.domain.lot.command.DeleteLot;
import com.skytala.eCommerce.domain.lot.command.UpdateLot;
import com.skytala.eCommerce.domain.lot.event.LotAdded;
import com.skytala.eCommerce.domain.lot.event.LotDeleted;
import com.skytala.eCommerce.domain.lot.event.LotFound;
import com.skytala.eCommerce.domain.lot.event.LotUpdated;
import com.skytala.eCommerce.domain.lot.mapper.LotMapper;
import com.skytala.eCommerce.domain.lot.model.Lot;
import com.skytala.eCommerce.domain.lot.query.FindLotsBy;
