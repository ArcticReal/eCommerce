...
public class DeletePicklist extends Command {

private String toBeDeletedId;
public DeletePicklist(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("Picklist", UtilMisc.toMap("picklistId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PicklistDeleted(success);
