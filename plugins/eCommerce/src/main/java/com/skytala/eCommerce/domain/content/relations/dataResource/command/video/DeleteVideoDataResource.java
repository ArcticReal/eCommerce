...
public class DeleteVideoDataResource extends Command {

private String toBeDeletedId;
public DeleteVideoDataResource(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("VideoDataResource", UtilMisc.toMap("videoDataResourceId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new VideoDataResourceDeleted(success);
