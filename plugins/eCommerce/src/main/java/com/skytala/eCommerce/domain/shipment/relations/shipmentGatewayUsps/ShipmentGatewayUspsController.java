package com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayUsps;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayUsps.command.AddShipmentGatewayUsps;
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayUsps.command.DeleteShipmentGatewayUsps;
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayUsps.command.UpdateShipmentGatewayUsps;
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayUsps.event.ShipmentGatewayUspsAdded;
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayUsps.event.ShipmentGatewayUspsDeleted;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayUsps.query.FindShipmentGatewayUspssBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/shipmentGatewayUspss")
...
//		shipmentGatewayUspsToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{shipmentGatewayUspsId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{shipmentGatewayUspsId}")
