package com.skytala.eCommerce.domain.returnType;
...
import com.skytala.eCommerce.domain.returnType.command.AddReturnType;
import com.skytala.eCommerce.domain.returnType.command.DeleteReturnType;
import com.skytala.eCommerce.domain.returnType.command.UpdateReturnType;
import com.skytala.eCommerce.domain.returnType.event.ReturnTypeAdded;
import com.skytala.eCommerce.domain.returnType.event.ReturnTypeDeleted;
import com.skytala.eCommerce.domain.returnType.event.ReturnTypeFound;
import com.skytala.eCommerce.domain.returnType.event.ReturnTypeUpdated;
...
import com.skytala.eCommerce.domain.returnType.query.FindReturnTypesBy;
