...
@RestController
@CrossOrigin
@RequestMapping("/personTrainings")
...
//		personTrainingToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{personTrainingId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{personTrainingId}")
