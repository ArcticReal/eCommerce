...
public class DeleteReturnItem extends Command {

private String toBeDeletedId;
public DeleteReturnItem(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ReturnItem", UtilMisc.toMap("returnItemId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ReturnItemDeleted(success);
