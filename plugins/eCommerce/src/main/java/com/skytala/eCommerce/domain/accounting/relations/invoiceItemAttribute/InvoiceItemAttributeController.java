package com.skytala.eCommerce.domain.accounting.relations.invoiceItemAttribute;
...
import com.skytala.eCommerce.domain.accounting.relations.invoiceItemAttribute.command.AddInvoiceItemAttribute;
import com.skytala.eCommerce.domain.accounting.relations.invoiceItemAttribute.command.DeleteInvoiceItemAttribute;
import com.skytala.eCommerce.domain.accounting.relations.invoiceItemAttribute.command.UpdateInvoiceItemAttribute;
import com.skytala.eCommerce.domain.accounting.relations.invoiceItemAttribute.event.InvoiceItemAttributeAdded;
import com.skytala.eCommerce.domain.accounting.relations.invoiceItemAttribute.event.InvoiceItemAttributeDeleted;
...
import com.skytala.eCommerce.domain.accounting.relations.invoiceItemAttribute.query.FindInvoiceItemAttributesBy;
...
public class InvoiceItemAttributeController {
	...
	public boolean updateInvoiceItemAttribute(HttpServletRequest request) throws Exception {
		...
		if (updateInvoiceItemAttribute(invoiceItemAttributeToBeUpdated, invoiceItemAttributeToBeUpdated.getInvoiceItemSeqId()).getStatusCode()
	...
	public ResponseEntity<Object> updateInvoiceItemAttribute(@RequestBody InvoiceItemAttribute invoiceItemAttributeToBeUpdated,
		...
		invoiceItemAttributeToBeUpdated.setInvoiceItemSeqId(invoiceItemSeqId);
