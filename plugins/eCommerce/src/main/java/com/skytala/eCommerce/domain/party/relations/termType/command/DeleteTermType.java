...
public class DeleteTermType extends Command {

private String toBeDeletedId;
public DeleteTermType(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("TermType", UtilMisc.toMap("termTypeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new TermTypeDeleted(success);
