...
public class DeleteProductFeaturePrice extends Command {

private String toBeDeletedId;
public DeleteProductFeaturePrice(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductFeaturePrice", UtilMisc.toMap("productFeaturePriceId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductFeaturePriceDeleted(success);
