...
public class DeleteSkillType extends Command {

private String toBeDeletedId;
public DeleteSkillType(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("SkillType", UtilMisc.toMap("skillTypeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new SkillTypeDeleted(success);
