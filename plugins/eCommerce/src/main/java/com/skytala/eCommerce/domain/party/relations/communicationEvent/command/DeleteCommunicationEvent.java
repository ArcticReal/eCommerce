...
public class DeleteCommunicationEvent extends Command {

private String toBeDeletedId;
public DeleteCommunicationEvent(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CommunicationEvent", UtilMisc.toMap("communicationEventId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CommunicationEventDeleted(success);
