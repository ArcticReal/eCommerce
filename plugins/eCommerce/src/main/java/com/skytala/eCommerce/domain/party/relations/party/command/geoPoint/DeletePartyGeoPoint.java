...
public class DeletePartyGeoPoint extends Command {

private String toBeDeletedId;
public DeletePartyGeoPoint(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyGeoPoint", UtilMisc.toMap("partyGeoPointId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyGeoPointDeleted(success);
