package com.skytala.eCommerce.domain.product.relations.productStoreSurveyAppl;
...
import com.skytala.eCommerce.domain.product.relations.productStoreSurveyAppl.command.AddProductStoreSurveyAppl;
import com.skytala.eCommerce.domain.product.relations.productStoreSurveyAppl.command.DeleteProductStoreSurveyAppl;
import com.skytala.eCommerce.domain.product.relations.productStoreSurveyAppl.command.UpdateProductStoreSurveyAppl;
import com.skytala.eCommerce.domain.product.relations.productStoreSurveyAppl.event.ProductStoreSurveyApplAdded;
import com.skytala.eCommerce.domain.product.relations.productStoreSurveyAppl.event.ProductStoreSurveyApplDeleted;
import com.skytala.eCommerce.domain.product.relations.productStoreSurveyAppl.event.ProductStoreSurveyApplFound;
import com.skytala.eCommerce.domain.product.relations.productStoreSurveyAppl.event.ProductStoreSurveyApplUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productStoreSurveyAppl.query.FindProductStoreSurveyApplsBy;
