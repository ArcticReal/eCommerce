...
public class DeleteCommContentAssocType extends Command {

private String toBeDeletedId;
public DeleteCommContentAssocType(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CommContentAssocType", UtilMisc.toMap("commContentAssocTypeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CommContentAssocTypeDeleted(success);
