...
public class DeleteQuoteAttribute extends Command {

private String toBeDeletedId;
public DeleteQuoteAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("QuoteAttribute", UtilMisc.toMap("quoteAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new QuoteAttributeDeleted(success);
