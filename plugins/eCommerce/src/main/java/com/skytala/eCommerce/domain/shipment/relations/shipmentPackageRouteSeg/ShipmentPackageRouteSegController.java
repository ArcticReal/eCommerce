package com.skytala.eCommerce.domain.shipment.relations.shipmentPackageRouteSeg;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageRouteSeg.command.AddShipmentPackageRouteSeg;
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageRouteSeg.command.DeleteShipmentPackageRouteSeg;
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageRouteSeg.command.UpdateShipmentPackageRouteSeg;
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageRouteSeg.event.ShipmentPackageRouteSegAdded;
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageRouteSeg.event.ShipmentPackageRouteSegDeleted;
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageRouteSeg.event.ShipmentPackageRouteSegFound;
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageRouteSeg.event.ShipmentPackageRouteSegUpdated;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageRouteSeg.query.FindShipmentPackageRouteSegsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/shipmentPackageRouteSegs")
