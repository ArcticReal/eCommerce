package com.skytala.eCommerce.domain.product.relations.productFeatureType;
...
import com.skytala.eCommerce.domain.product.relations.productFeatureType.command.AddProductFeatureType;
import com.skytala.eCommerce.domain.product.relations.productFeatureType.command.DeleteProductFeatureType;
import com.skytala.eCommerce.domain.product.relations.productFeatureType.command.UpdateProductFeatureType;
import com.skytala.eCommerce.domain.product.relations.productFeatureType.event.ProductFeatureTypeAdded;
import com.skytala.eCommerce.domain.product.relations.productFeatureType.event.ProductFeatureTypeDeleted;
import com.skytala.eCommerce.domain.product.relations.productFeatureType.event.ProductFeatureTypeFound;
import com.skytala.eCommerce.domain.product.relations.productFeatureType.event.ProductFeatureTypeUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productFeatureType.query.FindProductFeatureTypesBy;
