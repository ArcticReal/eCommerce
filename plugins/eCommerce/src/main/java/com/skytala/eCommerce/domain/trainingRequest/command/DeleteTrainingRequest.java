...
public class DeleteTrainingRequest extends Command {

private String toBeDeletedId;
public DeleteTrainingRequest(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("TrainingRequest", UtilMisc.toMap("trainingRequestId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new TrainingRequestDeleted(success);
