package com.skytala.eCommerce.domain.humanres.relations.emplPositionResponsibility;
...
import com.skytala.eCommerce.domain.humanres.relations.emplPositionResponsibility.command.AddEmplPositionResponsibility;
import com.skytala.eCommerce.domain.humanres.relations.emplPositionResponsibility.command.DeleteEmplPositionResponsibility;
import com.skytala.eCommerce.domain.humanres.relations.emplPositionResponsibility.command.UpdateEmplPositionResponsibility;
import com.skytala.eCommerce.domain.humanres.relations.emplPositionResponsibility.event.EmplPositionResponsibilityAdded;
import com.skytala.eCommerce.domain.humanres.relations.emplPositionResponsibility.event.EmplPositionResponsibilityDeleted;
...
import com.skytala.eCommerce.domain.humanres.relations.emplPositionResponsibility.query.FindEmplPositionResponsibilitysBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/emplPositionResponsibilitys")
...
//		emplPositionResponsibilityToBeUpdated.setnull(null);
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/emplPositionResponsibility/\" plus one of the following: "
				+ "";
