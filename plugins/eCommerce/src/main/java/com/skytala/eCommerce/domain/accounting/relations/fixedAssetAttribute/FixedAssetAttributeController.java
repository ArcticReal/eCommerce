package com.skytala.eCommerce.domain.accounting.relations.fixedAssetAttribute;
...
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetAttribute.command.AddFixedAssetAttribute;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetAttribute.command.DeleteFixedAssetAttribute;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetAttribute.command.UpdateFixedAssetAttribute;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetAttribute.event.FixedAssetAttributeAdded;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetAttribute.event.FixedAssetAttributeDeleted;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetAttribute.event.FixedAssetAttributeFound;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetAttribute.event.FixedAssetAttributeUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetAttribute.query.FindFixedAssetAttributesBy;
...
public class FixedAssetAttributeController {
	...
	public boolean updateFixedAssetAttribute(HttpServletRequest request) throws Exception {
		...
		if (updateFixedAssetAttribute(fixedAssetAttributeToBeUpdated, null).getStatusCode()
...
//		fixedAssetAttributeToBeUpdated.setnull(null);
