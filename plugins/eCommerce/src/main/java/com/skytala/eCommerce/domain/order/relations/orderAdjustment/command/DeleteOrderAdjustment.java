...
public class DeleteOrderAdjustment extends Command {

private String toBeDeletedId;
public DeleteOrderAdjustment(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderAdjustment", UtilMisc.toMap("orderAdjustmentId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderAdjustmentDeleted(success);
