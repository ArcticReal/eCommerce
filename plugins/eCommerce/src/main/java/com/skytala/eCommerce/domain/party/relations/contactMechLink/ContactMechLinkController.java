package com.skytala.eCommerce.domain.party.relations.contactMechLink;
...
import com.skytala.eCommerce.domain.party.relations.contactMechLink.command.AddContactMechLink;
import com.skytala.eCommerce.domain.party.relations.contactMechLink.command.DeleteContactMechLink;
import com.skytala.eCommerce.domain.party.relations.contactMechLink.command.UpdateContactMechLink;
import com.skytala.eCommerce.domain.party.relations.contactMechLink.event.ContactMechLinkAdded;
import com.skytala.eCommerce.domain.party.relations.contactMechLink.event.ContactMechLinkDeleted;
import com.skytala.eCommerce.domain.party.relations.contactMechLink.event.ContactMechLinkFound;
...
import com.skytala.eCommerce.domain.party.relations.contactMechLink.query.FindContactMechLinksBy;
...
//		contactMechLinkToBeUpdated.setnull(null);
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/contactMechLink/\" plus one of the following: "
				+ "";
