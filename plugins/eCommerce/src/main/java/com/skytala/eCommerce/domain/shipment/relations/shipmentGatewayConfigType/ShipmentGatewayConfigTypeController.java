package com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayConfigType;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayConfigType.command.AddShipmentGatewayConfigType;
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayConfigType.command.DeleteShipmentGatewayConfigType;
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayConfigType.command.UpdateShipmentGatewayConfigType;
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayConfigType.event.ShipmentGatewayConfigTypeAdded;
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayConfigType.event.ShipmentGatewayConfigTypeDeleted;
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayConfigType.event.ShipmentGatewayConfigTypeFound;
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayConfigType.event.ShipmentGatewayConfigTypeUpdated;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentGatewayConfigType.query.FindShipmentGatewayConfigTypesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/shipmentGatewayConfigTypes")
