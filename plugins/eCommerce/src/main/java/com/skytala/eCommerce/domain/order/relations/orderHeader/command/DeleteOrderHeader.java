...
public class DeleteOrderHeader extends Command {

private String toBeDeletedId;
public DeleteOrderHeader(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderHeader", UtilMisc.toMap("orderHeaderId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderHeaderDeleted(success);
