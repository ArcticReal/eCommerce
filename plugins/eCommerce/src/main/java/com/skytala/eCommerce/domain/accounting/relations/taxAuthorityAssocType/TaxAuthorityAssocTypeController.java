package com.skytala.eCommerce.domain.accounting.relations.taxAuthorityAssocType;
...
import com.skytala.eCommerce.domain.accounting.relations.taxAuthorityAssocType.command.AddTaxAuthorityAssocType;
import com.skytala.eCommerce.domain.accounting.relations.taxAuthorityAssocType.command.DeleteTaxAuthorityAssocType;
import com.skytala.eCommerce.domain.accounting.relations.taxAuthorityAssocType.command.UpdateTaxAuthorityAssocType;
import com.skytala.eCommerce.domain.accounting.relations.taxAuthorityAssocType.event.TaxAuthorityAssocTypeAdded;
import com.skytala.eCommerce.domain.accounting.relations.taxAuthorityAssocType.event.TaxAuthorityAssocTypeDeleted;
import com.skytala.eCommerce.domain.accounting.relations.taxAuthorityAssocType.event.TaxAuthorityAssocTypeFound;
import com.skytala.eCommerce.domain.accounting.relations.taxAuthorityAssocType.event.TaxAuthorityAssocTypeUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.taxAuthorityAssocType.query.FindTaxAuthorityAssocTypesBy;
