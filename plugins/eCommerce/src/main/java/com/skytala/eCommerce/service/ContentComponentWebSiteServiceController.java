...
@RestController
@RequestMapping("/service/ContentComponentWebSiteController")
public class ContentComponentWebSiteServiceController{
	...
	public ResponseEntity<Object> getWebSitePathAlias(HttpSession session, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="aliasTo") String aliasTo, @RequestParam(value="contentId") String contentId, @RequestParam(value="mapKey") String mapKey, @RequestParam(value="webSiteId") String webSiteId, @RequestParam(value="pathAlias") String pathAlias, @RequestParam(value="thruDate") Timestamp thruDate) {
