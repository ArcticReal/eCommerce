...
public class DeleteTermTypeAttr extends Command {

private String toBeDeletedId;
public DeleteTermTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("TermTypeAttr", UtilMisc.toMap("termTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new TermTypeAttrDeleted(success);
