...
public class DeleteWebUserPreference extends Command {

private String toBeDeletedId;
public DeleteWebUserPreference(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("WebUserPreference", UtilMisc.toMap("webUserPreferenceId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new WebUserPreferenceDeleted(success);
