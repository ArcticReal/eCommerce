package com.skytala.eCommerce.domain.varianceReason;
...
import com.skytala.eCommerce.domain.varianceReason.command.AddVarianceReason;
import com.skytala.eCommerce.domain.varianceReason.command.DeleteVarianceReason;
import com.skytala.eCommerce.domain.varianceReason.command.UpdateVarianceReason;
import com.skytala.eCommerce.domain.varianceReason.event.VarianceReasonAdded;
import com.skytala.eCommerce.domain.varianceReason.event.VarianceReasonDeleted;
...
import com.skytala.eCommerce.domain.varianceReason.query.FindVarianceReasonsBy;
