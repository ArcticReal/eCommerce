...
public class DeleteShipmentAttribute extends Command {

private String toBeDeletedId;
public DeleteShipmentAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ShipmentAttribute", UtilMisc.toMap("shipmentAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ShipmentAttributeDeleted(success);
