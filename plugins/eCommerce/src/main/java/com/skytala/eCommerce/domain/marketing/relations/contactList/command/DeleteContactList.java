...
public class DeleteContactList extends Command {

private String toBeDeletedId;
public DeleteContactList(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ContactList", UtilMisc.toMap("contactListId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ContactListDeleted(success);
