...
public class DeleteRequirementAttribute extends Command {

private String toBeDeletedId;
public DeleteRequirementAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("RequirementAttribute", UtilMisc.toMap("requirementAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new RequirementAttributeDeleted(success);
