...
public class DeleteUserLoginPasswordHistory extends Command {

private String toBeDeletedId;
public DeleteUserLoginPasswordHistory(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("UserLoginPasswordHistory", UtilMisc.toMap("userLoginPasswordHistoryId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new UserLoginPasswordHistoryDeleted(success);
