...
public class DeleteEftAccount extends Command {

private String toBeDeletedId;
public DeleteEftAccount(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("EftAccount", UtilMisc.toMap("eftAccountId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new EftAccountDeleted(success);
