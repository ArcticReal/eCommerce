...
public class DeletePaymentAttribute extends Command {

private String toBeDeletedId;
public DeletePaymentAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PaymentAttribute", UtilMisc.toMap("paymentAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PaymentAttributeDeleted(success);
