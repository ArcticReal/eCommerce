package com.skytala.eCommerce.domain.terminationType;
...
import com.skytala.eCommerce.domain.terminationType.command.AddTerminationType;
import com.skytala.eCommerce.domain.terminationType.command.DeleteTerminationType;
import com.skytala.eCommerce.domain.terminationType.command.UpdateTerminationType;
import com.skytala.eCommerce.domain.terminationType.event.TerminationTypeAdded;
import com.skytala.eCommerce.domain.terminationType.event.TerminationTypeDeleted;
import com.skytala.eCommerce.domain.terminationType.event.TerminationTypeFound;
import com.skytala.eCommerce.domain.terminationType.event.TerminationTypeUpdated;
...
import com.skytala.eCommerce.domain.terminationType.query.FindTerminationTypesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/terminationTypes")
public class TerminationTypeController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{terminationTypeId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{terminationTypeId}")
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/terminationType/\" plus one of the following: "
				+ "";
