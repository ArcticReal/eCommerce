...
public class DeleteOrderAttribute extends Command {

private String toBeDeletedId;
public DeleteOrderAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderAttribute", UtilMisc.toMap("orderAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderAttributeDeleted(success);
