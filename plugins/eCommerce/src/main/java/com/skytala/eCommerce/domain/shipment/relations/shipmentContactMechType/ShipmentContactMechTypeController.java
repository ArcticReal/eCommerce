package com.skytala.eCommerce.domain.shipment.relations.shipmentContactMechType;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentContactMechType.command.AddShipmentContactMechType;
import com.skytala.eCommerce.domain.shipment.relations.shipmentContactMechType.command.DeleteShipmentContactMechType;
import com.skytala.eCommerce.domain.shipment.relations.shipmentContactMechType.command.UpdateShipmentContactMechType;
import com.skytala.eCommerce.domain.shipment.relations.shipmentContactMechType.event.ShipmentContactMechTypeAdded;
import com.skytala.eCommerce.domain.shipment.relations.shipmentContactMechType.event.ShipmentContactMechTypeDeleted;
import com.skytala.eCommerce.domain.shipment.relations.shipmentContactMechType.event.ShipmentContactMechTypeFound;
import com.skytala.eCommerce.domain.shipment.relations.shipmentContactMechType.event.ShipmentContactMechTypeUpdated;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentContactMechType.query.FindShipmentContactMechTypesBy;
