...
public class PartysServiceController{
	...
	public ResponseEntity<Map<String, Object>> cancelPartyInvitation(HttpSession session, @RequestParam(value="partyInvitationId") String partyInvitationId) {
	...
	public ResponseEntity<Map<String, Object>> updateContactMechAttribute(HttpSession session, @RequestParam(value="contactMechId") String contactMechId, @RequestParam(value="attrName") String attrName, @RequestParam(value="attrDescription", required=false) String attrDescription, @RequestParam(value="attrValue", required=false) Long attrValue) {
	...
	public ResponseEntity<Map<String, Object>> sendEmailDated(HttpSession session) {
	...
	public ResponseEntity<Map<String, Object>> findPartyFromTelephone(HttpSession session, @RequestParam(value="telno") String telno) {
	...
	public ResponseEntity<Map<String, Object>> deletePartyClassificationGroup(HttpSession session, @RequestParam(value="partyClassificationGroupId") String partyClassificationGroupId) {
	...
	public ResponseEntity<Map<String, Object>> logIncomingMessage(HttpSession session, @RequestParam(value="messageWrapper") org.apache.ofbiz.service.mail.MimeMessageWrapper messageWrapper) {
	...
	public ResponseEntity<Map<String, Object>> findPartyFromTelephoneComplete(HttpSession session, @RequestParam(value="telno") String telno) {
	...
	public ResponseEntity<Map<String, Object>> updatePartyCarrierAccount(HttpSession session, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="carrierPartyId") String carrierPartyId, @RequestParam(value="partyId") String partyId, @RequestParam(value="accountNumber", required=false) String accountNumber, @RequestParam(value="thruDate", required=false) Timestamp thruDate) {
	...
	public ResponseEntity<Map<String, Object>> setPartyStatus(HttpSession session, @RequestParam(value="statusId") String statusId, @RequestParam(value="partyId") String partyId, @RequestParam(value="statusDate", required=false) Timestamp statusDate) {
	...
	public ResponseEntity<Map<String, Object>> createPartyClassificationGroup(HttpSession session, @RequestParam(value="parentGroupId", required=false) String parentGroupId, @RequestParam(value="description", required=false) String description, @RequestParam(value="partyClassificationTypeId", required=false) String partyClassificationTypeId) {
	...
	public ResponseEntity<Map<String, Object>> ensurePartyRoleTo(HttpSession session, @RequestParam(value="partyIdTo") String partyIdTo, @RequestParam(value="roleTypeIdTo", required=false) String roleTypeIdTo) {
	...
	public ResponseEntity<Map<String, Object>> sendEmailToContactList(HttpSession session, @RequestParam(value="contactListId") String contactListId, @RequestParam(value="communicationEventId") String communicationEventId) {
	...
	public ResponseEntity<Map<String, Object>> linkPartyRecord(HttpSession session, @RequestParam(value="partyIdTo") String partyIdTo, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> updatePartyClassification(HttpSession session, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="partyClassificationGroupId") String partyClassificationGroupId, @RequestParam(value="partyId") String partyId, @RequestParam(value="thruDate", required=false) Timestamp thruDate) {
	...
	public ResponseEntity<Map<String, Object>> createPartyClassification(HttpSession session, @RequestParam(value="partyClassificationGroupId") String partyClassificationGroupId, @RequestParam(value="partyId") String partyId, @RequestParam(value="fromDate", required=false) Timestamp fromDate, @RequestParam(value="thruDate", required=false) Timestamp thruDate) {
	...
	public ResponseEntity<Map<String, Object>> partyContactMechPermissionCheck(HttpSession session, @RequestParam(value="primaryPermission", required=false) String primaryPermission, @RequestParam(value="altPermission", required=false) String altPermission, @RequestParam(value="resourceDescription", required=false) String resourceDescription, @RequestParam(value="partyId", required=false) String partyId, @RequestParam(value="mainAction", required=false) String mainAction) {
	...
	public ResponseEntity<Map<String, Object>> deletePartyRelationship(HttpSession session, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="partyIdTo") String partyIdTo, @RequestParam(value="roleTypeIdTo", required=false) String roleTypeIdTo, @RequestParam(value="partyIdFrom", required=false) String partyIdFrom, @RequestParam(value="roleTypeIdFrom", required=false) String roleTypeIdFrom) {
	...
	public ResponseEntity<Map<String, Object>> getPartyPostalAddress(HttpSession session, @RequestParam(value="partyId") String partyId, @RequestParam(value="contactMechPurposeTypeId", required=false) String contactMechPurposeTypeId) {
	...
	public ResponseEntity<Map<String, Object>> clearAddressMatchMap(HttpSession session) {
	...
	public ResponseEntity<Map<String, Object>> deleteRoleType(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId) {
	...
	public ResponseEntity<Map<String, Object>> updateAgreementItemTypeAttr(HttpSession session, @RequestParam(value="agreementItemTypeId") String agreementItemTypeId, @RequestParam(value="attrName") String attrName, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> deleteVendor(HttpSession session, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> createContactMech(HttpSession session, @RequestParam(value="contactMechTypeId") String contactMechTypeId, @RequestParam(value="infoString", required=false) String infoString, @RequestParam(value="contactMechId", required=false) String contactMechId) {
	...
	public ResponseEntity<Map<String, Object>> createPartyCarrierAccount(HttpSession session, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="carrierPartyId") String carrierPartyId, @RequestParam(value="partyId") String partyId, @RequestParam(value="accountNumber", required=false) String accountNumber, @RequestParam(value="thruDate", required=false) Timestamp thruDate) {
	...
	public ResponseEntity<Map<String, Object>> getPartyEmail(HttpSession session, @RequestParam(value="contactMechPurposeTypeId") String contactMechPurposeTypeId, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> deleteAgreementAttribute(HttpSession session, @RequestParam(value="agreementId") String agreementId, @RequestParam(value="attrName") String attrName) {
	...
	public ResponseEntity<Map<String, Object>> removePartyContent(HttpSession session, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="partyContentTypeId") String partyContentTypeId, @RequestParam(value="contentId") String contentId, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> createEmailAddress(HttpSession session, @RequestParam(value="emailAddress") String emailAddress, @RequestParam(value="infoString", required=false) String infoString, @RequestParam(value="contactMechTypeId", required=false) String contactMechTypeId) {
	...
	public ResponseEntity<Map<String, Object>> createContactMechLink(HttpSession session, @RequestParam(value="contactMechIdFrom") String contactMechIdFrom, @RequestParam(value="contactMechIdTo") String contactMechIdTo) {
	...
	public ResponseEntity<Map<String, Object>> createEmailAddressVerification(HttpSession session, @RequestParam(value="emailAddress") String emailAddress, @RequestParam(value="expireDate", required=false) String expireDate) {
	...
	public ResponseEntity<Map<String, Object>> deletePartyRole(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> setCommEventRoleToRead(HttpSession session, @RequestParam(value="communicationEventId") String communicationEventId, @RequestParam(value="roleTypeId", required=false) String roleTypeId, @RequestParam(value="partyId", required=false) String partyId) {
	...
	public ResponseEntity<Map<String, Object>> createPartyDataSource(HttpSession session, @RequestParam(value="dataSourceId") String dataSourceId, @RequestParam(value="partyId") String partyId, @RequestParam(value="fromDate", required=false) Timestamp fromDate) {
	...
	public ResponseEntity<Map<String, Object>> declinePartyInvitation(HttpSession session, @RequestParam(value="partyInvitationId") String partyInvitationId) {
	...
	public ResponseEntity<Map<String, Object>> updateRoleType(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="parentTypeId", required=false) String parentTypeId, @RequestParam(value="hasTable", required=false) String hasTable, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> deletePartyInvitationRoleAssoc(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="partyInvitationId") String partyInvitationId) {
	...
	public ResponseEntity<Map<String, Object>> deletePartyIdentification(HttpSession session, @RequestParam(value="partyIdentificationTypeId") String partyIdentificationTypeId, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> deleteCustRequestCommEvent(HttpSession session, @RequestParam(value="custRequestId") String custRequestId, @RequestParam(value="communicationEventId") String communicationEventId) {
	...
	public ResponseEntity<Map<String, Object>> createUpdatePartyEmailAddress(HttpSession session, @RequestParam(value="emailAddress") String emailAddress, @RequestParam(value="userLogin", required=false) org.apache.ofbiz.entity.GenericValue userLogin, @RequestParam(value="contactMechPurposeTypeId", required=false) String contactMechPurposeTypeId, @RequestParam(value="partyId", required=false) String partyId, @RequestParam(value="contactMechId", required=false) String contactMechId) {
	...
	public ResponseEntity<Map<String, Object>> quickCreateCustomer(HttpSession session, @RequestParam(value="firstName") String firstName, @RequestParam(value="lastName") String lastName, @RequestParam(value="emailAddress") String emailAddress, @RequestParam(value="subscribeContactList", required=false) String subscribeContactList, @RequestParam(value="contactListId", required=false) String contactListId) {
	...
	public ResponseEntity<Map<String, Object>> updatePartyAttribute(HttpSession session, @RequestParam(value="partyId") String partyId, @RequestParam(value="attrName") String attrName, @RequestParam(value="attrDescription", required=false) String attrDescription, @RequestParam(value="attrValue", required=false) Long attrValue) {
	...
	public ResponseEntity<Map<String, Object>> cancelPartyInvitationPermissionCheck(HttpSession session, @RequestParam(value="partyInvitationId") String partyInvitationId, @RequestParam(value="primaryPermission", required=false) String primaryPermission, @RequestParam(value="altPermission", required=false) String altPermission, @RequestParam(value="resourceDescription", required=false) String resourceDescription, @RequestParam(value="mainAction", required=false) String mainAction) {
	...
	public ResponseEntity<Map<String, Object>> updatePartyGroup(HttpSession session, @RequestParam(value="comments", required=false) String comments, @RequestParam(value="description", required=false) String description, @RequestParam(value="externalId", required=false) String externalId, @RequestParam(value="tickerSymbol", required=false) String tickerSymbol, @RequestParam(value="logoImageUrl", required=false) String logoImageUrl, @RequestParam(value="partyTypeId", required=false) String partyTypeId, @RequestParam(value="groupName", required=false) String groupName, @RequestParam(value="groupNameLocal", required=false) String groupNameLocal, @RequestParam(value="numEmployees", required=false) Long numEmployees, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="preferredCurrencyUomId", required=false) String preferredCurrencyUomId, @RequestParam(value="partyId", required=false) String partyId, @RequestParam(value="officeSiteName", required=false) String officeSiteName, @RequestParam(value="annualRevenue", required=false) BigDecimal annualRevenue) {
	...
	public ResponseEntity<Map<String, Object>> findPartiesById(HttpSession session, @RequestParam(value="idToFind") String idToFind, @RequestParam(value="searchAllId", required=false) String searchAllId, @RequestParam(value="partyIdentificationTypeId", required=false) String partyIdentificationTypeId, @RequestParam(value="searchPartyFirst", required=false) String searchPartyFirst) {
	...
	public ResponseEntity<Map<String, Object>> updateEmailAddress(HttpSession session, @RequestParam(value="emailAddress") String emailAddress, @RequestParam(value="contactMechId") String contactMechId) {
	...
	public ResponseEntity<Map<String, Object>> ensureNaPartyRole(HttpSession session, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> importAddressMatchMapCsv(HttpSession session, @RequestParam(value="_uploadedFile_contentType") String _uploadedFile_contentType, @RequestParam(value="uploadedFile") java.nio.ByteBuffer uploadedFile, @RequestParam(value="_uploadedFile_fileName") String _uploadedFile_fileName) {
	...
	public ResponseEntity<Map<String, Object>> ensurePartyRole(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> partyRolePermissionCheck(HttpSession session, @RequestParam(value="primaryPermission", required=false) String primaryPermission, @RequestParam(value="altPermission", required=false) String altPermission, @RequestParam(value="resourceDescription", required=false) String resourceDescription, @RequestParam(value="partyId", required=false) String partyId, @RequestParam(value="mainAction", required=false) String mainAction) {
	...
	public ResponseEntity<Map<String, Object>> ensurePartyRoleFrom(HttpSession session, @RequestParam(value="partyIdFrom") String partyIdFrom, @RequestParam(value="roleTypeIdFrom", required=false) String roleTypeIdFrom) {
	...
	public ResponseEntity<Map<String, Object>> createPartyNote(HttpSession session, @RequestParam(value="partyId") String partyId, @RequestParam(value="note", required=false) String note, @RequestParam(value="noteName", required=false) String noteName, @RequestParam(value="noteId", required=false) String noteId) {
	...
	public ResponseEntity<Map<String, Object>> sendVerifyEmailAddressNotification(HttpSession session, @RequestParam(value="emailAddress") String emailAddress) {
	...
	public ResponseEntity<Map<String, Object>> updateAgreementAttribute(HttpSession session, @RequestParam(value="agreementId") String agreementId, @RequestParam(value="attrName") String attrName, @RequestParam(value="attrDescription", required=false) String attrDescription, @RequestParam(value="attrValue", required=false) Long attrValue) {
	...
	public ResponseEntity<Map<String, Object>> getPartyTelephone(HttpSession session, @RequestParam(value="partyId") String partyId, @RequestParam(value="contactMechPurposeTypeId", required=false) String contactMechPurposeTypeId) {
	...
	public ResponseEntity<Map<String, Object>> accAndDecPartyInvitationPermissionCheck(HttpSession session, @RequestParam(value="partyInvitationId") String partyInvitationId, @RequestParam(value="primaryPermission", required=false) String primaryPermission, @RequestParam(value="altPermission", required=false) String altPermission, @RequestParam(value="resourceDescription", required=false) String resourceDescription, @RequestParam(value="mainAction", required=false) String mainAction) {
	...
	public ResponseEntity<Map<String, Object>> deleteNeedType(HttpSession session, @RequestParam(value="needTypeId") String needTypeId) {
	...
	public ResponseEntity<Map<String, Object>> sendCommEventAsEmail(HttpSession session, @RequestParam(value="communicationEventId") String communicationEventId) {
	...
	public ResponseEntity<Map<String, Object>> createRoleTypeAttr(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="attrName") String attrName, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> createCommunicationEventPrpTyp(HttpSession session, @RequestParam(value="communicationEventPrpTypId", required=false) String communicationEventPrpTypId, @RequestParam(value="parentTypeId", required=false) String parentTypeId, @RequestParam(value="hasTable", required=false) String hasTable, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> removeAddressMatchMap(HttpSession session, @RequestParam(value="mapValue") String mapValue, @RequestParam(value="mapKey") String mapKey) {
	...
	public ResponseEntity<Map<String, Object>> lookupParty(HttpSession session, @RequestParam(value="firstName", required=false) String firstName, @RequestParam(value="lastName", required=false) String lastName) {
	...
	public ResponseEntity<Map<String, Object>> partyGroupPermissionCheck(HttpSession session, @RequestParam(value="primaryPermission", required=false) String primaryPermission, @RequestParam(value="altPermission", required=false) String altPermission, @RequestParam(value="resourceDescription", required=false) String resourceDescription, @RequestParam(value="partyId", required=false) String partyId, @RequestParam(value="mainAction", required=false) String mainAction) {
	...
	public ResponseEntity<Map<String, Object>> removePartyAttribute(HttpSession session, @RequestParam(value="partyId") String partyId, @RequestParam(value="attrName") String attrName) {
	...
	public ResponseEntity<Map<String, Object>> createCommunicationEvent(HttpSession session, @RequestParam(value="partyIdFrom", required=false) String partyIdFrom, @RequestParam(value="note", required=false) String note, @RequestParam(value="orderId", required=false) String orderId, @RequestParam(value="subject", required=false) String subject, @RequestParam(value="ccString", required=false) String ccString, @RequestParam(value="contactMechTypeId", required=false) String contactMechTypeId, @RequestParam(value="communicationEventTypeId", required=false) String communicationEventTypeId, @RequestParam(value="content", required=false) String content, @RequestParam(value="contentMimeTypeId", required=false) String contentMimeTypeId, @RequestParam(value="datetimeStarted", required=false) Timestamp datetimeStarted, @RequestParam(value="contactListId", required=false) String contactListId, @RequestParam(value="custRequestId", required=false) String custRequestId, @RequestParam(value="action", required=false) String action, @RequestParam(value="contactMechIdFrom", required=false) String contactMechIdFrom, @RequestParam(value="reasonEnumId", required=false) String reasonEnumId, @RequestParam(value="roleTypeIdTo", required=false) String roleTypeIdTo, @RequestParam(value="productId", required=false) String productId, @RequestParam(value="parentCommEventId", required=false) String parentCommEventId, @RequestParam(value="entryDate", required=false) Timestamp entryDate, @RequestParam(value="datetimeEnded", required=false) Timestamp datetimeEnded, @RequestParam(value="origCommEventId", required=false) String origCommEventId, @RequestParam(value="messageId", required=false) Long messageId, @RequestParam(value="roleTypeIdFrom", required=false) String roleTypeIdFrom, @RequestParam(value="contactMechIdTo", required=false) String contactMechIdTo, @RequestParam(value="headerString", required=false) String headerString, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="bccString", required=false) String bccString, @RequestParam(value="communicationEventId", required=false) String communicationEventId, @RequestParam(value="partyIdTo", required=false) String partyIdTo, @RequestParam(value="toString", required=false) String toString, @RequestParam(value="fromString", required=false) String fromString) {
	...
	public ResponseEntity<Map<String, Object>> deletePostalAddressBoundary(HttpSession session, @RequestParam(value="geoId") String geoId, @RequestParam(value="contactMechId") String contactMechId) {
	...
	public ResponseEntity<Map<String, Object>> processBouncedMessage(HttpSession session, @RequestParam(value="messageWrapper") org.apache.ofbiz.service.mail.MimeMessageWrapper messageWrapper) {
	...
	public ResponseEntity<Map<String, Object>> createCommunicationEventPurpose(HttpSession session, @RequestParam(value="communicationEventPrpTypId") String communicationEventPrpTypId, @RequestParam(value="communicationEventId") String communicationEventId, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> updatePartyContent(HttpSession session, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="partyContentTypeId") String partyContentTypeId, @RequestParam(value="contentId") String contentId, @RequestParam(value="partyId") String partyId, @RequestParam(value="thruDate", required=false) Timestamp thruDate) {
	...
	public ResponseEntity<Map<String, Object>> updateRoleTypeAttr(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="attrName") String attrName, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> createContactMechAttribute(HttpSession session, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="partyId") String partyId, @RequestParam(value="contactMechId") String contactMechId, @RequestParam(value="attrDescription", required=false) String attrDescription, @RequestParam(value="attrValue", required=false) Long attrValue) {
	...
	public ResponseEntity<Map<String, Object>> createCommunicationEventInterface(HttpSession session, @RequestParam(value="partyIdFrom", required=false) String partyIdFrom, @RequestParam(value="note", required=false) String note, @RequestParam(value="orderId", required=false) String orderId, @RequestParam(value="subject", required=false) String subject, @RequestParam(value="ccString", required=false) String ccString, @RequestParam(value="contactMechTypeId", required=false) String contactMechTypeId, @RequestParam(value="communicationEventTypeId", required=false) String communicationEventTypeId, @RequestParam(value="content", required=false) String content, @RequestParam(value="contentMimeTypeId", required=false) String contentMimeTypeId, @RequestParam(value="datetimeStarted", required=false) Timestamp datetimeStarted, @RequestParam(value="contactListId", required=false) String contactListId, @RequestParam(value="custRequestId", required=false) String custRequestId, @RequestParam(value="action", required=false) String action, @RequestParam(value="contactMechIdFrom", required=false) String contactMechIdFrom, @RequestParam(value="reasonEnumId", required=false) String reasonEnumId, @RequestParam(value="roleTypeIdTo", required=false) String roleTypeIdTo, @RequestParam(value="productId", required=false) String productId, @RequestParam(value="parentCommEventId", required=false) String parentCommEventId, @RequestParam(value="entryDate", required=false) Timestamp entryDate, @RequestParam(value="datetimeEnded", required=false) Timestamp datetimeEnded, @RequestParam(value="origCommEventId", required=false) String origCommEventId, @RequestParam(value="messageId", required=false) Long messageId, @RequestParam(value="roleTypeIdFrom", required=false) String roleTypeIdFrom, @RequestParam(value="contactMechIdTo", required=false) String contactMechIdTo, @RequestParam(value="headerString", required=false) String headerString, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="bccString", required=false) String bccString, @RequestParam(value="communicationEventId", required=false) String communicationEventId, @RequestParam(value="partyIdTo", required=false) String partyIdTo, @RequestParam(value="toString", required=false) String toString, @RequestParam(value="fromString", required=false) String fromString) {
	...
	public ResponseEntity<Map<String, Object>> updatePartyTelecomNumber(HttpSession session, @RequestParam(value="roleTypeId", required=false) String roleTypeId, @RequestParam(value="extension", required=false) String extension, @RequestParam(value="askForName", required=false) String askForName, @RequestParam(value="comments", required=false) String comments, @RequestParam(value="verified", required=false) String verified, @RequestParam(value="monthsWithContactMech", required=false) Long monthsWithContactMech, @RequestParam(value="contactMechId", required=false) String contactMechId, @RequestParam(value="thruDate", required=false) Timestamp thruDate, @RequestParam(value="fromDate", required=false) Timestamp fromDate, @RequestParam(value="allowSolicitation", required=false) String allowSolicitation, @RequestParam(value="areaCode", required=false) String areaCode, @RequestParam(value="yearsWithContactMech", required=false) Long yearsWithContactMech, @RequestParam(value="countryCode", required=false) String countryCode, @RequestParam(value="contactNumber", required=false) String contactNumber, @RequestParam(value="partyId", required=false) String partyId) {
	...
	public ResponseEntity<Map<String, Object>> createNeedType(HttpSession session, @RequestParam(value="needTypeId", required=false) String needTypeId, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> getPartyNameForDate(HttpSession session, @RequestParam(value="partyId") String partyId, @RequestParam(value="compareDate", required=false) Timestamp compareDate, @RequestParam(value="lastNameFirst", required=false) String lastNameFirst) {
	...
	public ResponseEntity<Map<String, Object>> deletePartyClassification(HttpSession session, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="partyClassificationGroupId") String partyClassificationGroupId, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> partyBasePermissionCheck(HttpSession session, @RequestParam(value="primaryPermission", required=false) String primaryPermission, @RequestParam(value="altPermission", required=false) String altPermission, @RequestParam(value="resourceDescription", required=false) String resourceDescription, @RequestParam(value="mainAction", required=false) String mainAction) {
	...
	public ResponseEntity<Map<String, Object>> deletePartyContactMech(HttpSession session, @RequestParam(value="contactMechId") String contactMechId, @RequestParam(value="partyId", required=false) String partyId) {
	...
	public ResponseEntity<Map<String, Object>> removeCommunicationEventRole(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="communicationEventId") String communicationEventId, @RequestParam(value="partyId") String partyId, @RequestParam(value="deleteCommEventIfLast", required=false) String deleteCommEventIfLast, @RequestParam(value="delContentDataResource", required=false) String delContentDataResource) {
	...
	public ResponseEntity<Map<String, Object>> createAgreementItemTypeAttr(HttpSession session, @RequestParam(value="agreementItemTypeId") String agreementItemTypeId, @RequestParam(value="attrName") String attrName, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> createPartyPostalAddress(HttpSession session, @RequestParam(value="city") String city, @RequestParam(value="address1") String address1, @RequestParam(value="postalCode") String postalCode, @RequestParam(value="houseNumberExt", required=false) String houseNumberExt, @RequestParam(value="extension", required=false) String extension, @RequestParam(value="postalCodeGeoId", required=false) String postalCodeGeoId, @RequestParam(value="houseNumber", required=false) Long houseNumber, @RequestParam(value="postalCodeExt", required=false) String postalCodeExt, @RequestParam(value="contactMechId", required=false) String contactMechId, @RequestParam(value="attnName", required=false) String attnName, @RequestParam(value="countyGeoId", required=false) String countyGeoId, @RequestParam(value="toName", required=false) String toName, @RequestParam(value="cityGeoId", required=false) String cityGeoId, @RequestParam(value="paymentMethodId", required=false) String paymentMethodId, @RequestParam(value="partyId", required=false) String partyId, @RequestParam(value="countryGeoId", required=false) String countryGeoId, @RequestParam(value="roleTypeId", required=false) String roleTypeId, @RequestParam(value="comments", required=false) String comments, @RequestParam(value="address2", required=false) String address2, @RequestParam(value="verified", required=false) String verified, @RequestParam(value="monthsWithContactMech", required=false) Long monthsWithContactMech, @RequestParam(value="thruDate", required=false) Timestamp thruDate, @RequestParam(value="fromDate", required=false) Timestamp fromDate, @RequestParam(value="allowSolicitation", required=false) String allowSolicitation, @RequestParam(value="yearsWithContactMech", required=false) Long yearsWithContactMech, @RequestParam(value="directions", required=false) String directions, @RequestParam(value="contactMechPurposeTypeId", required=false) String contactMechPurposeTypeId, @RequestParam(value="municipalityGeoId", required=false) String municipalityGeoId, @RequestParam(value="stateProvinceGeoId", required=false) String stateProvinceGeoId, @RequestParam(value="geoPointId", required=false) String geoPointId) {
	...
	public ResponseEntity<Map<String, Object>> copyPartyContactMechs(HttpSession session, @RequestParam(value="partyIdFrom") String partyIdFrom, @RequestParam(value="partyIdTo") String partyIdTo) {
	...
	public ResponseEntity<Map<String, Object>> removeCommunicationEventPurpose(HttpSession session, @RequestParam(value="communicationEventPrpTypId") String communicationEventPrpTypId, @RequestParam(value="communicationEventId") String communicationEventId) {
	...
	public ResponseEntity<Map<String, Object>> verifyEmailAddress(HttpSession session, @RequestParam(value="verifyHash") String verifyHash) {
	...
	public ResponseEntity<Map<String, Object>> createPartyInvitationRoleAssoc(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="partyInvitationId") String partyInvitationId) {
	...
	public ResponseEntity<Map<String, Object>> storeIncomingEmail(HttpSession session, @RequestParam(value="messageWrapper") org.apache.ofbiz.service.mail.MimeMessageWrapper messageWrapper) {
	...
	public ResponseEntity<Map<String, Object>> sendCreatePartyEmailNotification(HttpSession session, @RequestParam(value="emailAddress") String emailAddress, @RequestParam(value="productStoreId") String productStoreId, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> createAddressMatchMap(HttpSession session, @RequestParam(value="mapValue") String mapValue, @RequestParam(value="mapKey") String mapKey, @RequestParam(value="sequenceNum", required=false) Long sequenceNum) {
	...
	public ResponseEntity<Map<String, Object>> updateNeedType(HttpSession session, @RequestParam(value="needTypeId") String needTypeId, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> createPostalAddressBoundary(HttpSession session, @RequestParam(value="geoId") String geoId, @RequestParam(value="contactMechId") String contactMechId) {
	...
	public ResponseEntity<Map<String, Object>> createPartyIdentifications(HttpSession session, @RequestParam(value="partyId") String partyId, @RequestParam(value="identifications") Map identifications) {
	...
	public ResponseEntity<Map<String, Object>> setCommunicationEventStatus(HttpSession session, @RequestParam(value="statusId") String statusId, @RequestParam(value="communicationEventId") String communicationEventId, @RequestParam(value="setRoleStatusToComplete") String setRoleStatusToComplete, @RequestParam(value="partyIdFrom", required=false) String partyIdFrom) {
	...
	public ResponseEntity<Map<String, Object>> updateCommEventAfterEmail(HttpSession session, @RequestParam(value="messageWrapper") org.apache.ofbiz.service.mail.MimeMessageWrapper messageWrapper, @RequestParam(value="communicationEventId") String communicationEventId) {
	...
	public ResponseEntity<Map<String, Object>> setCommEventComplete(HttpSession session, @RequestParam(value="communicationEventId") String communicationEventId, @RequestParam(value="partyIdFrom", required=false) String partyIdFrom) {
	...
	public ResponseEntity<Map<String, Object>> createVendor(HttpSession session, @RequestParam(value="partyId") String partyId, @RequestParam(value="manifestCompanyTitle", required=false) String manifestCompanyTitle, @RequestParam(value="manifestPolicies", required=false) String manifestPolicies, @RequestParam(value="manifestLogoUrl", required=false) String manifestLogoUrl, @RequestParam(value="manifestCompanyName", required=false) String manifestCompanyName) {
	...
	public ResponseEntity<Map<String, Object>> createCommunicationEventRole(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="communicationEventId") String communicationEventId, @RequestParam(value="partyId") String partyId, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="contactMechId", required=false) String contactMechId) {
	...
	public ResponseEntity<Map<String, Object>> updatePartyInvitation(HttpSession session, @RequestParam(value="partyInvitationId") String partyInvitationId, @RequestParam(value="partyIdFrom", required=false) String partyIdFrom, @RequestParam(value="emailAddress", required=false) String emailAddress, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="toName", required=false) String toName, @RequestParam(value="lastInviteDate", required=false) Timestamp lastInviteDate, @RequestParam(value="partyId", required=false) String partyId) {
	...
	public ResponseEntity<Map<String, Object>> updateCommunicationEventPrpTyp(HttpSession session, @RequestParam(value="communicationEventPrpTypId") String communicationEventPrpTypId, @RequestParam(value="parentTypeId", required=false) String parentTypeId, @RequestParam(value="hasTable", required=false) String hasTable, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> deleteParty(HttpSession session, @RequestParam(value="partyId", required=false) String partyId) {
	...
	public ResponseEntity<Map<String, Object>> createPartyEmailAddress(HttpSession session, @RequestParam(value="emailAddress") String emailAddress, @RequestParam(value="roleTypeId", required=false) String roleTypeId, @RequestParam(value="extension", required=false) String extension, @RequestParam(value="comments", required=false) String comments, @RequestParam(value="verified", required=false) String verified, @RequestParam(value="contactMechTypeId", required=false) String contactMechTypeId, @RequestParam(value="monthsWithContactMech", required=false) Long monthsWithContactMech, @RequestParam(value="contactMechId", required=false) String contactMechId, @RequestParam(value="thruDate", required=false) Timestamp thruDate, @RequestParam(value="fromDate", required=false) Timestamp fromDate, @RequestParam(value="allowSolicitation", required=false) String allowSolicitation, @RequestParam(value="infoString", required=false) String infoString, @RequestParam(value="yearsWithContactMech", required=false) Long yearsWithContactMech, @RequestParam(value="contactMechPurposeTypeId", required=false) String contactMechPurposeTypeId, @RequestParam(value="partyId", required=false) String partyId) {
	...
	public ResponseEntity<Map<String, Object>> createPartyRelationshipContactAccount(HttpSession session, @RequestParam(value="contactPartyId") String contactPartyId, @RequestParam(value="accountPartyId") String accountPartyId, @RequestParam(value="comments", required=false) String comments) {
	...
	public ResponseEntity<Map<String, Object>> updateCommunicationEventRole(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="communicationEventId") String communicationEventId, @RequestParam(value="partyId") String partyId, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="contactMechId", required=false) String contactMechId) {
	...
	public ResponseEntity<Map<String, Object>> createPostalAddress(HttpSession session, @RequestParam(value="city") String city, @RequestParam(value="address1") String address1, @RequestParam(value="postalCode") String postalCode, @RequestParam(value="countryGeoId", required=false) String countryGeoId, @RequestParam(value="houseNumberExt", required=false) String houseNumberExt, @RequestParam(value="address2", required=false) String address2, @RequestParam(value="postalCodeGeoId", required=false) String postalCodeGeoId, @RequestParam(value="houseNumber", required=false) Long houseNumber, @RequestParam(value="postalCodeExt", required=false) String postalCodeExt, @RequestParam(value="contactMechId", required=false) String contactMechId, @RequestParam(value="attnName", required=false) String attnName, @RequestParam(value="directions", required=false) String directions, @RequestParam(value="countyGeoId", required=false) String countyGeoId, @RequestParam(value="toName", required=false) String toName, @RequestParam(value="cityGeoId", required=false) String cityGeoId, @RequestParam(value="municipalityGeoId", required=false) String municipalityGeoId, @RequestParam(value="stateProvinceGeoId", required=false) String stateProvinceGeoId, @RequestParam(value="geoPointId", required=false) String geoPointId) {
	...
	public ResponseEntity<Map<String, Object>> updateContactMech(HttpSession session, @RequestParam(value="contactMechTypeId") String contactMechTypeId, @RequestParam(value="contactMechId") String contactMechId, @RequestParam(value="infoString", required=false) String infoString) {
	...
	public ResponseEntity<Map<String, Object>> createCustRequestCommEvent(HttpSession session, @RequestParam(value="custRequestId") String custRequestId, @RequestParam(value="communicationEventId") String communicationEventId) {
	...
	public ResponseEntity<Map<String, Object>> createAgreementAttribute(HttpSession session, @RequestParam(value="agreementId") String agreementId, @RequestParam(value="attrName") String attrName, @RequestParam(value="attrDescription", required=false) String attrDescription, @RequestParam(value="attrValue", required=false) Long attrValue) {
	...
	public ResponseEntity<Map<String, Object>> getPartyMainRole(HttpSession session, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> updateTelecomNumber(HttpSession session, @RequestParam(value="contactMechId") String contactMechId, @RequestParam(value="areaCode", required=false) String areaCode, @RequestParam(value="askForName", required=false) String askForName, @RequestParam(value="countryCode", required=false) String countryCode, @RequestParam(value="contactNumber", required=false) String contactNumber) {
	...
	public ResponseEntity<Map<String, Object>> createPartyInvitationGroupAssoc(HttpSession session, @RequestParam(value="partyIdTo") String partyIdTo, @RequestParam(value="partyInvitationId") String partyInvitationId) {
	...
	public ResponseEntity<Map<String, Object>> createPartyRole(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> createPartyAttribute(HttpSession session, @RequestParam(value="productStoreId") String productStoreId, @RequestParam(value="partyId") String partyId, @RequestParam(value="attrDescription", required=false) String attrDescription, @RequestParam(value="attrValue", required=false) Long attrValue) {
	...
	public ResponseEntity<Map<String, Object>> createPartyIdentification(HttpSession session, @RequestParam(value="partyIdentificationTypeId") String partyIdentificationTypeId, @RequestParam(value="partyId") String partyId, @RequestParam(value="idValue", required=false) String idValue) {
	...
	public ResponseEntity<Map<String, Object>> updatePartyIdentification(HttpSession session, @RequestParam(value="partyIdentificationTypeId") String partyIdentificationTypeId, @RequestParam(value="partyId") String partyId, @RequestParam(value="idValue", required=false) String idValue) {
	...
	public ResponseEntity<Map<String, Object>> updatePartyRelationship(HttpSession session, @RequestParam(value="fromDate") Timestamp fromDate, @RequestParam(value="partyIdTo") String partyIdTo, @RequestParam(value="roleTypeIdTo", required=false) String roleTypeIdTo, @RequestParam(value="relationshipName", required=false) String relationshipName, @RequestParam(value="securityGroupId", required=false) String securityGroupId, @RequestParam(value="partyIdFrom", required=false) String partyIdFrom, @RequestParam(value="partyRelationshipTypeId", required=false) String partyRelationshipTypeId, @RequestParam(value="positionTitle", required=false) String positionTitle, @RequestParam(value="comments", required=false) String comments, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="priorityTypeId", required=false) String priorityTypeId, @RequestParam(value="permissionsEnumId", required=false) String permissionsEnumId, @RequestParam(value="roleTypeIdFrom", required=false) String roleTypeIdFrom, @RequestParam(value="thruDate", required=false) Timestamp thruDate) {
	...
	public ResponseEntity<Map<String, Object>> setCommunicationEventRoleStatus(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="statusId") String statusId, @RequestParam(value="communicationEventId") String communicationEventId, @RequestParam(value="partyId") String partyId) {
	...
	public ResponseEntity<Map<String, Object>> deletePartyInvitation(HttpSession session, @RequestParam(value="partyInvitationId") String partyInvitationId) {
	...
	public ResponseEntity<Map<String, Object>> sendAccountActivatedEmailNotification(HttpSession session, @RequestParam(value="userLoginId") String userLoginId, @RequestParam(value="productStoreId") String productStoreId) {
	...
	public ResponseEntity<Map<String, Object>> createPerson(HttpSession session, @RequestParam(value="firstName") String firstName, @RequestParam(value="lastName") String lastName, @RequestParam(value="yearsWithEmployer", required=false) Long yearsWithEmployer, @RequestParam(value="occupation", required=false) String occupation, @RequestParam(value="gender", required=false) String gender, @RequestParam(value="employmentStatusEnumId", required=false) String employmentStatusEnumId, @RequestParam(value="socialSecurityNumber", required=false) String socialSecurityNumber, @RequestParam(value="description", required=false) String description, @RequestParam(value="suffix", required=false) String suffix, @RequestParam(value="mothersMaidenName", required=false) String mothersMaidenName, @RequestParam(value="middleNameLocal", required=false) String middleNameLocal, @RequestParam(value="existingCustomer", required=false) String existingCustomer, @RequestParam(value="residenceStatusEnumId", required=false) String residenceStatusEnumId, @RequestParam(value="nickname", required=false) String nickname, @RequestParam(value="preferredCurrencyUomId", required=false) String preferredCurrencyUomId, @RequestParam(value="partyId", required=false) String partyId, @RequestParam(value="memberId", required=false) String memberId, @RequestParam(value="height", required=false) BigDecimal height, @RequestParam(value="passportNumber", required=false) String passportNumber, @RequestParam(value="lastNameLocal", required=false) String lastNameLocal, @RequestParam(value="comments", required=false) String comments, @RequestParam(value="monthsWithEmployer", required=false) Long monthsWithEmployer, @RequestParam(value="weight", required=false) BigDecimal weight, @RequestParam(value="externalId", required=false) String externalId, @RequestParam(value="birthDate", required=false) Timestamp birthDate, @RequestParam(value="otherLocal", required=false) String otherLocal, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="cardId", required=false) String cardId, @RequestParam(value="middleName", required=false) String middleName, @RequestParam(value="firstNameLocal", required=false) String firstNameLocal, @RequestParam(value="passportExpireDate", required=false) Timestamp passportExpireDate, @RequestParam(value="salutation", required=false) String salutation, @RequestParam(value="personalTitle", required=false) String personalTitle, @RequestParam(value="deceasedDate", required=false) Timestamp deceasedDate, @RequestParam(value="totalYearsWorkExperience", required=false) BigDecimal totalYearsWorkExperience, @RequestParam(value="maritalStatus", required=false) String maritalStatus) {
	...
	public ResponseEntity<Map<String, Object>> createAffiliate(HttpSession session, @RequestParam(value="affiliateName") String affiliateName, @RequestParam(value="partyId") String partyId, @RequestParam(value="yearEstablished", required=false) String yearEstablished, @RequestParam(value="affiliateDescription", required=false) String affiliateDescription, @RequestParam(value="sitePageViews", required=false) String sitePageViews, @RequestParam(value="siteVisitors", required=false) String siteVisitors, @RequestParam(value="siteType", required=false) String siteType) {
	...
	public ResponseEntity<Map<String, Object>> partyRelationshipPermissionCheck(HttpSession session, @RequestParam(value="partyIdFrom", required=false) String partyIdFrom, @RequestParam(value="primaryPermission", required=false) String primaryPermission, @RequestParam(value="altPermission", required=false) String altPermission, @RequestParam(value="resourceDescription", required=false) String resourceDescription, @RequestParam(value="mainAction", required=false) String mainAction) {
	...
	public ResponseEntity<Map<String, Object>> deletePartyInvitationGroupAssoc(HttpSession session, @RequestParam(value="partyIdTo") String partyIdTo, @RequestParam(value="partyInvitationId") String partyInvitationId) {
	...
	public ResponseEntity<Map<String, Object>> partyIdPermissionCheck(HttpSession session, @RequestParam(value="primaryPermission", required=false) String primaryPermission, @RequestParam(value="altPermission", required=false) String altPermission, @RequestParam(value="resourceDescription", required=false) String resourceDescription, @RequestParam(value="partyId", required=false) String partyId, @RequestParam(value="mainAction", required=false) String mainAction) {
	...
	public ResponseEntity<Map<String, Object>> importParty(HttpSession session, @RequestParam(value="uploadedFile", required=false) java.nio.ByteBuffer uploadedFile) {
	...
	public ResponseEntity<Map<String, Object>> deleteContactMechLink(HttpSession session, @RequestParam(value="contactMechIdFrom") String contactMechIdFrom, @RequestParam(value="contactMechIdTo") String contactMechIdTo) {
	...
	public ResponseEntity<Map<String, Object>> updateCommunicationEventPurpose(HttpSession session, @RequestParam(value="communicationEventPrpTypId") String communicationEventPrpTypId, @RequestParam(value="communicationEventId") String communicationEventId, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> createRoleType(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="description") String description, @RequestParam(value="parentTypeId", required=false) String parentTypeId) {
	...
	public ResponseEntity<Map<String, Object>> acceptPartyInvitation(HttpSession session, @RequestParam(value="partyId") String partyId, @RequestParam(value="partyInvitationId") String partyInvitationId) {
	...
	public ResponseEntity<Map<String, Object>> deleteAgreementItemTypeAttr(HttpSession session, @RequestParam(value="agreementItemTypeId") String agreementItemTypeId, @RequestParam(value="attrName") String attrName) {
	...
	public ResponseEntity<Map<String, Object>> deleteCommunicationEventWorkEffort(HttpSession session, @RequestParam(value="communicationEventId") String communicationEventId, @RequestParam(value="delContentDataResource", required=false) String delContentDataResource) {
	...
	public ResponseEntity<Map<String, Object>> deleteRoleTypeAttr(HttpSession session, @RequestParam(value="roleTypeId") String roleTypeId, @RequestParam(value="attrName") String attrName) {
	...
	public ResponseEntity<Map<String, Object>> deletePartyContactMechPurposeIfExists(HttpSession session, @RequestParam(value="contactMechPurposeTypeId") String contactMechPurposeTypeId, @RequestParam(value="contactMechId") String contactMechId, @RequestParam(value="partyId", required=false) String partyId) {
	...
	public ResponseEntity<Map<String, Object>> deleteCommunicationEventPrpTyp(HttpSession session, @RequestParam(value="communicationEventPrpTypId") String communicationEventPrpTypId) {
	...
	public ResponseEntity<Map<String, Object>> removeContactMechAttribute(HttpSession session, @RequestParam(value="contactMechId") String contactMechId, @RequestParam(value="attrName") String attrName) {
	...
	public ResponseEntity<Map<String, Object>> updatePostalAddressAndPurposes(HttpSession session, @RequestParam(value="contactMechId") String contactMechId, @RequestParam(value="houseNumberExt", required=false) String houseNumberExt, @RequestParam(value="extension", required=false) String extension, @RequestParam(value="city", required=false) String city, @RequestParam(value="postalCode", required=false) String postalCode, @RequestParam(value="postalCodeGeoId", required=false) String postalCodeGeoId, @RequestParam(value="houseNumber", required=false) Long houseNumber, @RequestParam(value="postalCodeExt", required=false) String postalCodeExt, @RequestParam(value="attnName", required=false) String attnName, @RequestParam(value="setShippingPurpose", required=false) String setShippingPurpose, @RequestParam(value="countyGeoId", required=false) String countyGeoId, @RequestParam(value="toName", required=false) String toName, @RequestParam(value="cityGeoId", required=false) String cityGeoId, @RequestParam(value="productStoreId", required=false) String productStoreId, @RequestParam(value="partyId", required=false) String partyId, @RequestParam(value="countryGeoId", required=false) String countryGeoId, @RequestParam(value="roleTypeId", required=false) String roleTypeId, @RequestParam(value="comments", required=false) String comments, @RequestParam(value="address2", required=false) String address2, @RequestParam(value="address1", required=false) String address1, @RequestParam(value="verified", required=false) String verified, @RequestParam(value="monthsWithContactMech", required=false) Long monthsWithContactMech, @RequestParam(value="thruDate", required=false) Timestamp thruDate, @RequestParam(value="fromDate", required=false) Timestamp fromDate, @RequestParam(value="setBillingPurpose", required=false) String setBillingPurpose, @RequestParam(value="allowSolicitation", required=false) String allowSolicitation, @RequestParam(value="yearsWithContactMech", required=false) Long yearsWithContactMech, @RequestParam(value="directions", required=false) String directions, @RequestParam(value="municipalityGeoId", required=false) String municipalityGeoId, @RequestParam(value="stateProvinceGeoId", required=false) String stateProvinceGeoId, @RequestParam(value="geoPointId", required=false) String geoPointId) {
	...
	public ResponseEntity<Map<String, Object>> deleteCommunicationEvent(HttpSession session, @RequestParam(value="communicationEventId") String communicationEventId, @RequestParam(value="delContentDataResource", required=false) String delContentDataResource) {
	...
	public ResponseEntity<Map<String, Object>> createPartyContent(HttpSession session, @RequestParam(value="partyContentTypeId") String partyContentTypeId, @RequestParam(value="contentId") String contentId, @RequestParam(value="partyId") String partyId, @RequestParam(value="fromDate", required=false) Timestamp fromDate, @RequestParam(value="thruDate", required=false) Timestamp thruDate) {
