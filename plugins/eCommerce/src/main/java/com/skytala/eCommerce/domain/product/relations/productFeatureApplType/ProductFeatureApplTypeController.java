package com.skytala.eCommerce.domain.product.relations.productFeatureApplType;
...
import com.skytala.eCommerce.domain.product.relations.productFeatureApplType.command.AddProductFeatureApplType;
import com.skytala.eCommerce.domain.product.relations.productFeatureApplType.command.DeleteProductFeatureApplType;
import com.skytala.eCommerce.domain.product.relations.productFeatureApplType.command.UpdateProductFeatureApplType;
import com.skytala.eCommerce.domain.product.relations.productFeatureApplType.event.ProductFeatureApplTypeAdded;
import com.skytala.eCommerce.domain.product.relations.productFeatureApplType.event.ProductFeatureApplTypeDeleted;
import com.skytala.eCommerce.domain.product.relations.productFeatureApplType.event.ProductFeatureApplTypeFound;
...
import com.skytala.eCommerce.domain.product.relations.productFeatureApplType.query.FindProductFeatureApplTypesBy;
