package com.skytala.eCommerce.domain.accounting.relations.paymentGatewaySecurePay;
...
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewaySecurePay.command.AddPaymentGatewaySecurePay;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewaySecurePay.command.DeletePaymentGatewaySecurePay;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewaySecurePay.command.UpdatePaymentGatewaySecurePay;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewaySecurePay.event.PaymentGatewaySecurePayAdded;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewaySecurePay.event.PaymentGatewaySecurePayDeleted;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewaySecurePay.event.PaymentGatewaySecurePayFound;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewaySecurePay.event.PaymentGatewaySecurePayUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewaySecurePay.query.FindPaymentGatewaySecurePaysBy;
