package com.skytala.eCommerce.domain.shipment.relations.picklistRole;
...
import com.skytala.eCommerce.domain.shipment.relations.picklistRole.command.AddPicklistRole;
import com.skytala.eCommerce.domain.shipment.relations.picklistRole.command.DeletePicklistRole;
import com.skytala.eCommerce.domain.shipment.relations.picklistRole.command.UpdatePicklistRole;
import com.skytala.eCommerce.domain.shipment.relations.picklistRole.event.PicklistRoleAdded;
import com.skytala.eCommerce.domain.shipment.relations.picklistRole.event.PicklistRoleDeleted;
...
import com.skytala.eCommerce.domain.shipment.relations.picklistRole.query.FindPicklistRolesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/picklistRoles")
public class PicklistRoleController {
	...
	public boolean updatePicklistRole(HttpServletRequest request) throws Exception {
		...
		if (updatePicklistRole(picklistRoleToBeUpdated, null).getStatusCode()
...
//		picklistRoleToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{picklistRoleId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{picklistRoleId}")
