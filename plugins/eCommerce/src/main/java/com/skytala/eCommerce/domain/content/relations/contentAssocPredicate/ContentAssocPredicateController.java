package com.skytala.eCommerce.domain.content.relations.contentAssocPredicate;
...
import com.skytala.eCommerce.domain.content.relations.contentAssocPredicate.command.AddContentAssocPredicate;
import com.skytala.eCommerce.domain.content.relations.contentAssocPredicate.command.DeleteContentAssocPredicate;
import com.skytala.eCommerce.domain.content.relations.contentAssocPredicate.command.UpdateContentAssocPredicate;
import com.skytala.eCommerce.domain.content.relations.contentAssocPredicate.event.ContentAssocPredicateAdded;
import com.skytala.eCommerce.domain.content.relations.contentAssocPredicate.event.ContentAssocPredicateDeleted;
import com.skytala.eCommerce.domain.content.relations.contentAssocPredicate.event.ContentAssocPredicateFound;
import com.skytala.eCommerce.domain.content.relations.contentAssocPredicate.event.ContentAssocPredicateUpdated;
import com.skytala.eCommerce.domain.content.relations.contentAssocPredicate.mapper.ContentAssocPredicateMapper;
import com.skytala.eCommerce.domain.content.relations.contentAssocPredicate.model.ContentAssocPredicate;
import com.skytala.eCommerce.domain.content.relations.contentAssocPredicate.query.FindContentAssocPredicatesBy;
