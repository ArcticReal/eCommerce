...
public class DeleteFixedAssetTypeGlAccount extends Command {

private String toBeDeletedId;
public DeleteFixedAssetTypeGlAccount(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("FixedAssetTypeGlAccount", UtilMisc.toMap("fixedAssetTypeGlAccountId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new FixedAssetTypeGlAccountDeleted(success);
