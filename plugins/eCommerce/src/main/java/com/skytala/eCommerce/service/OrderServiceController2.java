...
@RestController
@RequestMapping("/service/OrderController2")
public class OrderServiceController2{
	...
	public ResponseEntity<Object> getOrderHeaderInformation(HttpSession session, @RequestParam(value="orderId") String orderId, @RequestParam(value="invoicePerShipment", required=false) Boolean invoicePerShipment, @RequestParam(value="salesChannelEnumId", required=false) String salesChannelEnumId, @RequestParam(value="orderTypeId", required=false) String orderTypeId, @RequestParam(value="billingAccountId", required=false) String billingAccountId, @RequestParam(value="terminalId", required=false) String terminalId, @RequestParam(value="isViewed", required=false) Boolean isViewed, @RequestParam(value="visitId", required=false) String visitId, @RequestParam(value="productStoreId", required=false) String productStoreId, @RequestParam(value="remainingSubTotal", required=false) BigDecimal remainingSubTotal, @RequestParam(value="orderName", required=false) String orderName, @RequestParam(value="webSiteId", required=false) String webSiteId, @RequestParam(value="isRushOrder", required=false) Boolean isRushOrder, @RequestParam(value="entryDate", required=false) Timestamp entryDate, @RequestParam(value="grandTotal", required=false) BigDecimal grandTotal, @RequestParam(value="autoOrderShoppingListId", required=false) String autoOrderShoppingListId, @RequestParam(value="externalId", required=false) String externalId, @RequestParam(value="priority", required=false) Boolean priority, @RequestParam(value="transactionId", required=false) String transactionId, @RequestParam(value="firstAttemptOrderId", required=false) String firstAttemptOrderId, @RequestParam(value="originFacilityId", required=false) String originFacilityId, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="createdBy", required=false) String createdBy, @RequestParam(value="currencyUom", required=false) String currencyUom, @RequestParam(value="syncStatusId", required=false) String syncStatusId, @RequestParam(value="pickSheetPrintedDate", required=false) Timestamp pickSheetPrintedDate, @RequestParam(value="needsInventoryIssuance", required=false) Boolean needsInventoryIssuance, @RequestParam(value="orderDate", required=false) Timestamp orderDate, @RequestParam(value="internalCode", required=false) String internalCode) {
	...
	public ResponseEntity<Object> updateOrderHeader(HttpSession session, @RequestParam(value="orderId") String orderId, @RequestParam(value="invoicePerShipment", required=false) Boolean invoicePerShipment, @RequestParam(value="salesChannelEnumId", required=false) String salesChannelEnumId, @RequestParam(value="orderTypeId", required=false) String orderTypeId, @RequestParam(value="billingAccountId", required=false) String billingAccountId, @RequestParam(value="terminalId", required=false) String terminalId, @RequestParam(value="isViewed", required=false) Boolean isViewed, @RequestParam(value="visitId", required=false) String visitId, @RequestParam(value="productStoreId", required=false) String productStoreId, @RequestParam(value="remainingSubTotal", required=false) BigDecimal remainingSubTotal, @RequestParam(value="orderName", required=false) String orderName, @RequestParam(value="webSiteId", required=false) String webSiteId, @RequestParam(value="isRushOrder", required=false) Boolean isRushOrder, @RequestParam(value="entryDate", required=false) Timestamp entryDate, @RequestParam(value="grandTotal", required=false) BigDecimal grandTotal, @RequestParam(value="autoOrderShoppingListId", required=false) String autoOrderShoppingListId, @RequestParam(value="externalId", required=false) String externalId, @RequestParam(value="priority", required=false) Boolean priority, @RequestParam(value="transactionId", required=false) String transactionId, @RequestParam(value="firstAttemptOrderId", required=false) String firstAttemptOrderId, @RequestParam(value="originFacilityId", required=false) String originFacilityId, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="createdBy", required=false) String createdBy, @RequestParam(value="currencyUom", required=false) String currencyUom, @RequestParam(value="syncStatusId", required=false) String syncStatusId, @RequestParam(value="pickSheetPrintedDate", required=false) Timestamp pickSheetPrintedDate, @RequestParam(value="needsInventoryIssuance", required=false) Boolean needsInventoryIssuance, @RequestParam(value="orderDate", required=false) Timestamp orderDate, @RequestParam(value="internalCode", required=false) String internalCode) {
	...
	public ResponseEntity<Object> createOrderHeader(HttpSession session, @RequestParam(value="invoicePerShipment", required=false) Boolean invoicePerShipment, @RequestParam(value="salesChannelEnumId", required=false) String salesChannelEnumId, @RequestParam(value="orderId", required=false) String orderId, @RequestParam(value="orderTypeId", required=false) String orderTypeId, @RequestParam(value="billingAccountId", required=false) String billingAccountId, @RequestParam(value="terminalId", required=false) String terminalId, @RequestParam(value="isViewed", required=false) Boolean isViewed, @RequestParam(value="visitId", required=false) String visitId, @RequestParam(value="productStoreId", required=false) String productStoreId, @RequestParam(value="remainingSubTotal", required=false) BigDecimal remainingSubTotal, @RequestParam(value="orderName", required=false) String orderName, @RequestParam(value="webSiteId", required=false) String webSiteId, @RequestParam(value="isRushOrder", required=false) Boolean isRushOrder, @RequestParam(value="entryDate", required=false) Timestamp entryDate, @RequestParam(value="grandTotal", required=false) BigDecimal grandTotal, @RequestParam(value="autoOrderShoppingListId", required=false) String autoOrderShoppingListId, @RequestParam(value="externalId", required=false) String externalId, @RequestParam(value="priority", required=false) Boolean priority, @RequestParam(value="transactionId", required=false) String transactionId, @RequestParam(value="firstAttemptOrderId", required=false) String firstAttemptOrderId, @RequestParam(value="originFacilityId", required=false) String originFacilityId, @RequestParam(value="statusId", required=false) String statusId, @RequestParam(value="createdBy", required=false) String createdBy, @RequestParam(value="currencyUom", required=false) String currencyUom, @RequestParam(value="syncStatusId", required=false) String syncStatusId, @RequestParam(value="pickSheetPrintedDate", required=false) Timestamp pickSheetPrintedDate, @RequestParam(value="needsInventoryIssuance", required=false) Boolean needsInventoryIssuance, @RequestParam(value="orderDate", required=false) Timestamp orderDate, @RequestParam(value="internalCode", required=false) String internalCode) {
	...
	public ResponseEntity<Object> createOrderNotificationLog(HttpSession session, @RequestParam(value="orderNotificationId") String orderNotificationId, @RequestParam(value="orderId") String orderId, @RequestParam(value="emailType") String emailType, @RequestParam(value="comments", required=false) String comments) {
