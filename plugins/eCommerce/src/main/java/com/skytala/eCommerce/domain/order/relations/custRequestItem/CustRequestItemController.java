package com.skytala.eCommerce.domain.order.relations.custRequestItem;
...
import com.skytala.eCommerce.domain.order.relations.custRequestItem.command.AddCustRequestItem;
import com.skytala.eCommerce.domain.order.relations.custRequestItem.command.DeleteCustRequestItem;
import com.skytala.eCommerce.domain.order.relations.custRequestItem.command.UpdateCustRequestItem;
import com.skytala.eCommerce.domain.order.relations.custRequestItem.event.CustRequestItemAdded;
import com.skytala.eCommerce.domain.order.relations.custRequestItem.event.CustRequestItemDeleted;
import com.skytala.eCommerce.domain.order.relations.custRequestItem.event.CustRequestItemFound;
...
import com.skytala.eCommerce.domain.order.relations.custRequestItem.query.FindCustRequestItemsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/custRequestItems")
public class CustRequestItemController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{custRequestItemId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{custRequestItemId}")
