...
public class DeletePerformanceNote extends Command {

private String toBeDeletedId;
public DeletePerformanceNote(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PerformanceNote", UtilMisc.toMap("performanceNoteId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PerformanceNoteDeleted(success);
