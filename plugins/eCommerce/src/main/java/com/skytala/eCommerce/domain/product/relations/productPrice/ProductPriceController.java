package com.skytala.eCommerce.domain.product.relations.productPrice;
...
import com.skytala.eCommerce.domain.product.relations.productPrice.command.AddProductPrice;
import com.skytala.eCommerce.domain.product.relations.productPrice.command.DeleteProductPrice;
import com.skytala.eCommerce.domain.product.relations.productPrice.command.UpdateProductPrice;
import com.skytala.eCommerce.domain.product.relations.productPrice.event.ProductPriceAdded;
import com.skytala.eCommerce.domain.product.relations.productPrice.event.ProductPriceDeleted;
import com.skytala.eCommerce.domain.product.relations.productPrice.event.ProductPriceFound;
import com.skytala.eCommerce.domain.product.relations.productPrice.event.ProductPriceUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productPrice.query.FindProductPricesBy;
