...
public class DeleteOrderShipment extends Command {

private String toBeDeletedId;
public DeleteOrderShipment(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderShipment", UtilMisc.toMap("orderShipmentId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderShipmentDeleted(success);
