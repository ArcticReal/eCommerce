package com.skytala.eCommerce.domain.returnReason;
...
import com.skytala.eCommerce.domain.returnReason.command.AddReturnReason;
import com.skytala.eCommerce.domain.returnReason.command.DeleteReturnReason;
import com.skytala.eCommerce.domain.returnReason.command.UpdateReturnReason;
import com.skytala.eCommerce.domain.returnReason.event.ReturnReasonAdded;
import com.skytala.eCommerce.domain.returnReason.event.ReturnReasonDeleted;
import com.skytala.eCommerce.domain.returnReason.event.ReturnReasonFound;
import com.skytala.eCommerce.domain.returnReason.event.ReturnReasonUpdated;
...
import com.skytala.eCommerce.domain.returnReason.query.FindReturnReasonsBy;
...
public class ReturnReasonController {
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/returnReason/\" plus one of the following: "
				+ "";
