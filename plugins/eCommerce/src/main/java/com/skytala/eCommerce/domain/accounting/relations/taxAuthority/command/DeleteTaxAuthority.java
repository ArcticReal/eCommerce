...
public class DeleteTaxAuthority extends Command {

private String toBeDeletedId;
public DeleteTaxAuthority(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("TaxAuthority", UtilMisc.toMap("taxAuthorityId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new TaxAuthorityDeleted(success);
