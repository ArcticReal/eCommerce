...
public class DeleteReturnHeader extends Command {

private String toBeDeletedId;
public DeleteReturnHeader(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ReturnHeader", UtilMisc.toMap("returnHeaderId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ReturnHeaderDeleted(success);
