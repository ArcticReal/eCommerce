...
public class DeletePartySkill extends Command {

private String toBeDeletedId;
public DeletePartySkill(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartySkill", UtilMisc.toMap("partySkillId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartySkillDeleted(success);
