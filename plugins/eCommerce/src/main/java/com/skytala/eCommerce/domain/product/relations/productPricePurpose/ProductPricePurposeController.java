package com.skytala.eCommerce.domain.product.relations.productPricePurpose;
...
import com.skytala.eCommerce.domain.product.relations.productPricePurpose.command.AddProductPricePurpose;
import com.skytala.eCommerce.domain.product.relations.productPricePurpose.command.DeleteProductPricePurpose;
import com.skytala.eCommerce.domain.product.relations.productPricePurpose.command.UpdateProductPricePurpose;
import com.skytala.eCommerce.domain.product.relations.productPricePurpose.event.ProductPricePurposeAdded;
import com.skytala.eCommerce.domain.product.relations.productPricePurpose.event.ProductPricePurposeDeleted;
import com.skytala.eCommerce.domain.product.relations.productPricePurpose.event.ProductPricePurposeFound;
import com.skytala.eCommerce.domain.product.relations.productPricePurpose.event.ProductPricePurposeUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productPricePurpose.query.FindProductPricePurposesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/productPricePurposes")
