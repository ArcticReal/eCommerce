...
public class DeleteCostComponentTypeAttr extends Command {

private String toBeDeletedId;
public DeleteCostComponentTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CostComponentTypeAttr", UtilMisc.toMap("costComponentTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CostComponentTypeAttrDeleted(success);
