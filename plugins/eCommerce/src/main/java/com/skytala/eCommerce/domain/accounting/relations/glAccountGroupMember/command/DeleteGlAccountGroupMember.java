...
public class DeleteGlAccountGroupMember extends Command {

private String toBeDeletedId;
public DeleteGlAccountGroupMember(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("GlAccountGroupMember", UtilMisc.toMap("glAccountGroupMemberId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new GlAccountGroupMemberDeleted(success);
