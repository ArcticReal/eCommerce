package com.skytala.eCommerce.domain.accounting.relations.fixedAssetProduct;
...
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetProduct.command.AddFixedAssetProduct;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetProduct.command.DeleteFixedAssetProduct;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetProduct.command.UpdateFixedAssetProduct;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetProduct.event.FixedAssetProductAdded;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetProduct.event.FixedAssetProductDeleted;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetProduct.event.FixedAssetProductFound;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetProduct.event.FixedAssetProductUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetProduct.query.FindFixedAssetProductsBy;
