...
public class DeleteCustRequest extends Command {

private String toBeDeletedId;
public DeleteCustRequest(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CustRequest", UtilMisc.toMap("custRequestId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CustRequestDeleted(success);
