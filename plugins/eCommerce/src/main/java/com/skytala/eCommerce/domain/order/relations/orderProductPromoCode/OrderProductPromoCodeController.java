...
@RestController
@RequestMapping("/orderProductPromoCodes")
...
//		orderProductPromoCodeToBeUpdated.setnull(null);
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/orderProductPromoCode/\" plus one of the following: "
				+ "";
