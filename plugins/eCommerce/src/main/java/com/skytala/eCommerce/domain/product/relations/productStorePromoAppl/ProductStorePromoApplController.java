package com.skytala.eCommerce.domain.product.relations.productStorePromoAppl;
...
import com.skytala.eCommerce.domain.product.relations.productStorePromoAppl.command.AddProductStorePromoAppl;
import com.skytala.eCommerce.domain.product.relations.productStorePromoAppl.command.DeleteProductStorePromoAppl;
import com.skytala.eCommerce.domain.product.relations.productStorePromoAppl.command.UpdateProductStorePromoAppl;
import com.skytala.eCommerce.domain.product.relations.productStorePromoAppl.event.ProductStorePromoApplAdded;
import com.skytala.eCommerce.domain.product.relations.productStorePromoAppl.event.ProductStorePromoApplDeleted;
import com.skytala.eCommerce.domain.product.relations.productStorePromoAppl.event.ProductStorePromoApplFound;
import com.skytala.eCommerce.domain.product.relations.productStorePromoAppl.event.ProductStorePromoApplUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productStorePromoAppl.query.FindProductStorePromoApplsBy;
