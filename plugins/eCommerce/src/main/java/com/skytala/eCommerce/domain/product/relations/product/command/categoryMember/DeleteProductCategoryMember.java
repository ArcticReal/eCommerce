package com.skytala.eCommerce.domain.product.relations.product.command.categoryMember;
...
public class DeleteProductCategoryMember extends Command {

private String toBeDeletedId;
public DeleteProductCategoryMember(String toBeDeletedId){
...
Event resultingEvent = new ProductCategoryMemberDeleted(success);
