...
public class DeleteRespondingParty extends Command {

private String toBeDeletedId;
public DeleteRespondingParty(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("RespondingParty", UtilMisc.toMap("respondingPartyId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new RespondingPartyDeleted(success);
