...
public class DeleteOrderItem extends Command {

private String toBeDeletedId;
public DeleteOrderItem(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderItem", UtilMisc.toMap("orderItemId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderItemDeleted(success);
