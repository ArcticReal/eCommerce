...
public class DeletePicklistItem extends Command {

private String toBeDeletedId;
public DeletePicklistItem(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PicklistItem", UtilMisc.toMap("picklistItemId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PicklistItemDeleted(success);
