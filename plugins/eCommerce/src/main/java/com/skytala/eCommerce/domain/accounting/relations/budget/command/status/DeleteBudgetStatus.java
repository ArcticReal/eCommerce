...
public class DeleteBudgetStatus extends Command {

private String toBeDeletedId;
public DeleteBudgetStatus(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("BudgetStatus", UtilMisc.toMap("budgetStatusId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new BudgetStatusDeleted(success);
