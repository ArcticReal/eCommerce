...
@RestController
@RequestMapping("/service/MarketingComponentController")
public class MarketingComponentServiceController{
	...
	public ResponseEntity<Object> createSegmentGroup(HttpSession session, @RequestParam(value="segmentGroupId") String segmentGroupId, @RequestParam(value="description", required=false) String description, @RequestParam(value="productStoreId", required=false) String productStoreId, @RequestParam(value="segmentGroupTypeId", required=false) String segmentGroupTypeId) {
