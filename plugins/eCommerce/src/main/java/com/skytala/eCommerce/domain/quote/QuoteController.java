package com.skytala.eCommerce.domain.quote;
...
import com.skytala.eCommerce.domain.quote.command.AddQuote;
import com.skytala.eCommerce.domain.quote.command.DeleteQuote;
import com.skytala.eCommerce.domain.quote.command.UpdateQuote;
import com.skytala.eCommerce.domain.quote.event.QuoteAdded;
import com.skytala.eCommerce.domain.quote.event.QuoteDeleted;
import com.skytala.eCommerce.domain.quote.event.QuoteFound;
import com.skytala.eCommerce.domain.quote.event.QuoteUpdated;
import com.skytala.eCommerce.domain.quote.mapper.QuoteMapper;
import com.skytala.eCommerce.domain.quote.model.Quote;
import com.skytala.eCommerce.domain.quote.query.FindQuotesBy;
