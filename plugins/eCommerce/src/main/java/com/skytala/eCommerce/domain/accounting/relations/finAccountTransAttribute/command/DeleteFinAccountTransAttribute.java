...
public class DeleteFinAccountTransAttribute extends Command {

private String toBeDeletedId;
public DeleteFinAccountTransAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("FinAccountTransAttribute", UtilMisc.toMap("finAccountTransAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new FinAccountTransAttributeDeleted(success);
