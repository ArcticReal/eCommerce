package com.skytala.eCommerce.domain.product.relations.facilityType;
...
import com.skytala.eCommerce.domain.product.relations.facilityType.command.AddFacilityType;
import com.skytala.eCommerce.domain.product.relations.facilityType.command.DeleteFacilityType;
import com.skytala.eCommerce.domain.product.relations.facilityType.command.UpdateFacilityType;
import com.skytala.eCommerce.domain.product.relations.facilityType.event.FacilityTypeAdded;
import com.skytala.eCommerce.domain.product.relations.facilityType.event.FacilityTypeDeleted;
...
import com.skytala.eCommerce.domain.product.relations.facilityType.query.FindFacilityTypesBy;
