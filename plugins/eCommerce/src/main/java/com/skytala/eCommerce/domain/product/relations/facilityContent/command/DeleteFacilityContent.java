...
public class DeleteFacilityContent extends Command {

private String toBeDeletedId;
public DeleteFacilityContent(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("FacilityContent", UtilMisc.toMap("facilityContentId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new FacilityContentDeleted(success);
