...
public class DeleteSubscriptionAttribute extends Command {

private String toBeDeletedId;
public DeleteSubscriptionAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("SubscriptionAttribute", UtilMisc.toMap("subscriptionAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new SubscriptionAttributeDeleted(success);
