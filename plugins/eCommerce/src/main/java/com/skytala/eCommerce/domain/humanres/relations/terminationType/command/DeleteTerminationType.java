...
public class DeleteTerminationType extends Command {

private String toBeDeletedId;
public DeleteTerminationType(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("TerminationType", UtilMisc.toMap("terminationTypeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new TerminationTypeDeleted(success);
