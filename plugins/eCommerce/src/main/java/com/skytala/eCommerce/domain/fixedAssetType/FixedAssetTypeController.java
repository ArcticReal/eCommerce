package com.skytala.eCommerce.domain.fixedAssetType;
...
import com.skytala.eCommerce.domain.fixedAssetType.command.AddFixedAssetType;
import com.skytala.eCommerce.domain.fixedAssetType.command.DeleteFixedAssetType;
import com.skytala.eCommerce.domain.fixedAssetType.command.UpdateFixedAssetType;
import com.skytala.eCommerce.domain.fixedAssetType.event.FixedAssetTypeAdded;
import com.skytala.eCommerce.domain.fixedAssetType.event.FixedAssetTypeDeleted;
...
import com.skytala.eCommerce.domain.fixedAssetType.query.FindFixedAssetTypesBy;
