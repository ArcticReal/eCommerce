package com.skytala.eCommerce.domain.accounting.relations.fixedAssetDepMethod;
...
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetDepMethod.command.AddFixedAssetDepMethod;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetDepMethod.command.DeleteFixedAssetDepMethod;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetDepMethod.command.UpdateFixedAssetDepMethod;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetDepMethod.event.FixedAssetDepMethodAdded;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetDepMethod.event.FixedAssetDepMethodDeleted;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetDepMethod.event.FixedAssetDepMethodFound;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetDepMethod.event.FixedAssetDepMethodUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetDepMethod.query.FindFixedAssetDepMethodsBy;
...
//		fixedAssetDepMethodToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{fixedAssetDepMethodId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{fixedAssetDepMethodId}")
