...
@RestController
@RequestMapping("/service/PartyComponentController3")
public class PartyComponentServiceController3{
	...
	public ResponseEntity<Object> createPartyClassificationGroup(HttpSession session, @RequestParam(value="partyClassificationGroupId") String partyClassificationGroupId, @RequestParam(value="parentGroupId", required=false) String parentGroupId, @RequestParam(value="description", required=false) String description, @RequestParam(value="partyClassificationTypeId", required=false) String partyClassificationTypeId) {
	...
	public ResponseEntity<Object> createEmailAddress(HttpSession session, @RequestParam(value="emailAddress") String emailAddress, @RequestParam(value="contactMechId") String contactMechId, @RequestParam(value="infoString", required=false) String infoString, @RequestParam(value="contactMechTypeId", required=false) String contactMechTypeId) {
