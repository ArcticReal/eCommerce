package com.skytala.eCommerce.domain.product.relations.productFeatureGroup;
...
import com.skytala.eCommerce.domain.product.relations.productFeatureGroup.command.AddProductFeatureGroup;
import com.skytala.eCommerce.domain.product.relations.productFeatureGroup.command.DeleteProductFeatureGroup;
import com.skytala.eCommerce.domain.product.relations.productFeatureGroup.command.UpdateProductFeatureGroup;
import com.skytala.eCommerce.domain.product.relations.productFeatureGroup.event.ProductFeatureGroupAdded;
import com.skytala.eCommerce.domain.product.relations.productFeatureGroup.event.ProductFeatureGroupDeleted;
import com.skytala.eCommerce.domain.product.relations.productFeatureGroup.event.ProductFeatureGroupFound;
import com.skytala.eCommerce.domain.product.relations.productFeatureGroup.event.ProductFeatureGroupUpdated;
import com.skytala.eCommerce.domain.product.relations.productFeatureGroup.mapper.ProductFeatureGroupMapper;
import com.skytala.eCommerce.domain.product.relations.productFeatureGroup.model.ProductFeatureGroup;
import com.skytala.eCommerce.domain.product.relations.productFeatureGroup.query.FindProductFeatureGroupsBy;
