...
public class DeleteProductOrderItem extends Command {

private String toBeDeletedId;
public DeleteProductOrderItem(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductOrderItem", UtilMisc.toMap("productOrderItemId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductOrderItemDeleted(success);
