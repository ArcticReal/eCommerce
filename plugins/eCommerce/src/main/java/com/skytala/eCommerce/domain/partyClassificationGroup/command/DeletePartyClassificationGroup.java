...
public class DeletePartyClassificationGroup extends Command {

private String toBeDeletedId;
public DeletePartyClassificationGroup(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyClassificationGroup", UtilMisc.toMap("partyClassificationGroupId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyClassificationGroupDeleted(success);
