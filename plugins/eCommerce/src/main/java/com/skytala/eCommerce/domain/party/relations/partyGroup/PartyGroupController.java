package com.skytala.eCommerce.domain.party.relations.partyGroup;
...
import com.skytala.eCommerce.domain.party.relations.partyGroup.command.AddPartyGroup;
import com.skytala.eCommerce.domain.party.relations.partyGroup.command.DeletePartyGroup;
import com.skytala.eCommerce.domain.party.relations.partyGroup.command.UpdatePartyGroup;
import com.skytala.eCommerce.domain.party.relations.partyGroup.event.PartyGroupAdded;
import com.skytala.eCommerce.domain.party.relations.partyGroup.event.PartyGroupDeleted;
import com.skytala.eCommerce.domain.party.relations.partyGroup.event.PartyGroupFound;
import com.skytala.eCommerce.domain.party.relations.partyGroup.event.PartyGroupUpdated;
...
import com.skytala.eCommerce.domain.party.relations.partyGroup.query.FindPartyGroupsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/partyGroups")
...
//		partyGroupToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{partyGroupId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{partyGroupId}")
