...
public class DeleteCartAbandonedLine extends Command {

private String toBeDeletedId;
public DeleteCartAbandonedLine(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CartAbandonedLine", UtilMisc.toMap("cartAbandonedLineId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CartAbandonedLineDeleted(success);
