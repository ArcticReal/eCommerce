...
public class DeleteOrderType extends Command {

private String toBeDeletedId;
public DeleteOrderType(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderType", UtilMisc.toMap("orderTypeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderTypeDeleted(success);
