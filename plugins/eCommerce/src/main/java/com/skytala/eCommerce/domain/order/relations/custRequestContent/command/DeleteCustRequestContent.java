...
public class DeleteCustRequestContent extends Command {

private String toBeDeletedId;
public DeleteCustRequestContent(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CustRequestContent", UtilMisc.toMap("custRequestContentId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CustRequestContentDeleted(success);
