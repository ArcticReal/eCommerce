...
public class DeleteProductKeyword extends Command {

private String toBeDeletedId;
public DeleteProductKeyword(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductKeyword", UtilMisc.toMap("productKeywordId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductKeywordDeleted(success);
