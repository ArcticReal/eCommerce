...
public class DeleteReturnContactMech extends Command {

private String toBeDeletedId;
public DeleteReturnContactMech(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ReturnContactMech", UtilMisc.toMap("returnContactMechId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ReturnContactMechDeleted(success);
