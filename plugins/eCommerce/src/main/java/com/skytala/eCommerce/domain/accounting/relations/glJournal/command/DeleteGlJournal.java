...
public class DeleteGlJournal extends Command {

private String toBeDeletedId;
public DeleteGlJournal(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("GlJournal", UtilMisc.toMap("glJournalId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new GlJournalDeleted(success);
