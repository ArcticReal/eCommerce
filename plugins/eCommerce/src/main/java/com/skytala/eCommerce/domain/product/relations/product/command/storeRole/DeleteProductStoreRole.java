...
public class DeleteProductStoreRole extends Command {

private String toBeDeletedId;
public DeleteProductStoreRole(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductStoreRole", UtilMisc.toMap("productStoreRoleId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductStoreRoleDeleted(success);
