package com.skytala.eCommerce.domain.finAccountTrans;
...
import com.skytala.eCommerce.domain.finAccountTrans.command.AddFinAccountTrans;
import com.skytala.eCommerce.domain.finAccountTrans.command.DeleteFinAccountTrans;
import com.skytala.eCommerce.domain.finAccountTrans.command.UpdateFinAccountTrans;
import com.skytala.eCommerce.domain.finAccountTrans.event.FinAccountTransAdded;
import com.skytala.eCommerce.domain.finAccountTrans.event.FinAccountTransDeleted;
import com.skytala.eCommerce.domain.finAccountTrans.event.FinAccountTransFound;
import com.skytala.eCommerce.domain.finAccountTrans.event.FinAccountTransUpdated;
...
import com.skytala.eCommerce.domain.finAccountTrans.query.FindFinAccountTranssBy;
