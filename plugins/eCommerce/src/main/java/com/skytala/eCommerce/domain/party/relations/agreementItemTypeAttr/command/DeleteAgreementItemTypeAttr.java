...
public class DeleteAgreementItemTypeAttr extends Command {

private String toBeDeletedId;
public DeleteAgreementItemTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("AgreementItemTypeAttr", UtilMisc.toMap("agreementItemTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new AgreementItemTypeAttrDeleted(success);
