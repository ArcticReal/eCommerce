...
@RestController
@RequestMapping("/service/AccountingController17")
public class AccountingServiceController17{
	...
	public ResponseEntity<Object> updatePartyRate(HttpSession session, @RequestParam(value="rateTypeId") String rateTypeId, @RequestParam(value="periodTypeId") String periodTypeId, @RequestParam(value="partyId") String partyId, @RequestParam(value="fromDate", required=false) Timestamp fromDate, @RequestParam(value="percentageUsed", required=false) BigDecimal percentageUsed, @RequestParam(value="defaultRate", required=false) Boolean defaultRate, @RequestParam(value="rateAmount", required=false) BigDecimal rateAmount, @RequestParam(value="organizationPartyId", required=false) String organizationPartyId, @RequestParam(value="rateCurrencyUomId", required=false) String rateCurrencyUomId, @RequestParam(value="thruDate", required=false) Timestamp thruDate) {
