...
public class DeleteTechDataCalendar extends Command {

private String toBeDeletedId;
public DeleteTechDataCalendar(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("TechDataCalendar", UtilMisc.toMap("techDataCalendarId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new TechDataCalendarDeleted(success);
