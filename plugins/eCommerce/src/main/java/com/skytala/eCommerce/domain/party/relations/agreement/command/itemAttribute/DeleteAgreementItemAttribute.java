...
public class DeleteAgreementItemAttribute extends Command {

private String toBeDeletedId;
public DeleteAgreementItemAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("AgreementItemAttribute", UtilMisc.toMap("agreementItemAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new AgreementItemAttributeDeleted(success);
