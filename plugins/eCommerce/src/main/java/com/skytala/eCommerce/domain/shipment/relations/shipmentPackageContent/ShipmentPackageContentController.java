package com.skytala.eCommerce.domain.shipment.relations.shipmentPackageContent;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageContent.command.AddShipmentPackageContent;
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageContent.command.DeleteShipmentPackageContent;
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageContent.command.UpdateShipmentPackageContent;
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageContent.event.ShipmentPackageContentAdded;
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageContent.event.ShipmentPackageContentDeleted;
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageContent.event.ShipmentPackageContentFound;
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageContent.event.ShipmentPackageContentUpdated;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentPackageContent.query.FindShipmentPackageContentsBy;
