...
public class DeleteRoleTypeAttr extends Command {

private String toBeDeletedId;
public DeleteRoleTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("RoleTypeAttr", UtilMisc.toMap("roleTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new RoleTypeAttrDeleted(success);
