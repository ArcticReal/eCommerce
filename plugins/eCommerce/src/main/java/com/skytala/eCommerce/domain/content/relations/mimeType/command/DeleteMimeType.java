...
public class DeleteMimeType extends Command {

private String toBeDeletedId;
public DeleteMimeType(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("MimeType", UtilMisc.toMap("mimeTypeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new MimeTypeDeleted(success);
