package com.skytala.eCommerce.domain.workeffort.relations.workEffortSkillStandard;
...
import com.skytala.eCommerce.domain.workeffort.relations.workEffortSkillStandard.command.AddWorkEffortSkillStandard;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortSkillStandard.command.DeleteWorkEffortSkillStandard;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortSkillStandard.command.UpdateWorkEffortSkillStandard;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortSkillStandard.event.WorkEffortSkillStandardAdded;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortSkillStandard.event.WorkEffortSkillStandardDeleted;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortSkillStandard.event.WorkEffortSkillStandardFound;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortSkillStandard.event.WorkEffortSkillStandardUpdated;
...
import com.skytala.eCommerce.domain.workeffort.relations.workEffortSkillStandard.query.FindWorkEffortSkillStandardsBy;
