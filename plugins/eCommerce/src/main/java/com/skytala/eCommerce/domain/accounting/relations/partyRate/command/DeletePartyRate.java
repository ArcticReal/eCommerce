...
public class DeletePartyRate extends Command {

private String toBeDeletedId;
public DeletePartyRate(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyRate", UtilMisc.toMap("partyRateId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyRateDeleted(success);
