...
@RestController
@RequestMapping("/service/OrderpermissionCheckingLogicController")
public class OrderpermissionCheckingLogicController{

	@RequestMapping(method = RequestMethod.POST, value = "/returnPermissionCheck")
	public ResponseEntity<Object> returnPermissionCheck(HttpSession session, @RequestParam(value="primaryPermission", required=false) String primaryPermission, @RequestParam(value="altPermission", required=false) String altPermission, @RequestParam(value="resourceDescription", required=false) String resourceDescription, @RequestParam(value="mainAction", required=false) String mainAction) {
		...
		try {
			result = dispatcher.runSync("returnPermissionCheck", paramMap);
