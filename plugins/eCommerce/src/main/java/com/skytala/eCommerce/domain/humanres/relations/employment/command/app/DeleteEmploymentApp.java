...
public class DeleteEmploymentApp extends Command {

private String toBeDeletedId;
public DeleteEmploymentApp(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("EmploymentApp", UtilMisc.toMap("employmentAppId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new EmploymentAppDeleted(success);
