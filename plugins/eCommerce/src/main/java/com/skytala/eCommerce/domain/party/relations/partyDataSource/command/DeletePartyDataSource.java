...
public class DeletePartyDataSource extends Command {

private String toBeDeletedId;
public DeletePartyDataSource(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyDataSource", UtilMisc.toMap("partyDataSourceId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyDataSourceDeleted(success);
