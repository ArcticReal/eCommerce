package com.skytala.eCommerce.domain.inventoryItem;
...
import com.skytala.eCommerce.domain.inventoryItem.command.AddInventoryItem;
import com.skytala.eCommerce.domain.inventoryItem.command.DeleteInventoryItem;
import com.skytala.eCommerce.domain.inventoryItem.command.UpdateInventoryItem;
import com.skytala.eCommerce.domain.inventoryItem.event.InventoryItemAdded;
import com.skytala.eCommerce.domain.inventoryItem.event.InventoryItemDeleted;
...
import com.skytala.eCommerce.domain.inventoryItem.query.FindInventoryItemsBy;
