package com.skytala.eCommerce.domain.accounting.relations.invoiceRole;
...
import com.skytala.eCommerce.domain.accounting.relations.invoiceRole.command.AddInvoiceRole;
import com.skytala.eCommerce.domain.accounting.relations.invoiceRole.command.DeleteInvoiceRole;
import com.skytala.eCommerce.domain.accounting.relations.invoiceRole.command.UpdateInvoiceRole;
import com.skytala.eCommerce.domain.accounting.relations.invoiceRole.event.InvoiceRoleAdded;
import com.skytala.eCommerce.domain.accounting.relations.invoiceRole.event.InvoiceRoleDeleted;
...
import com.skytala.eCommerce.domain.accounting.relations.invoiceRole.query.FindInvoiceRolesBy;
