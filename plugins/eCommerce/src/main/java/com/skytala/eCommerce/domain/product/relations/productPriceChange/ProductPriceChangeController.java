package com.skytala.eCommerce.domain.product.relations.productPriceChange;
...
import com.skytala.eCommerce.domain.product.relations.productPriceChange.command.AddProductPriceChange;
import com.skytala.eCommerce.domain.product.relations.productPriceChange.command.DeleteProductPriceChange;
import com.skytala.eCommerce.domain.product.relations.productPriceChange.command.UpdateProductPriceChange;
import com.skytala.eCommerce.domain.product.relations.productPriceChange.event.ProductPriceChangeAdded;
import com.skytala.eCommerce.domain.product.relations.productPriceChange.event.ProductPriceChangeDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productPriceChange.query.FindProductPriceChangesBy;
