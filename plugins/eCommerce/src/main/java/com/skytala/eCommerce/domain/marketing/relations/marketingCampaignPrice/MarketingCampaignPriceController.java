package com.skytala.eCommerce.domain.marketing.relations.marketingCampaignPrice;
...
import com.skytala.eCommerce.domain.marketing.relations.marketingCampaignPrice.command.AddMarketingCampaignPrice;
import com.skytala.eCommerce.domain.marketing.relations.marketingCampaignPrice.command.DeleteMarketingCampaignPrice;
import com.skytala.eCommerce.domain.marketing.relations.marketingCampaignPrice.command.UpdateMarketingCampaignPrice;
import com.skytala.eCommerce.domain.marketing.relations.marketingCampaignPrice.event.MarketingCampaignPriceAdded;
import com.skytala.eCommerce.domain.marketing.relations.marketingCampaignPrice.event.MarketingCampaignPriceDeleted;
import com.skytala.eCommerce.domain.marketing.relations.marketingCampaignPrice.event.MarketingCampaignPriceFound;
import com.skytala.eCommerce.domain.marketing.relations.marketingCampaignPrice.event.MarketingCampaignPriceUpdated;
...
import com.skytala.eCommerce.domain.marketing.relations.marketingCampaignPrice.query.FindMarketingCampaignPricesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/marketingCampaignPrices")
...
//		marketingCampaignPriceToBeUpdated.setnull(null);
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/marketingCampaignPrice/\" plus one of the following: "
				+ "";
