package com.skytala.eCommerce.domain.order.relations.orderItemShipGroupAssoc;
...
import com.skytala.eCommerce.domain.order.relations.orderItemShipGroupAssoc.command.AddOrderItemShipGroupAssoc;
import com.skytala.eCommerce.domain.order.relations.orderItemShipGroupAssoc.command.DeleteOrderItemShipGroupAssoc;
import com.skytala.eCommerce.domain.order.relations.orderItemShipGroupAssoc.command.UpdateOrderItemShipGroupAssoc;
...
import com.skytala.eCommerce.domain.order.relations.orderItemShipGroupAssoc.event.OrderItemShipGroupAssocFound;
import com.skytala.eCommerce.domain.order.relations.orderItemShipGroupAssoc.event.OrderItemShipGroupAssocUpdated;
...
import com.skytala.eCommerce.domain.order.relations.orderItemShipGroupAssoc.query.FindOrderItemShipGroupAssocsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/orderItemShipGroupAssocs")
...
//		orderItemShipGroupAssocToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{orderItemShipGroupAssocId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{orderItemShipGroupAssocId}")
