...
public class DeleteRateAmount extends Command {

private String toBeDeletedId;
public DeleteRateAmount(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("RateAmount", UtilMisc.toMap("rateAmountId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new RateAmountDeleted(success);
