...
public class DeleteInventoryItemVariance extends Command {

private String toBeDeletedId;
public DeleteInventoryItemVariance(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("InventoryItemVariance", UtilMisc.toMap("inventoryItemVarianceId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new InventoryItemVarianceDeleted(success);
