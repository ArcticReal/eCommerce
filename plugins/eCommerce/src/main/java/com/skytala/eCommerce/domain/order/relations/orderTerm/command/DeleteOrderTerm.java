...
public class DeleteOrderTerm extends Command {

private String toBeDeletedId;
public DeleteOrderTerm(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderTerm", UtilMisc.toMap("orderTermId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderTermDeleted(success);
