package com.skytala.eCommerce.domain.accounting.relations.glAccountGroup;
...
import com.skytala.eCommerce.domain.accounting.relations.glAccountGroup.command.AddGlAccountGroup;
import com.skytala.eCommerce.domain.accounting.relations.glAccountGroup.command.DeleteGlAccountGroup;
import com.skytala.eCommerce.domain.accounting.relations.glAccountGroup.command.UpdateGlAccountGroup;
import com.skytala.eCommerce.domain.accounting.relations.glAccountGroup.event.GlAccountGroupAdded;
import com.skytala.eCommerce.domain.accounting.relations.glAccountGroup.event.GlAccountGroupDeleted;
import com.skytala.eCommerce.domain.accounting.relations.glAccountGroup.event.GlAccountGroupFound;
import com.skytala.eCommerce.domain.accounting.relations.glAccountGroup.event.GlAccountGroupUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.glAccountGroup.query.FindGlAccountGroupsBy;
...
public class GlAccountGroupController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{glAccountGroupId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{glAccountGroupId}")
