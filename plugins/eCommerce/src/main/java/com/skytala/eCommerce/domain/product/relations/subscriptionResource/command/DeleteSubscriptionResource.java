...
public class DeleteSubscriptionResource extends Command {

private String toBeDeletedId;
public DeleteSubscriptionResource(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("SubscriptionResource", UtilMisc.toMap("subscriptionResourceId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new SubscriptionResourceDeleted(success);
