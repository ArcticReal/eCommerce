...
public class AffiliateController {
	...
	public ResponseEntity<Object> findAffiliatesBy(@RequestParam(required = false) Map<String, String> allRequestParams) throws Exception {
		...
		if (affiliates.size() == 1) {
			return ResponseEntity.ok().body(affiliates.get(0));
		}
	...
	public ResponseEntity<Object> createAffiliate(@RequestBody Affiliate affiliateToBeAdded) throws Exception {
		...
		if (affiliate != null) 
			...
			return ResponseEntity.status(HttpStatus.CONFLICT)
					             .body("Affiliate could not be created.");
	}
	...
	public boolean updateAffiliate(HttpServletRequest request) throws Exception {
		...
		if (updateAffiliate(affiliateToBeUpdated, null).getStatusCode()
	...
	public ResponseEntity<Object> updateAffiliate(@RequestBody Affiliate affiliateToBeUpdated,
...
//		affiliateToBeUpdated.setnull(null);
	...
	public ResponseEntity<Object> findById(@PathVariable String affiliateId) throws Exception {
		...
		try {
			...
			Object foundAffiliate = findAffiliatesBy(requestParams).getBody();
			return ResponseEntity.status(HttpStatus.OK).body(foundAffiliate);
		} catch (RecordNotFoundException e) {
	...
	public ResponseEntity<Object> deleteAffiliateByIdUpdated(@PathVariable String affiliateId) throws Exception {
		...
		return ResponseEntity.status(HttpStatus.CONFLICT).body("Affiliate could not be deleted");
