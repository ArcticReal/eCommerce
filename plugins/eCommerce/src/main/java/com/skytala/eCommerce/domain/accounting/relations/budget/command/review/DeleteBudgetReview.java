...
public class DeleteBudgetReview extends Command {

private String toBeDeletedId;
public DeleteBudgetReview(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("BudgetReview", UtilMisc.toMap("budgetReviewId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new BudgetReviewDeleted(success);
