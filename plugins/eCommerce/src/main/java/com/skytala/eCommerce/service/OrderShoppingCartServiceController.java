...
@RestController
@RequestMapping("/service/OrderShoppingCartController")
public class OrderShoppingCartServiceController{
	...
	public ResponseEntity<Object> interfaceProductPromoAction(HttpSession session, @RequestParam(value="productPromoAction") org.apache.ofbiz.entity.GenericValue productPromoAction, @RequestParam(value="shoppingCart") org.apache.ofbiz.order.shoppingcart.ShoppingCart shoppingCart, @RequestParam(value="nowTimestamp") Timestamp nowTimestamp, @RequestParam(value="actionResultInfo") org.apache.ofbiz.order.shoppingcart.product.ProductPromoWorker actionResultInfo) {
