...
public class ProtectedViewController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{protectedViewId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{protectedViewId}")
