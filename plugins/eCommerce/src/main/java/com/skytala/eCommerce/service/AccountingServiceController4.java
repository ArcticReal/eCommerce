...
@RestController
@RequestMapping("/service/AccountingController4")
public class AccountingServiceController4{
	...
	public ResponseEntity<Object> removePaymentApplication(HttpSession session, @RequestParam(value="paymentApplicationId") String paymentApplicationId, @RequestParam(value="toPaymentId", required=false) String toPaymentId, @RequestParam(value="paymentId", required=false) String paymentId, @RequestParam(value="amountApplied", required=false) BigDecimal amountApplied, @RequestParam(value="overrideGlAccountId", required=false) String overrideGlAccountId, @RequestParam(value="taxAuthGeoId", required=false) String taxAuthGeoId, @RequestParam(value="invoiceId", required=false) String invoiceId, @RequestParam(value="invoiceItemSeqId", required=false) String invoiceItemSeqId, @RequestParam(value="billingAccountId", required=false) String billingAccountId) {
