package com.skytala.eCommerce.domain.content.relations.surveyMultiResp;
...
import com.skytala.eCommerce.domain.content.relations.surveyMultiResp.command.AddSurveyMultiResp;
import com.skytala.eCommerce.domain.content.relations.surveyMultiResp.command.DeleteSurveyMultiResp;
import com.skytala.eCommerce.domain.content.relations.surveyMultiResp.command.UpdateSurveyMultiResp;
import com.skytala.eCommerce.domain.content.relations.surveyMultiResp.event.SurveyMultiRespAdded;
import com.skytala.eCommerce.domain.content.relations.surveyMultiResp.event.SurveyMultiRespDeleted;
import com.skytala.eCommerce.domain.content.relations.surveyMultiResp.event.SurveyMultiRespFound;
import com.skytala.eCommerce.domain.content.relations.surveyMultiResp.event.SurveyMultiRespUpdated;
...
import com.skytala.eCommerce.domain.content.relations.surveyMultiResp.query.FindSurveyMultiRespsBy;
