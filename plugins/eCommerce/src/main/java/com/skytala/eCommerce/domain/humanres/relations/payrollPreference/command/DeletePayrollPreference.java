...
public class DeletePayrollPreference extends Command {

private String toBeDeletedId;
public DeletePayrollPreference(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PayrollPreference", UtilMisc.toMap("payrollPreferenceId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PayrollPreferenceDeleted(success);
