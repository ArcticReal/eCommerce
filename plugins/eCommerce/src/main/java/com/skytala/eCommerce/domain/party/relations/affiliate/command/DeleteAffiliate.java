...
public class DeleteAffiliate extends Command {

private String toBeDeletedId;
public DeleteAffiliate(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("Affiliate", UtilMisc.toMap("affiliateId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new AffiliateDeleted(success);
