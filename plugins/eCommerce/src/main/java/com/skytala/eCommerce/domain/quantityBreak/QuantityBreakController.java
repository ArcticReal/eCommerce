package com.skytala.eCommerce.domain.quantityBreak;
...
import com.skytala.eCommerce.domain.quantityBreak.command.AddQuantityBreak;
import com.skytala.eCommerce.domain.quantityBreak.command.DeleteQuantityBreak;
import com.skytala.eCommerce.domain.quantityBreak.command.UpdateQuantityBreak;
import com.skytala.eCommerce.domain.quantityBreak.event.QuantityBreakAdded;
import com.skytala.eCommerce.domain.quantityBreak.event.QuantityBreakDeleted;
import com.skytala.eCommerce.domain.quantityBreak.event.QuantityBreakFound;
import com.skytala.eCommerce.domain.quantityBreak.event.QuantityBreakUpdated;
...
import com.skytala.eCommerce.domain.quantityBreak.query.FindQuantityBreaksBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/quantityBreaks")
public class QuantityBreakController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{quantityBreakId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{quantityBreakId}")
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/quantityBreak/\" plus one of the following: "
				+ "";
