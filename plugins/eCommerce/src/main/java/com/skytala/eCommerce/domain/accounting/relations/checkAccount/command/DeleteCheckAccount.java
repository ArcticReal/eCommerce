...
public class DeleteCheckAccount extends Command {

private String toBeDeletedId;
public DeleteCheckAccount(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CheckAccount", UtilMisc.toMap("checkAccountId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CheckAccountDeleted(success);
