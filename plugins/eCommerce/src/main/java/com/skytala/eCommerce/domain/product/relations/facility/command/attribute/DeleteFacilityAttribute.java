...
public class DeleteFacilityAttribute extends Command {

private String toBeDeletedId;
public DeleteFacilityAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("FacilityAttribute", UtilMisc.toMap("facilityAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new FacilityAttributeDeleted(success);
