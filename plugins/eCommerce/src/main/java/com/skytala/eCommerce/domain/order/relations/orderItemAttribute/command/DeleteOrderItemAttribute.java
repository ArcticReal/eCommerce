...
public class DeleteOrderItemAttribute extends Command {

private String toBeDeletedId;
public DeleteOrderItemAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderItemAttribute", UtilMisc.toMap("orderItemAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderItemAttributeDeleted(success);
