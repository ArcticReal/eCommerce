package com.skytala.eCommerce.domain.content.relations.surveyTrigger;
...
import com.skytala.eCommerce.domain.content.relations.surveyTrigger.command.AddSurveyTrigger;
import com.skytala.eCommerce.domain.content.relations.surveyTrigger.command.DeleteSurveyTrigger;
import com.skytala.eCommerce.domain.content.relations.surveyTrigger.command.UpdateSurveyTrigger;
import com.skytala.eCommerce.domain.content.relations.surveyTrigger.event.SurveyTriggerAdded;
import com.skytala.eCommerce.domain.content.relations.surveyTrigger.event.SurveyTriggerDeleted;
import com.skytala.eCommerce.domain.content.relations.surveyTrigger.event.SurveyTriggerFound;
import com.skytala.eCommerce.domain.content.relations.surveyTrigger.event.SurveyTriggerUpdated;
...
import com.skytala.eCommerce.domain.content.relations.surveyTrigger.query.FindSurveyTriggersBy;
