package com.skytala.eCommerce.domain.accounting.relations.paymentGroup;
...
import com.skytala.eCommerce.domain.accounting.relations.paymentGroup.command.AddPaymentGroup;
import com.skytala.eCommerce.domain.accounting.relations.paymentGroup.command.DeletePaymentGroup;
import com.skytala.eCommerce.domain.accounting.relations.paymentGroup.command.UpdatePaymentGroup;
import com.skytala.eCommerce.domain.accounting.relations.paymentGroup.event.PaymentGroupAdded;
import com.skytala.eCommerce.domain.accounting.relations.paymentGroup.event.PaymentGroupDeleted;
...
import com.skytala.eCommerce.domain.accounting.relations.paymentGroup.query.FindPaymentGroupsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/paymentGroups")
public class PaymentGroupController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{paymentGroupId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{paymentGroupId}")
