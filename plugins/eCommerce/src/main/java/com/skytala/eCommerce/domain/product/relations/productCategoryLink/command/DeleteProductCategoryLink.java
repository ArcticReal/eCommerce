...
public class DeleteProductCategoryLink extends Command {

private String toBeDeletedId;
public DeleteProductCategoryLink(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductCategoryLink", UtilMisc.toMap("productCategoryLinkId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductCategoryLinkDeleted(success);
