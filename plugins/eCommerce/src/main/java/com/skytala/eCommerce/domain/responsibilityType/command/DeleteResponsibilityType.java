...
public class DeleteResponsibilityType extends Command {

private String toBeDeletedId;
public DeleteResponsibilityType(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ResponsibilityType", UtilMisc.toMap("responsibilityTypeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ResponsibilityTypeDeleted(success);
