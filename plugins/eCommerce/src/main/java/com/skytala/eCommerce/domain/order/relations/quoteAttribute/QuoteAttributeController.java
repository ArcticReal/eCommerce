package com.skytala.eCommerce.domain.order.relations.quoteAttribute;
...
import com.skytala.eCommerce.domain.order.relations.quoteAttribute.command.AddQuoteAttribute;
import com.skytala.eCommerce.domain.order.relations.quoteAttribute.command.DeleteQuoteAttribute;
import com.skytala.eCommerce.domain.order.relations.quoteAttribute.command.UpdateQuoteAttribute;
import com.skytala.eCommerce.domain.order.relations.quoteAttribute.event.QuoteAttributeAdded;
import com.skytala.eCommerce.domain.order.relations.quoteAttribute.event.QuoteAttributeDeleted;
import com.skytala.eCommerce.domain.order.relations.quoteAttribute.event.QuoteAttributeFound;
import com.skytala.eCommerce.domain.order.relations.quoteAttribute.event.QuoteAttributeUpdated;
...
import com.skytala.eCommerce.domain.order.relations.quoteAttribute.query.FindQuoteAttributesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/quoteAttributes")
public class QuoteAttributeController {
	...
	public boolean updateQuoteAttribute(HttpServletRequest request) throws Exception {
		...
		if (updateQuoteAttribute(quoteAttributeToBeUpdated, null).getStatusCode()
...
//		quoteAttributeToBeUpdated.setnull(null);
