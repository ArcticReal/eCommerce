...
public class DeleteCustRequestNote extends Command {

private String toBeDeletedId;
public DeleteCustRequestNote(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CustRequestNote", UtilMisc.toMap("custRequestNoteId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CustRequestNoteDeleted(success);
