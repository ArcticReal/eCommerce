package com.skytala.eCommerce.domain.product.relations.productGroupOrder;
...
import com.skytala.eCommerce.domain.product.relations.productGroupOrder.command.AddProductGroupOrder;
import com.skytala.eCommerce.domain.product.relations.productGroupOrder.command.DeleteProductGroupOrder;
import com.skytala.eCommerce.domain.product.relations.productGroupOrder.command.UpdateProductGroupOrder;
import com.skytala.eCommerce.domain.product.relations.productGroupOrder.event.ProductGroupOrderAdded;
import com.skytala.eCommerce.domain.product.relations.productGroupOrder.event.ProductGroupOrderDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productGroupOrder.query.FindProductGroupOrdersBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/productGroupOrders")
public class ProductGroupOrderController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{productGroupOrderId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{productGroupOrderId}")
