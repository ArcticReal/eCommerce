...
public class DeletePartyNote extends Command {

private String toBeDeletedId;
public DeletePartyNote(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyNote", UtilMisc.toMap("partyNoteId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyNoteDeleted(success);
