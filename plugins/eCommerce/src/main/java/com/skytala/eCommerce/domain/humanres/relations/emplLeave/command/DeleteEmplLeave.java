...
public class DeleteEmplLeave extends Command {

private String toBeDeletedId;
public DeleteEmplLeave(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("EmplLeave", UtilMisc.toMap("emplLeaveId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new EmplLeaveDeleted(success);
