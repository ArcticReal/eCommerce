...
public class DeleteOrderAdjustmentTypeAttr extends Command {

private String toBeDeletedId;
public DeleteOrderAdjustmentTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderAdjustmentTypeAttr", UtilMisc.toMap("orderAdjustmentTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderAdjustmentTypeAttrDeleted(success);
