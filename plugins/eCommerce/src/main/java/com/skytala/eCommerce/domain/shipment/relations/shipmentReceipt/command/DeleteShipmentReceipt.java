...
public class DeleteShipmentReceipt extends Command {

private String toBeDeletedId;
public DeleteShipmentReceipt(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ShipmentReceipt", UtilMisc.toMap("shipmentReceiptId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ShipmentReceiptDeleted(success);
