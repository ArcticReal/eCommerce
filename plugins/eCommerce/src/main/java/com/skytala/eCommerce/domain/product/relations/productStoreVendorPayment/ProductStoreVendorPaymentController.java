package com.skytala.eCommerce.domain.product.relations.productStoreVendorPayment;
...
import com.skytala.eCommerce.domain.product.relations.productStoreVendorPayment.command.AddProductStoreVendorPayment;
import com.skytala.eCommerce.domain.product.relations.productStoreVendorPayment.command.DeleteProductStoreVendorPayment;
import com.skytala.eCommerce.domain.product.relations.productStoreVendorPayment.command.UpdateProductStoreVendorPayment;
import com.skytala.eCommerce.domain.product.relations.productStoreVendorPayment.event.ProductStoreVendorPaymentAdded;
import com.skytala.eCommerce.domain.product.relations.productStoreVendorPayment.event.ProductStoreVendorPaymentDeleted;
import com.skytala.eCommerce.domain.product.relations.productStoreVendorPayment.event.ProductStoreVendorPaymentFound;
import com.skytala.eCommerce.domain.product.relations.productStoreVendorPayment.event.ProductStoreVendorPaymentUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productStoreVendorPayment.query.FindProductStoreVendorPaymentsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/productStoreVendorPayments")
