package com.skytala.eCommerce.domain.product.relations.productStoreRole;
...
import com.skytala.eCommerce.domain.product.relations.productStoreRole.command.AddProductStoreRole;
import com.skytala.eCommerce.domain.product.relations.productStoreRole.command.DeleteProductStoreRole;
import com.skytala.eCommerce.domain.product.relations.productStoreRole.command.UpdateProductStoreRole;
import com.skytala.eCommerce.domain.product.relations.productStoreRole.event.ProductStoreRoleAdded;
import com.skytala.eCommerce.domain.product.relations.productStoreRole.event.ProductStoreRoleDeleted;
import com.skytala.eCommerce.domain.product.relations.productStoreRole.event.ProductStoreRoleFound;
...
import com.skytala.eCommerce.domain.product.relations.productStoreRole.query.FindProductStoreRolesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/productStoreRoles")
public class ProductStoreRoleController {
	...
	public boolean updateProductStoreRole(HttpServletRequest request) throws Exception {
		...
		if (updateProductStoreRole(productStoreRoleToBeUpdated, null).getStatusCode()
...
//		productStoreRoleToBeUpdated.setnull(null);
