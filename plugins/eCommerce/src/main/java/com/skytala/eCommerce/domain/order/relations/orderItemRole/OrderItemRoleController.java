package com.skytala.eCommerce.domain.order.relations.orderItemRole;
...
import com.skytala.eCommerce.domain.order.relations.orderItemRole.command.AddOrderItemRole;
import com.skytala.eCommerce.domain.order.relations.orderItemRole.command.DeleteOrderItemRole;
import com.skytala.eCommerce.domain.order.relations.orderItemRole.command.UpdateOrderItemRole;
import com.skytala.eCommerce.domain.order.relations.orderItemRole.event.OrderItemRoleAdded;
import com.skytala.eCommerce.domain.order.relations.orderItemRole.event.OrderItemRoleDeleted;
...
import com.skytala.eCommerce.domain.order.relations.orderItemRole.query.FindOrderItemRolesBy;
