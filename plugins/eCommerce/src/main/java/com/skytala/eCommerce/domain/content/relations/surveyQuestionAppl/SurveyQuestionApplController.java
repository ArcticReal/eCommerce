package com.skytala.eCommerce.domain.content.relations.surveyQuestionAppl;
...
import com.skytala.eCommerce.domain.content.relations.surveyQuestionAppl.command.AddSurveyQuestionAppl;
import com.skytala.eCommerce.domain.content.relations.surveyQuestionAppl.command.DeleteSurveyQuestionAppl;
import com.skytala.eCommerce.domain.content.relations.surveyQuestionAppl.command.UpdateSurveyQuestionAppl;
import com.skytala.eCommerce.domain.content.relations.surveyQuestionAppl.event.SurveyQuestionApplAdded;
import com.skytala.eCommerce.domain.content.relations.surveyQuestionAppl.event.SurveyQuestionApplDeleted;
...
import com.skytala.eCommerce.domain.content.relations.surveyQuestionAppl.query.FindSurveyQuestionApplsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/surveyQuestionAppls")
...
//		surveyQuestionApplToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{surveyQuestionApplId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{surveyQuestionApplId}")
