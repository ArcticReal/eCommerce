...
public class DeleteCustRequestItemNote extends Command {

private String toBeDeletedId;
public DeleteCustRequestItemNote(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CustRequestItemNote", UtilMisc.toMap("custRequestItemNoteId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CustRequestItemNoteDeleted(success);
