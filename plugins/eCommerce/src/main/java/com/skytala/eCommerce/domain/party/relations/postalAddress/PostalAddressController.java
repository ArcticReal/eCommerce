...
public class PostalAddressController {
	...
	public boolean updatePostalAddress(HttpServletRequest request) throws Exception {
		...
		if (updatePostalAddress(postalAddressToBeUpdated, null).getStatusCode()
