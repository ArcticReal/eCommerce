...
public class AccountingPaymentgatewayServiceController{
	...
	public ResponseEntity<Map<String, Object>> deletePaymentGatewayConfigSagePay(HttpSession session, @RequestParam(value="paymentGatewayConfigId") String paymentGatewayConfigId) {
	...
	public ResponseEntity<Map<String, Object>> createPaymentGatewayConfig(HttpSession session, @RequestParam(value="paymentGatewayConfigId", required=false) String paymentGatewayConfigId, @RequestParam(value="paymentGatewayConfigTypeId", required=false) String paymentGatewayConfigTypeId, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> deletePaymentGatewayConfigAuthorizeNet(HttpSession session, @RequestParam(value="paymentGatewayConfigId") String paymentGatewayConfigId) {
	...
	public ResponseEntity<Map<String, Object>> updatePaymentGatewayConfig(HttpSession session, @RequestParam(value="paymentGatewayConfigId") String paymentGatewayConfigId, @RequestParam(value="paymentGatewayConfigTypeId", required=false) String paymentGatewayConfigTypeId, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> updatePaymentGatewayConfigType(HttpSession session, @RequestParam(value="paymentGatewayConfigTypeId") String paymentGatewayConfigTypeId, @RequestParam(value="parentTypeId", required=false) String parentTypeId, @RequestParam(value="hasTable", required=false) String hasTable, @RequestParam(value="description", required=false) String description) {
	...
	public ResponseEntity<Map<String, Object>> updatePaymentGatewayConfigSecurePay(HttpSession session, @RequestParam(value="paymentGatewayConfigId") String paymentGatewayConfigId, @RequestParam(value="merchantId", required=false) Long merchantId, @RequestParam(value="serverURL", required=false) Long serverURL, @RequestParam(value="pwd", required=false) Long pwd, @RequestParam(value="processTimeout", required=false) Long processTimeout, @RequestParam(value="enableAmountRound", required=false) String enableAmountRound) {
	...
	public ResponseEntity<Map<String, Object>> createPaymentGatewayConfigSagePay(HttpSession session, @RequestParam(value="authenticationTransType", required=false) String authenticationTransType, @RequestParam(value="paymentGatewayConfigId", required=false) String paymentGatewayConfigId, @RequestParam(value="voidUrl", required=false) String voidUrl, @RequestParam(value="testingHost", required=false) String testingHost, @RequestParam(value="sagePayMode", required=false) String sagePayMode, @RequestParam(value="releaseTransType", required=false) String releaseTransType, @RequestParam(value="authoriseTransType", required=false) String authoriseTransType, @RequestParam(value="vendor", required=false) String vendor, @RequestParam(value="productionHost", required=false) String productionHost, @RequestParam(value="refundUrl", required=false) String refundUrl, @RequestParam(value="protocolVersion", required=false) String protocolVersion, @RequestParam(value="releaseUrl", required=false) String releaseUrl, @RequestParam(value="authenticationUrl", required=false) String authenticationUrl, @RequestParam(value="authoriseUrl", required=false) String authoriseUrl) {
	...
	public ResponseEntity<Map<String, Object>> deletePaymentGatewayConfig(HttpSession session, @RequestParam(value="paymentGatewayConfigId") String paymentGatewayConfigId) {
	...
	public ResponseEntity<Map<String, Object>> deletePaymentGatewayConfigClearCommerce(HttpSession session, @RequestParam(value="paymentGatewayConfigId") String paymentGatewayConfigId) {
