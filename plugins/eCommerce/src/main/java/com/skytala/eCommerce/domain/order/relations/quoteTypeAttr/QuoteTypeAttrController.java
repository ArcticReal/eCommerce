package com.skytala.eCommerce.domain.order.relations.quoteTypeAttr;
...
import com.skytala.eCommerce.domain.order.relations.quoteTypeAttr.command.AddQuoteTypeAttr;
import com.skytala.eCommerce.domain.order.relations.quoteTypeAttr.command.DeleteQuoteTypeAttr;
import com.skytala.eCommerce.domain.order.relations.quoteTypeAttr.command.UpdateQuoteTypeAttr;
import com.skytala.eCommerce.domain.order.relations.quoteTypeAttr.event.QuoteTypeAttrAdded;
import com.skytala.eCommerce.domain.order.relations.quoteTypeAttr.event.QuoteTypeAttrDeleted;
import com.skytala.eCommerce.domain.order.relations.quoteTypeAttr.event.QuoteTypeAttrFound;
import com.skytala.eCommerce.domain.order.relations.quoteTypeAttr.event.QuoteTypeAttrUpdated;
...
import com.skytala.eCommerce.domain.order.relations.quoteTypeAttr.query.FindQuoteTypeAttrsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/quoteTypeAttrs")
public class QuoteTypeAttrController {
	...
	public boolean updateQuoteTypeAttr(HttpServletRequest request) throws Exception {
		...
		if (updateQuoteTypeAttr(quoteTypeAttrToBeUpdated, null).getStatusCode()
...
//		quoteTypeAttrToBeUpdated.setnull(null);
