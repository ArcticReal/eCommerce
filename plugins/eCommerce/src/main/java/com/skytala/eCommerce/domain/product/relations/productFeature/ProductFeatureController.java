package com.skytala.eCommerce.domain.product.relations.productFeature;
...
import com.skytala.eCommerce.domain.product.relations.productFeature.command.AddProductFeature;
import com.skytala.eCommerce.domain.product.relations.productFeature.command.DeleteProductFeature;
import com.skytala.eCommerce.domain.product.relations.productFeature.command.UpdateProductFeature;
import com.skytala.eCommerce.domain.product.relations.productFeature.event.ProductFeatureAdded;
import com.skytala.eCommerce.domain.product.relations.productFeature.event.ProductFeatureDeleted;
import com.skytala.eCommerce.domain.product.relations.productFeature.event.ProductFeatureFound;
import com.skytala.eCommerce.domain.product.relations.productFeature.event.ProductFeatureUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productFeature.query.FindProductFeaturesBy;
