...
public class DeleteAddressMatchMap extends Command {

private String toBeDeletedId;
public DeleteAddressMatchMap(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("AddressMatchMap", UtilMisc.toMap("addressMatchMapId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new AddressMatchMapDeleted(success);
