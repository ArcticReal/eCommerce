package com.skytala.eCommerce.domain.shipment.relations.shipmentTypeAttr;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentTypeAttr.command.AddShipmentTypeAttr;
import com.skytala.eCommerce.domain.shipment.relations.shipmentTypeAttr.command.DeleteShipmentTypeAttr;
import com.skytala.eCommerce.domain.shipment.relations.shipmentTypeAttr.command.UpdateShipmentTypeAttr;
import com.skytala.eCommerce.domain.shipment.relations.shipmentTypeAttr.event.ShipmentTypeAttrAdded;
import com.skytala.eCommerce.domain.shipment.relations.shipmentTypeAttr.event.ShipmentTypeAttrDeleted;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentTypeAttr.query.FindShipmentTypeAttrsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/shipmentTypeAttrs")
public class ShipmentTypeAttrController {
	...
	public boolean updateShipmentTypeAttr(HttpServletRequest request) throws Exception {
		...
		if (updateShipmentTypeAttr(shipmentTypeAttrToBeUpdated, null).getStatusCode()
...
//		shipmentTypeAttrToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{shipmentTypeAttrId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{shipmentTypeAttrId}")
