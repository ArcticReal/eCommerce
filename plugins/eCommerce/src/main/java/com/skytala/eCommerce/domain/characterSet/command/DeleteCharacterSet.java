...
public class DeleteCharacterSet extends Command {

private String toBeDeletedId;
public DeleteCharacterSet(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CharacterSet", UtilMisc.toMap("characterSetId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CharacterSetDeleted(success);
