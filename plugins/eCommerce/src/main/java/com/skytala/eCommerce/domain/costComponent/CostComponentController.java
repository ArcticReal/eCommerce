package com.skytala.eCommerce.domain.costComponent;
...
import com.skytala.eCommerce.domain.costComponent.command.AddCostComponent;
import com.skytala.eCommerce.domain.costComponent.command.DeleteCostComponent;
import com.skytala.eCommerce.domain.costComponent.command.UpdateCostComponent;
import com.skytala.eCommerce.domain.costComponent.event.CostComponentAdded;
import com.skytala.eCommerce.domain.costComponent.event.CostComponentDeleted;
import com.skytala.eCommerce.domain.costComponent.event.CostComponentFound;
import com.skytala.eCommerce.domain.costComponent.event.CostComponentUpdated;
import com.skytala.eCommerce.domain.costComponent.mapper.CostComponentMapper;
import com.skytala.eCommerce.domain.costComponent.model.CostComponent;
import com.skytala.eCommerce.domain.costComponent.query.FindCostComponentsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/costComponents")
public class CostComponentController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{costComponentId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{costComponentId}")
