package com.skytala.eCommerce.domain.product.relations.productStoreGroupRollup;
...
import com.skytala.eCommerce.domain.product.relations.productStoreGroupRollup.command.AddProductStoreGroupRollup;
import com.skytala.eCommerce.domain.product.relations.productStoreGroupRollup.command.DeleteProductStoreGroupRollup;
import com.skytala.eCommerce.domain.product.relations.productStoreGroupRollup.command.UpdateProductStoreGroupRollup;
import com.skytala.eCommerce.domain.product.relations.productStoreGroupRollup.event.ProductStoreGroupRollupAdded;
import com.skytala.eCommerce.domain.product.relations.productStoreGroupRollup.event.ProductStoreGroupRollupDeleted;
import com.skytala.eCommerce.domain.product.relations.productStoreGroupRollup.event.ProductStoreGroupRollupFound;
import com.skytala.eCommerce.domain.product.relations.productStoreGroupRollup.event.ProductStoreGroupRollupUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productStoreGroupRollup.query.FindProductStoreGroupRollupsBy;
