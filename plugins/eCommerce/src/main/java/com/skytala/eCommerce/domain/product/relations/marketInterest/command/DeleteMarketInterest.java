...
public class DeleteMarketInterest extends Command {

private String toBeDeletedId;
public DeleteMarketInterest(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("MarketInterest", UtilMisc.toMap("marketInterestId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new MarketInterestDeleted(success);
