package com.skytala.eCommerce.domain.content.relations.audioDataResource;
...
import com.skytala.eCommerce.domain.content.relations.audioDataResource.command.AddAudioDataResource;
import com.skytala.eCommerce.domain.content.relations.audioDataResource.command.DeleteAudioDataResource;
import com.skytala.eCommerce.domain.content.relations.audioDataResource.command.UpdateAudioDataResource;
import com.skytala.eCommerce.domain.content.relations.audioDataResource.event.AudioDataResourceAdded;
import com.skytala.eCommerce.domain.content.relations.audioDataResource.event.AudioDataResourceDeleted;
...
import com.skytala.eCommerce.domain.content.relations.audioDataResource.query.FindAudioDataResourcesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/audioDataResources")
...
//		audioDataResourceToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{audioDataResourceId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{audioDataResourceId}")
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/audioDataResource/\" plus one of the following: "
				+ "";
