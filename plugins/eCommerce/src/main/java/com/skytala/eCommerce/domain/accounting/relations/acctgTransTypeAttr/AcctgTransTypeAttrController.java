package com.skytala.eCommerce.domain.accounting.relations.acctgTransTypeAttr;
...
import com.skytala.eCommerce.domain.accounting.relations.acctgTransTypeAttr.command.AddAcctgTransTypeAttr;
import com.skytala.eCommerce.domain.accounting.relations.acctgTransTypeAttr.command.DeleteAcctgTransTypeAttr;
import com.skytala.eCommerce.domain.accounting.relations.acctgTransTypeAttr.command.UpdateAcctgTransTypeAttr;
import com.skytala.eCommerce.domain.accounting.relations.acctgTransTypeAttr.event.AcctgTransTypeAttrAdded;
import com.skytala.eCommerce.domain.accounting.relations.acctgTransTypeAttr.event.AcctgTransTypeAttrDeleted;
import com.skytala.eCommerce.domain.accounting.relations.acctgTransTypeAttr.event.AcctgTransTypeAttrFound;
import com.skytala.eCommerce.domain.accounting.relations.acctgTransTypeAttr.event.AcctgTransTypeAttrUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.acctgTransTypeAttr.query.FindAcctgTransTypeAttrsBy;
