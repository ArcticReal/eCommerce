...
@RestController
@CrossOrigin
@RequestMapping("/webSitePublishPoints")
...
//		webSitePublishPointToBeUpdated.setnull(null);
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/webSitePublishPoint/\" plus one of the following: "
				+ "";
