...
public class DeleteContactMech extends Command {

private String toBeDeletedId;
public DeleteContactMech(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ContactMech", UtilMisc.toMap("contactMechId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ContactMechDeleted(success);
