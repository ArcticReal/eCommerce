package com.skytala.eCommerce.domain.order.relations.orderItemContactMech;
...
import com.skytala.eCommerce.domain.order.relations.orderItemContactMech.command.AddOrderItemContactMech;
import com.skytala.eCommerce.domain.order.relations.orderItemContactMech.command.DeleteOrderItemContactMech;
import com.skytala.eCommerce.domain.order.relations.orderItemContactMech.command.UpdateOrderItemContactMech;
import com.skytala.eCommerce.domain.order.relations.orderItemContactMech.event.OrderItemContactMechAdded;
import com.skytala.eCommerce.domain.order.relations.orderItemContactMech.event.OrderItemContactMechDeleted;
import com.skytala.eCommerce.domain.order.relations.orderItemContactMech.event.OrderItemContactMechFound;
import com.skytala.eCommerce.domain.order.relations.orderItemContactMech.event.OrderItemContactMechUpdated;
...
import com.skytala.eCommerce.domain.order.relations.orderItemContactMech.query.FindOrderItemContactMechsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/orderItemContactMechs")
public class OrderItemContactMechController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{orderItemContactMechId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{orderItemContactMechId}")
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/orderItemContactMech/\" plus one of the following: "
				+ "";
