...
public class DeleteOrderItemShipGroup extends Command {

private String toBeDeletedId;
public DeleteOrderItemShipGroup(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderItemShipGroup", UtilMisc.toMap("orderItemShipGroupId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderItemShipGroupDeleted(success);
