...
public class DeleteUserLoginSecurityGroup extends Command {

private String toBeDeletedId;
public DeleteUserLoginSecurityGroup(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("UserLoginSecurityGroup", UtilMisc.toMap("userLoginSecurityGroupId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new UserLoginSecurityGroupDeleted(success);
