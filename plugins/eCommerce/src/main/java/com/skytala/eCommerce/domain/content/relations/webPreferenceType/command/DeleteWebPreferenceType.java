...
public class DeleteWebPreferenceType extends Command {

private String toBeDeletedId;
public DeleteWebPreferenceType(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("WebPreferenceType", UtilMisc.toMap("webPreferenceTypeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new WebPreferenceTypeDeleted(success);
