package com.skytala.eCommerce.domain.party.relations.partyClassificationType;
...
import com.skytala.eCommerce.domain.party.relations.partyClassificationType.command.AddPartyClassificationType;
import com.skytala.eCommerce.domain.party.relations.partyClassificationType.command.DeletePartyClassificationType;
import com.skytala.eCommerce.domain.party.relations.partyClassificationType.command.UpdatePartyClassificationType;
import com.skytala.eCommerce.domain.party.relations.partyClassificationType.event.PartyClassificationTypeAdded;
import com.skytala.eCommerce.domain.party.relations.partyClassificationType.event.PartyClassificationTypeDeleted;
import com.skytala.eCommerce.domain.party.relations.partyClassificationType.event.PartyClassificationTypeFound;
import com.skytala.eCommerce.domain.party.relations.partyClassificationType.event.PartyClassificationTypeUpdated;
import com.skytala.eCommerce.domain.party.relations.partyClassificationType.mapper.PartyClassificationTypeMapper;
import com.skytala.eCommerce.domain.party.relations.partyClassificationType.model.PartyClassificationType;
import com.skytala.eCommerce.domain.party.relations.partyClassificationType.query.FindPartyClassificationTypesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/partyClassificationTypes")
public class PartyClassificationTypeController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{partyClassificationTypeId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{partyClassificationTypeId}")
