...
public class OFBizEnumServiceController{
	...
	public ResponseEntity<Object> deleteEnumerationType(HttpSession session, @RequestParam(value="enumTypeId") String enumTypeId) {
	...
	public ResponseEntity<Object> createEnumerationType(HttpSession session, @RequestParam(value="enumTypeId", required=false) String enumTypeId, @RequestParam(value="parentTypeId", required=false) String parentTypeId, @RequestParam(value="hasTable", required=false) Boolean hasTable, @RequestParam(value="description", required=false) String description) {
