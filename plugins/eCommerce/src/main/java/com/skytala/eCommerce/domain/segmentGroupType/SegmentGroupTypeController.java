package com.skytala.eCommerce.domain.segmentGroupType;
...
import com.skytala.eCommerce.domain.segmentGroupType.command.AddSegmentGroupType;
import com.skytala.eCommerce.domain.segmentGroupType.command.DeleteSegmentGroupType;
import com.skytala.eCommerce.domain.segmentGroupType.command.UpdateSegmentGroupType;
import com.skytala.eCommerce.domain.segmentGroupType.event.SegmentGroupTypeAdded;
import com.skytala.eCommerce.domain.segmentGroupType.event.SegmentGroupTypeDeleted;
import com.skytala.eCommerce.domain.segmentGroupType.event.SegmentGroupTypeFound;
import com.skytala.eCommerce.domain.segmentGroupType.event.SegmentGroupTypeUpdated;
import com.skytala.eCommerce.domain.segmentGroupType.mapper.SegmentGroupTypeMapper;
import com.skytala.eCommerce.domain.segmentGroupType.model.SegmentGroupType;
import com.skytala.eCommerce.domain.segmentGroupType.query.FindSegmentGroupTypesBy;
