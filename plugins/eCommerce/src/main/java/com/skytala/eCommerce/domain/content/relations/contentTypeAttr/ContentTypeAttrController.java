package com.skytala.eCommerce.domain.content.relations.contentTypeAttr;
...
import com.skytala.eCommerce.domain.content.relations.contentTypeAttr.command.AddContentTypeAttr;
import com.skytala.eCommerce.domain.content.relations.contentTypeAttr.command.DeleteContentTypeAttr;
import com.skytala.eCommerce.domain.content.relations.contentTypeAttr.command.UpdateContentTypeAttr;
import com.skytala.eCommerce.domain.content.relations.contentTypeAttr.event.ContentTypeAttrAdded;
import com.skytala.eCommerce.domain.content.relations.contentTypeAttr.event.ContentTypeAttrDeleted;
import com.skytala.eCommerce.domain.content.relations.contentTypeAttr.event.ContentTypeAttrFound;
import com.skytala.eCommerce.domain.content.relations.contentTypeAttr.event.ContentTypeAttrUpdated;
...
import com.skytala.eCommerce.domain.content.relations.contentTypeAttr.query.FindContentTypeAttrsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/contentTypeAttrs")
public class ContentTypeAttrController {
	...
	public boolean updateContentTypeAttr(HttpServletRequest request) throws Exception {
		...
		if (updateContentTypeAttr(contentTypeAttrToBeUpdated, null).getStatusCode()
...
//		contentTypeAttrToBeUpdated.setnull(null);
