...
public class DeletePartyAcctgPreference extends Command {

private String toBeDeletedId;
public DeletePartyAcctgPreference(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyAcctgPreference", UtilMisc.toMap("partyAcctgPreferenceId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyAcctgPreferenceDeleted(success);
