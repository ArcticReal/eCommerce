...
public class DeleteUserLoginSession extends Command {

private String toBeDeletedId;
public DeleteUserLoginSession(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("UserLoginSession", UtilMisc.toMap("userLoginSessionId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new UserLoginSessionDeleted(success);
