...
public class DeleteContactMechLink extends Command {

private String toBeDeletedId;
public DeleteContactMechLink(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ContactMechLink", UtilMisc.toMap("contactMechLinkId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ContactMechLinkDeleted(success);
