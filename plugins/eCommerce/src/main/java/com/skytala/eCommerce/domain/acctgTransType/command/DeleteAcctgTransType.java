...
public class DeleteAcctgTransType extends Command {

private String toBeDeletedId;
public DeleteAcctgTransType(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("AcctgTransType", UtilMisc.toMap("acctgTransTypeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new AcctgTransTypeDeleted(success);
