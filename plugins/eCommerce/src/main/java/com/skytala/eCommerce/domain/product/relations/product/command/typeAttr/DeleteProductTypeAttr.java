...
public class DeleteProductTypeAttr extends Command {

private String toBeDeletedId;
public DeleteProductTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductTypeAttr", UtilMisc.toMap("productTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductTypeAttrDeleted(success);
