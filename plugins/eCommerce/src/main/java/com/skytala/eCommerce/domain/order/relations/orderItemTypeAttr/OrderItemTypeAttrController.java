package com.skytala.eCommerce.domain.order.relations.orderItemTypeAttr;
...
import com.skytala.eCommerce.domain.order.relations.orderItemTypeAttr.command.AddOrderItemTypeAttr;
import com.skytala.eCommerce.domain.order.relations.orderItemTypeAttr.command.DeleteOrderItemTypeAttr;
import com.skytala.eCommerce.domain.order.relations.orderItemTypeAttr.command.UpdateOrderItemTypeAttr;
import com.skytala.eCommerce.domain.order.relations.orderItemTypeAttr.event.OrderItemTypeAttrAdded;
import com.skytala.eCommerce.domain.order.relations.orderItemTypeAttr.event.OrderItemTypeAttrDeleted;
import com.skytala.eCommerce.domain.order.relations.orderItemTypeAttr.event.OrderItemTypeAttrFound;
import com.skytala.eCommerce.domain.order.relations.orderItemTypeAttr.event.OrderItemTypeAttrUpdated;
...
import com.skytala.eCommerce.domain.order.relations.orderItemTypeAttr.query.FindOrderItemTypeAttrsBy;
