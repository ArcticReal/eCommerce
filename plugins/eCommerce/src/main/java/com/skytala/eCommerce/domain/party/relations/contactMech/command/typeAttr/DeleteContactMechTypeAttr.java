...
public class DeleteContactMechTypeAttr extends Command {

private String toBeDeletedId;
public DeleteContactMechTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ContactMechTypeAttr", UtilMisc.toMap("contactMechTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ContactMechTypeAttrDeleted(success);
