...
public class DeleteAgreementTermAttribute extends Command {

private String toBeDeletedId;
public DeleteAgreementTermAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("AgreementTermAttribute", UtilMisc.toMap("agreementTermAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new AgreementTermAttributeDeleted(success);
