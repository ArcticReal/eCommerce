...
public class DeleteFinAccountTypeAttr extends Command {

private String toBeDeletedId;
public DeleteFinAccountTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("FinAccountTypeAttr", UtilMisc.toMap("finAccountTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new FinAccountTypeAttrDeleted(success);
