package com.skytala.eCommerce.domain.accounting.relations.budgetAttribute;
...
import com.skytala.eCommerce.domain.accounting.relations.budgetAttribute.command.AddBudgetAttribute;
import com.skytala.eCommerce.domain.accounting.relations.budgetAttribute.command.DeleteBudgetAttribute;
import com.skytala.eCommerce.domain.accounting.relations.budgetAttribute.command.UpdateBudgetAttribute;
import com.skytala.eCommerce.domain.accounting.relations.budgetAttribute.event.BudgetAttributeAdded;
import com.skytala.eCommerce.domain.accounting.relations.budgetAttribute.event.BudgetAttributeDeleted;
import com.skytala.eCommerce.domain.accounting.relations.budgetAttribute.event.BudgetAttributeFound;
import com.skytala.eCommerce.domain.accounting.relations.budgetAttribute.event.BudgetAttributeUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.budgetAttribute.query.FindBudgetAttributesBy;
...
public class BudgetAttributeController {
	...
	public boolean updateBudgetAttribute(HttpServletRequest request) throws Exception {
		...
		if (updateBudgetAttribute(budgetAttributeToBeUpdated, null).getStatusCode()
...
//		budgetAttributeToBeUpdated.setnull(null);
