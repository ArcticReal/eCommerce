...
public class DeletePartyBenefit extends Command {

private String toBeDeletedId;
public DeletePartyBenefit(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyBenefit", UtilMisc.toMap("partyBenefitId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyBenefitDeleted(success);
