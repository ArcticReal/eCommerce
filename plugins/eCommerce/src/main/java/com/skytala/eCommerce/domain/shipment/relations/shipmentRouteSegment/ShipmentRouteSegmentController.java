package com.skytala.eCommerce.domain.shipment.relations.shipmentRouteSegment;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentRouteSegment.command.AddShipmentRouteSegment;
import com.skytala.eCommerce.domain.shipment.relations.shipmentRouteSegment.command.DeleteShipmentRouteSegment;
import com.skytala.eCommerce.domain.shipment.relations.shipmentRouteSegment.command.UpdateShipmentRouteSegment;
import com.skytala.eCommerce.domain.shipment.relations.shipmentRouteSegment.event.ShipmentRouteSegmentAdded;
import com.skytala.eCommerce.domain.shipment.relations.shipmentRouteSegment.event.ShipmentRouteSegmentDeleted;
import com.skytala.eCommerce.domain.shipment.relations.shipmentRouteSegment.event.ShipmentRouteSegmentFound;
import com.skytala.eCommerce.domain.shipment.relations.shipmentRouteSegment.event.ShipmentRouteSegmentUpdated;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentRouteSegment.query.FindShipmentRouteSegmentsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/shipmentRouteSegments")
public class ShipmentRouteSegmentController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{shipmentRouteSegmentId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{shipmentRouteSegmentId}")
