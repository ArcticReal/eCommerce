...
public class DeletePerfRatingType extends Command {

private String toBeDeletedId;
public DeletePerfRatingType(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PerfRatingType", UtilMisc.toMap("perfRatingTypeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PerfRatingTypeDeleted(success);
