package com.skytala.eCommerce.domain.product.relations.productSubscriptionResource;
...
import com.skytala.eCommerce.domain.product.relations.productSubscriptionResource.command.AddProductSubscriptionResource;
import com.skytala.eCommerce.domain.product.relations.productSubscriptionResource.command.DeleteProductSubscriptionResource;
import com.skytala.eCommerce.domain.product.relations.productSubscriptionResource.command.UpdateProductSubscriptionResource;
import com.skytala.eCommerce.domain.product.relations.productSubscriptionResource.event.ProductSubscriptionResourceAdded;
import com.skytala.eCommerce.domain.product.relations.productSubscriptionResource.event.ProductSubscriptionResourceDeleted;
import com.skytala.eCommerce.domain.product.relations.productSubscriptionResource.event.ProductSubscriptionResourceFound;
import com.skytala.eCommerce.domain.product.relations.productSubscriptionResource.event.ProductSubscriptionResourceUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productSubscriptionResource.query.FindProductSubscriptionResourcesBy;
