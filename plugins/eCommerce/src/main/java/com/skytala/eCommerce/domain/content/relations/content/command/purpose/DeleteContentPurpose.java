...
public class DeleteContentPurpose extends Command {

private String toBeDeletedId;
public DeleteContentPurpose(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ContentPurpose", UtilMisc.toMap("contentPurposeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ContentPurposeDeleted(success);
