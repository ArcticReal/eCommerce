package com.skytala.eCommerce.domain.workeffort.relations.workEffortStatus;
...
import com.skytala.eCommerce.domain.workeffort.relations.workEffortStatus.command.AddWorkEffortStatus;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortStatus.command.DeleteWorkEffortStatus;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortStatus.command.UpdateWorkEffortStatus;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortStatus.event.WorkEffortStatusAdded;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortStatus.event.WorkEffortStatusDeleted;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortStatus.event.WorkEffortStatusFound;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortStatus.event.WorkEffortStatusUpdated;
...
import com.skytala.eCommerce.domain.workeffort.relations.workEffortStatus.query.FindWorkEffortStatussBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/workEffortStatuss")
