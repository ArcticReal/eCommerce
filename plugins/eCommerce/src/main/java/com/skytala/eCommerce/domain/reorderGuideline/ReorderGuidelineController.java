package com.skytala.eCommerce.domain.reorderGuideline;
...
import com.skytala.eCommerce.domain.reorderGuideline.command.AddReorderGuideline;
import com.skytala.eCommerce.domain.reorderGuideline.command.DeleteReorderGuideline;
import com.skytala.eCommerce.domain.reorderGuideline.command.UpdateReorderGuideline;
import com.skytala.eCommerce.domain.reorderGuideline.event.ReorderGuidelineAdded;
import com.skytala.eCommerce.domain.reorderGuideline.event.ReorderGuidelineDeleted;
...
import com.skytala.eCommerce.domain.reorderGuideline.query.FindReorderGuidelinesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/reorderGuidelines")
public class ReorderGuidelineController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{reorderGuidelineId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{reorderGuidelineId}")
