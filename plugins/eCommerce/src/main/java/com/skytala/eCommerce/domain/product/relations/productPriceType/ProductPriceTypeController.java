package com.skytala.eCommerce.domain.product.relations.productPriceType;
...
import com.skytala.eCommerce.domain.product.relations.productPriceType.command.AddProductPriceType;
import com.skytala.eCommerce.domain.product.relations.productPriceType.command.DeleteProductPriceType;
import com.skytala.eCommerce.domain.product.relations.productPriceType.command.UpdateProductPriceType;
import com.skytala.eCommerce.domain.product.relations.productPriceType.event.ProductPriceTypeAdded;
import com.skytala.eCommerce.domain.product.relations.productPriceType.event.ProductPriceTypeDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productPriceType.query.FindProductPriceTypesBy;
