...
@RestController
@RequestMapping("/service/AccountingController13")
public class AccountingServiceController13{
	...
	public ResponseEntity<Object> createGlJournal(HttpSession session, @RequestParam(value="organizationPartyId") String organizationPartyId, @RequestParam(value="glJournalId") String glJournalId, @RequestParam(value="glJournalName", required=false) String glJournalName) {
	...
	public ResponseEntity<Object> createGlAccountCategory(HttpSession session, @RequestParam(value="glAccountCategoryId") String glAccountCategoryId, @RequestParam(value="glAccountCategoryTypeId", required=false) String glAccountCategoryTypeId, @RequestParam(value="description", required=false) String description) {
