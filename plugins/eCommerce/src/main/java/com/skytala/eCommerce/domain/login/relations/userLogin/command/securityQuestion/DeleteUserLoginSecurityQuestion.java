...
public class DeleteUserLoginSecurityQuestion extends Command {

private String toBeDeletedId;
public DeleteUserLoginSecurityQuestion(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("UserLoginSecurityQuestion", UtilMisc.toMap("userLoginSecurityQuestionId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new UserLoginSecurityQuestionDeleted(success);
