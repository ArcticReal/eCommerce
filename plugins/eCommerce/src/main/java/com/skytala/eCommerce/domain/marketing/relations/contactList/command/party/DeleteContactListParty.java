...
public class DeleteContactListParty extends Command {

private String toBeDeletedId;
public DeleteContactListParty(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ContactListParty", UtilMisc.toMap("contactListPartyId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ContactListPartyDeleted(success);
