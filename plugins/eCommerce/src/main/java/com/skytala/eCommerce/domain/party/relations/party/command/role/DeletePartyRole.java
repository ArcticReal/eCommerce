...
public class DeletePartyRole extends Command {

private String toBeDeletedId;
public DeletePartyRole(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyRole", UtilMisc.toMap("partyRoleId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyRoleDeleted(success);
