...
public class DeleteProductConfigProduct extends Command {

private String toBeDeletedId;
public DeleteProductConfigProduct(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductConfigProduct", UtilMisc.toMap("productConfigProductId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductConfigProductDeleted(success);
