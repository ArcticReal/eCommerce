package com.skytala.eCommerce.domain.accounting.relations.paymentTypeAttr;
...
import com.skytala.eCommerce.domain.accounting.relations.paymentTypeAttr.command.AddPaymentTypeAttr;
import com.skytala.eCommerce.domain.accounting.relations.paymentTypeAttr.command.DeletePaymentTypeAttr;
import com.skytala.eCommerce.domain.accounting.relations.paymentTypeAttr.command.UpdatePaymentTypeAttr;
import com.skytala.eCommerce.domain.accounting.relations.paymentTypeAttr.event.PaymentTypeAttrAdded;
import com.skytala.eCommerce.domain.accounting.relations.paymentTypeAttr.event.PaymentTypeAttrDeleted;
...
import com.skytala.eCommerce.domain.accounting.relations.paymentTypeAttr.query.FindPaymentTypeAttrsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/paymentTypeAttrs")
public class PaymentTypeAttrController {
	...
	public boolean updatePaymentTypeAttr(HttpServletRequest request) throws Exception {
		...
		if (updatePaymentTypeAttr(paymentTypeAttrToBeUpdated, null).getStatusCode()
...
//		paymentTypeAttrToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{paymentTypeAttrId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{paymentTypeAttrId}")
