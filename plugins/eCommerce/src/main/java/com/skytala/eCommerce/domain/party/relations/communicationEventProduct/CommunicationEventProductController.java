package com.skytala.eCommerce.domain.party.relations.communicationEventProduct;
...
import com.skytala.eCommerce.domain.party.relations.communicationEventProduct.command.AddCommunicationEventProduct;
import com.skytala.eCommerce.domain.party.relations.communicationEventProduct.command.DeleteCommunicationEventProduct;
import com.skytala.eCommerce.domain.party.relations.communicationEventProduct.command.UpdateCommunicationEventProduct;
import com.skytala.eCommerce.domain.party.relations.communicationEventProduct.event.CommunicationEventProductAdded;
import com.skytala.eCommerce.domain.party.relations.communicationEventProduct.event.CommunicationEventProductDeleted;
import com.skytala.eCommerce.domain.party.relations.communicationEventProduct.event.CommunicationEventProductFound;
...
import com.skytala.eCommerce.domain.party.relations.communicationEventProduct.query.FindCommunicationEventProductsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/communicationEventProducts")
