...
public class DeleteTrackingCodeOrderReturn extends Command {

private String toBeDeletedId;
public DeleteTrackingCodeOrderReturn(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("TrackingCodeOrderReturn", UtilMisc.toMap("trackingCodeOrderReturnId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new TrackingCodeOrderReturnDeleted(success);
