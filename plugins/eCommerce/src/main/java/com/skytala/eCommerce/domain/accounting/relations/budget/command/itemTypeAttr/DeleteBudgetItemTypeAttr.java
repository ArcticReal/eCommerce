...
public class DeleteBudgetItemTypeAttr extends Command {

private String toBeDeletedId;
public DeleteBudgetItemTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("BudgetItemTypeAttr", UtilMisc.toMap("budgetItemTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new BudgetItemTypeAttrDeleted(success);
