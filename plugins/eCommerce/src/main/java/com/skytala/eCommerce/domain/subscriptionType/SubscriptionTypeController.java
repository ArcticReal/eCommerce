package com.skytala.eCommerce.domain.subscriptionType;
...
import com.skytala.eCommerce.domain.subscriptionType.command.AddSubscriptionType;
import com.skytala.eCommerce.domain.subscriptionType.command.DeleteSubscriptionType;
import com.skytala.eCommerce.domain.subscriptionType.command.UpdateSubscriptionType;
import com.skytala.eCommerce.domain.subscriptionType.event.SubscriptionTypeAdded;
import com.skytala.eCommerce.domain.subscriptionType.event.SubscriptionTypeDeleted;
...
import com.skytala.eCommerce.domain.subscriptionType.query.FindSubscriptionTypesBy;
