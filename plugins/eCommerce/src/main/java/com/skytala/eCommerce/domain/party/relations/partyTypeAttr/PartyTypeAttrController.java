package com.skytala.eCommerce.domain.party.relations.partyTypeAttr;
...
import com.skytala.eCommerce.domain.party.relations.partyTypeAttr.command.AddPartyTypeAttr;
import com.skytala.eCommerce.domain.party.relations.partyTypeAttr.command.DeletePartyTypeAttr;
import com.skytala.eCommerce.domain.party.relations.partyTypeAttr.command.UpdatePartyTypeAttr;
import com.skytala.eCommerce.domain.party.relations.partyTypeAttr.event.PartyTypeAttrAdded;
import com.skytala.eCommerce.domain.party.relations.partyTypeAttr.event.PartyTypeAttrDeleted;
import com.skytala.eCommerce.domain.party.relations.partyTypeAttr.event.PartyTypeAttrFound;
import com.skytala.eCommerce.domain.party.relations.partyTypeAttr.event.PartyTypeAttrUpdated;
...
import com.skytala.eCommerce.domain.party.relations.partyTypeAttr.query.FindPartyTypeAttrsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/partyTypeAttrs")
public class PartyTypeAttrController {
	...
	public boolean updatePartyTypeAttr(HttpServletRequest request) throws Exception {
		...
		if (updatePartyTypeAttr(partyTypeAttrToBeUpdated, null).getStatusCode()
...
//		partyTypeAttrToBeUpdated.setnull(null);
