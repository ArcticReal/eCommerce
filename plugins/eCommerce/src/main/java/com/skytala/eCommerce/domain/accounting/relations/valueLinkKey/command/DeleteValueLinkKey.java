...
public class DeleteValueLinkKey extends Command {

private String toBeDeletedId;
public DeleteValueLinkKey(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ValueLinkKey", UtilMisc.toMap("valueLinkKeyId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ValueLinkKeyDeleted(success);
