package com.skytala.eCommerce.domain.accounting.relations.finAccountTrans;
...
import com.skytala.eCommerce.domain.accounting.relations.finAccountTrans.command.AddFinAccountTrans;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTrans.command.DeleteFinAccountTrans;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTrans.command.UpdateFinAccountTrans;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTrans.event.FinAccountTransAdded;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTrans.event.FinAccountTransDeleted;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTrans.event.FinAccountTransFound;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTrans.event.FinAccountTransUpdated;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTrans.mapper.FinAccountTransMapper;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTrans.model.FinAccountTrans;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTrans.query.FindFinAccountTranssBy;
...
public class FinAccountTransController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{finAccountTransId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{finAccountTransId}")
