...
public class DeleteProductConfigOption extends Command {

private String toBeDeletedId;
public DeleteProductConfigOption(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductConfigOption", UtilMisc.toMap("productConfigOptionId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductConfigOptionDeleted(success);
