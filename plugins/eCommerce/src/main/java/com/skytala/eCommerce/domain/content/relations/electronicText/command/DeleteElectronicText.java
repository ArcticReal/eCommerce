...
public class DeleteElectronicText extends Command {

private String toBeDeletedId;
public DeleteElectronicText(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ElectronicText", UtilMisc.toMap("electronicTextId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ElectronicTextDeleted(success);
