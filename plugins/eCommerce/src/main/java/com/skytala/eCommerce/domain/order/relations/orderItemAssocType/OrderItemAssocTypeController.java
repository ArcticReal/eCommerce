package com.skytala.eCommerce.domain.order.relations.orderItemAssocType;
...
import com.skytala.eCommerce.domain.order.relations.orderItemAssocType.command.AddOrderItemAssocType;
import com.skytala.eCommerce.domain.order.relations.orderItemAssocType.command.DeleteOrderItemAssocType;
import com.skytala.eCommerce.domain.order.relations.orderItemAssocType.command.UpdateOrderItemAssocType;
import com.skytala.eCommerce.domain.order.relations.orderItemAssocType.event.OrderItemAssocTypeAdded;
import com.skytala.eCommerce.domain.order.relations.orderItemAssocType.event.OrderItemAssocTypeDeleted;
import com.skytala.eCommerce.domain.order.relations.orderItemAssocType.event.OrderItemAssocTypeFound;
import com.skytala.eCommerce.domain.order.relations.orderItemAssocType.event.OrderItemAssocTypeUpdated;
import com.skytala.eCommerce.domain.order.relations.orderItemAssocType.mapper.OrderItemAssocTypeMapper;
import com.skytala.eCommerce.domain.order.relations.orderItemAssocType.model.OrderItemAssocType;
import com.skytala.eCommerce.domain.order.relations.orderItemAssocType.query.FindOrderItemAssocTypesBy;
