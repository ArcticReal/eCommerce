package com.skytala.eCommerce.domain.order.relations.orderItemChange;
...
import com.skytala.eCommerce.domain.order.relations.orderItemChange.command.AddOrderItemChange;
import com.skytala.eCommerce.domain.order.relations.orderItemChange.command.DeleteOrderItemChange;
import com.skytala.eCommerce.domain.order.relations.orderItemChange.command.UpdateOrderItemChange;
import com.skytala.eCommerce.domain.order.relations.orderItemChange.event.OrderItemChangeAdded;
import com.skytala.eCommerce.domain.order.relations.orderItemChange.event.OrderItemChangeDeleted;
import com.skytala.eCommerce.domain.order.relations.orderItemChange.event.OrderItemChangeFound;
import com.skytala.eCommerce.domain.order.relations.orderItemChange.event.OrderItemChangeUpdated;
...
import com.skytala.eCommerce.domain.order.relations.orderItemChange.query.FindOrderItemChangesBy;
