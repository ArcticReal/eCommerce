package com.skytala.eCommerce.domain.product.relations.productConfigStats;
...
import com.skytala.eCommerce.domain.product.relations.productConfigStats.command.AddProductConfigStats;
import com.skytala.eCommerce.domain.product.relations.productConfigStats.command.DeleteProductConfigStats;
import com.skytala.eCommerce.domain.product.relations.productConfigStats.command.UpdateProductConfigStats;
import com.skytala.eCommerce.domain.product.relations.productConfigStats.event.ProductConfigStatsAdded;
import com.skytala.eCommerce.domain.product.relations.productConfigStats.event.ProductConfigStatsDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productConfigStats.query.FindProductConfigStatssBy;
