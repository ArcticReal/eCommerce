package com.skytala.eCommerce.domain.accounting.relations.finAccountTransTypeAttr;
...
import com.skytala.eCommerce.domain.accounting.relations.finAccountTransTypeAttr.command.AddFinAccountTransTypeAttr;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTransTypeAttr.command.DeleteFinAccountTransTypeAttr;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTransTypeAttr.command.UpdateFinAccountTransTypeAttr;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTransTypeAttr.event.FinAccountTransTypeAttrAdded;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTransTypeAttr.event.FinAccountTransTypeAttrDeleted;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTransTypeAttr.event.FinAccountTransTypeAttrFound;
import com.skytala.eCommerce.domain.accounting.relations.finAccountTransTypeAttr.event.FinAccountTransTypeAttrUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.finAccountTransTypeAttr.query.FindFinAccountTransTypeAttrsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/finAccountTransTypeAttrs")
public class FinAccountTransTypeAttrController {
	...
	public boolean updateFinAccountTransTypeAttr(HttpServletRequest request) throws Exception {
		...
		if (updateFinAccountTransTypeAttr(finAccountTransTypeAttrToBeUpdated, null).getStatusCode()
...
//		finAccountTransTypeAttrToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{finAccountTransTypeAttrId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{finAccountTransTypeAttrId}")
