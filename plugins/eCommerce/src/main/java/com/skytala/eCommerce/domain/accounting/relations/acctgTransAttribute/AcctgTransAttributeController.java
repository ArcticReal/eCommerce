package com.skytala.eCommerce.domain.accounting.relations.acctgTransAttribute;
...
import com.skytala.eCommerce.domain.accounting.relations.acctgTransAttribute.command.AddAcctgTransAttribute;
import com.skytala.eCommerce.domain.accounting.relations.acctgTransAttribute.command.DeleteAcctgTransAttribute;
import com.skytala.eCommerce.domain.accounting.relations.acctgTransAttribute.command.UpdateAcctgTransAttribute;
import com.skytala.eCommerce.domain.accounting.relations.acctgTransAttribute.event.AcctgTransAttributeAdded;
import com.skytala.eCommerce.domain.accounting.relations.acctgTransAttribute.event.AcctgTransAttributeDeleted;
...
import com.skytala.eCommerce.domain.accounting.relations.acctgTransAttribute.query.FindAcctgTransAttributesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/acctgTransAttributes")
public class AcctgTransAttributeController {
	...
	public boolean updateAcctgTransAttribute(HttpServletRequest request) throws Exception {
		...
		if (updateAcctgTransAttribute(acctgTransAttributeToBeUpdated, null).getStatusCode()
...
//		acctgTransAttributeToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{acctgTransAttributeId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{acctgTransAttributeId}")
