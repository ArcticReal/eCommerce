...
public class DeleteInvoiceItemAttribute extends Command {

private String toBeDeletedId;
public DeleteInvoiceItemAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("InvoiceItemAttribute", UtilMisc.toMap("invoiceItemAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new InvoiceItemAttributeDeleted(success);
