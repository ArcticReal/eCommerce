...
public class DeleteFacilityLocation extends Command {

private String toBeDeletedId;
public DeleteFacilityLocation(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("FacilityLocation", UtilMisc.toMap("facilityLocationId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new FacilityLocationDeleted(success);
