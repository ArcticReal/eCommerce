...
public class DeleteInvoice extends Command {

private String toBeDeletedId;
public DeleteInvoice(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("Invoice", UtilMisc.toMap("invoiceId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new InvoiceDeleted(success);
