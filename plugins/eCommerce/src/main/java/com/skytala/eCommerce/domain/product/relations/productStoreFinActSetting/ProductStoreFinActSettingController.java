package com.skytala.eCommerce.domain.product.relations.productStoreFinActSetting;
...
import com.skytala.eCommerce.domain.product.relations.productStoreFinActSetting.command.AddProductStoreFinActSetting;
import com.skytala.eCommerce.domain.product.relations.productStoreFinActSetting.command.DeleteProductStoreFinActSetting;
import com.skytala.eCommerce.domain.product.relations.productStoreFinActSetting.command.UpdateProductStoreFinActSetting;
import com.skytala.eCommerce.domain.product.relations.productStoreFinActSetting.event.ProductStoreFinActSettingAdded;
import com.skytala.eCommerce.domain.product.relations.productStoreFinActSetting.event.ProductStoreFinActSettingDeleted;
import com.skytala.eCommerce.domain.product.relations.productStoreFinActSetting.event.ProductStoreFinActSettingFound;
import com.skytala.eCommerce.domain.product.relations.productStoreFinActSetting.event.ProductStoreFinActSettingUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productStoreFinActSetting.query.FindProductStoreFinActSettingsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/productStoreFinActSettings")
