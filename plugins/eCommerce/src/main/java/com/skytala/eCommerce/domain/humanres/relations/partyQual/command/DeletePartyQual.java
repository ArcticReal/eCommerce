...
public class DeletePartyQual extends Command {

private String toBeDeletedId;
public DeletePartyQual(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyQual", UtilMisc.toMap("partyQualId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyQualDeleted(success);
