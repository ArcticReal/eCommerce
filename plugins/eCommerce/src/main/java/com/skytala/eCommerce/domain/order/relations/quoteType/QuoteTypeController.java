package com.skytala.eCommerce.domain.order.relations.quoteType;
...
import com.skytala.eCommerce.domain.order.relations.quoteType.command.AddQuoteType;
import com.skytala.eCommerce.domain.order.relations.quoteType.command.DeleteQuoteType;
import com.skytala.eCommerce.domain.order.relations.quoteType.command.UpdateQuoteType;
import com.skytala.eCommerce.domain.order.relations.quoteType.event.QuoteTypeAdded;
import com.skytala.eCommerce.domain.order.relations.quoteType.event.QuoteTypeDeleted;
import com.skytala.eCommerce.domain.order.relations.quoteType.event.QuoteTypeFound;
import com.skytala.eCommerce.domain.order.relations.quoteType.event.QuoteTypeUpdated;
...
import com.skytala.eCommerce.domain.order.relations.quoteType.query.FindQuoteTypesBy;
