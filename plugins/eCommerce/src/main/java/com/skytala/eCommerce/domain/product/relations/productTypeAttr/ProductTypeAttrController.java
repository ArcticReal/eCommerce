package com.skytala.eCommerce.domain.product.relations.productTypeAttr;
...
import com.skytala.eCommerce.domain.product.relations.productTypeAttr.command.AddProductTypeAttr;
import com.skytala.eCommerce.domain.product.relations.productTypeAttr.command.DeleteProductTypeAttr;
import com.skytala.eCommerce.domain.product.relations.productTypeAttr.command.UpdateProductTypeAttr;
import com.skytala.eCommerce.domain.product.relations.productTypeAttr.event.ProductTypeAttrAdded;
import com.skytala.eCommerce.domain.product.relations.productTypeAttr.event.ProductTypeAttrDeleted;
import com.skytala.eCommerce.domain.product.relations.productTypeAttr.event.ProductTypeAttrFound;
import com.skytala.eCommerce.domain.product.relations.productTypeAttr.event.ProductTypeAttrUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productTypeAttr.query.FindProductTypeAttrsBy;
