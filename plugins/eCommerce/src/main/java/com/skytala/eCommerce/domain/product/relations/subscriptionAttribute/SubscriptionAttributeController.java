package com.skytala.eCommerce.domain.product.relations.subscriptionAttribute;
...
import com.skytala.eCommerce.domain.product.relations.subscriptionAttribute.command.AddSubscriptionAttribute;
import com.skytala.eCommerce.domain.product.relations.subscriptionAttribute.command.DeleteSubscriptionAttribute;
import com.skytala.eCommerce.domain.product.relations.subscriptionAttribute.command.UpdateSubscriptionAttribute;
import com.skytala.eCommerce.domain.product.relations.subscriptionAttribute.event.SubscriptionAttributeAdded;
import com.skytala.eCommerce.domain.product.relations.subscriptionAttribute.event.SubscriptionAttributeDeleted;
...
import com.skytala.eCommerce.domain.product.relations.subscriptionAttribute.query.FindSubscriptionAttributesBy;
