package com.skytala.eCommerce.domain.order.relations.requirementBudgetAllocation;
...
import com.skytala.eCommerce.domain.order.relations.requirementBudgetAllocation.command.AddRequirementBudgetAllocation;
import com.skytala.eCommerce.domain.order.relations.requirementBudgetAllocation.command.DeleteRequirementBudgetAllocation;
import com.skytala.eCommerce.domain.order.relations.requirementBudgetAllocation.command.UpdateRequirementBudgetAllocation;
import com.skytala.eCommerce.domain.order.relations.requirementBudgetAllocation.event.RequirementBudgetAllocationAdded;
import com.skytala.eCommerce.domain.order.relations.requirementBudgetAllocation.event.RequirementBudgetAllocationDeleted;
import com.skytala.eCommerce.domain.order.relations.requirementBudgetAllocation.event.RequirementBudgetAllocationFound;
import com.skytala.eCommerce.domain.order.relations.requirementBudgetAllocation.event.RequirementBudgetAllocationUpdated;
...
import com.skytala.eCommerce.domain.order.relations.requirementBudgetAllocation.query.FindRequirementBudgetAllocationsBy;
...
public class RequirementBudgetAllocationController {
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/requirementBudgetAllocation/\" plus one of the following: "
				+ "";
