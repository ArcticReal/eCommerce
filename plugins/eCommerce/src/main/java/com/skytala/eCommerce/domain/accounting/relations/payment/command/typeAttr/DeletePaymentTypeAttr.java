...
public class DeletePaymentTypeAttr extends Command {

private String toBeDeletedId;
public DeletePaymentTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PaymentTypeAttr", UtilMisc.toMap("paymentTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PaymentTypeAttrDeleted(success);
