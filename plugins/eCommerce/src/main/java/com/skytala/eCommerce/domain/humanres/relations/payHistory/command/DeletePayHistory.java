...
public class DeletePayHistory extends Command {

private String toBeDeletedId;
public DeletePayHistory(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PayHistory", UtilMisc.toMap("payHistoryId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PayHistoryDeleted(success);
