...
@RestController
@RequestMapping("/service/AccountingController7")
public class AccountingServiceController7{
	...
	public ResponseEntity<Object> createTaxAuthority(HttpSession session, @RequestParam(value="taxAuthPartyId") String taxAuthPartyId, @RequestParam(value="taxAuthGeoId") String taxAuthGeoId, @RequestParam(value="requireTaxIdForExemption", required=false) Boolean requireTaxIdForExemption, @RequestParam(value="includeTaxInPrice", required=false) Boolean includeTaxInPrice, @RequestParam(value="taxIdFormatPattern", required=false) String taxIdFormatPattern) {
	...
	public ResponseEntity<Object> updateTaxAuthority(HttpSession session, @RequestParam(value="taxAuthPartyId") String taxAuthPartyId, @RequestParam(value="taxAuthGeoId") String taxAuthGeoId, @RequestParam(value="requireTaxIdForExemption", required=false) Boolean requireTaxIdForExemption, @RequestParam(value="includeTaxInPrice", required=false) Boolean includeTaxInPrice, @RequestParam(value="taxIdFormatPattern", required=false) String taxIdFormatPattern) {
