...
public class DeleteOrderBlacklist extends Command {

private String toBeDeletedId;
public DeleteOrderBlacklist(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderBlacklist", UtilMisc.toMap("orderBlacklistId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderBlacklistDeleted(success);
