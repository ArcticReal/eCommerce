package com.skytala.eCommerce.domain.accounting.relations.paymentMethod.command;
...
public DeletePaymentMethod(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PaymentMethod", UtilMisc.toMap("paymentMethodId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PaymentMethodDeleted(success);
