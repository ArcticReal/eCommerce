package com.skytala.eCommerce.domain.marketing.relations.contactListCommStatus;
...
import com.skytala.eCommerce.domain.marketing.relations.contactListCommStatus.command.AddContactListCommStatus;
import com.skytala.eCommerce.domain.marketing.relations.contactListCommStatus.command.DeleteContactListCommStatus;
import com.skytala.eCommerce.domain.marketing.relations.contactListCommStatus.command.UpdateContactListCommStatus;
import com.skytala.eCommerce.domain.marketing.relations.contactListCommStatus.event.ContactListCommStatusAdded;
import com.skytala.eCommerce.domain.marketing.relations.contactListCommStatus.event.ContactListCommStatusDeleted;
import com.skytala.eCommerce.domain.marketing.relations.contactListCommStatus.event.ContactListCommStatusFound;
import com.skytala.eCommerce.domain.marketing.relations.contactListCommStatus.event.ContactListCommStatusUpdated;
...
import com.skytala.eCommerce.domain.marketing.relations.contactListCommStatus.query.FindContactListCommStatussBy;
