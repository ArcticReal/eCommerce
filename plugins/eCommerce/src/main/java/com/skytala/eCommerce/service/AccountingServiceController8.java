...
@RestController
@RequestMapping("/service/AccountingController8")
public class AccountingServiceController8{
	...
	public ResponseEntity<Object> createBillingAccountTerm(HttpSession session, @RequestParam(value="billingAccountTermId") String billingAccountTermId, @RequestParam(value="termTypeId") String termTypeId, @RequestParam(value="billingAccountId") String billingAccountId, @RequestParam(value="termDays", required=false) Long termDays, @RequestParam(value="uomId", required=false) String uomId, @RequestParam(value="termValue", required=false) BigDecimal termValue) {
