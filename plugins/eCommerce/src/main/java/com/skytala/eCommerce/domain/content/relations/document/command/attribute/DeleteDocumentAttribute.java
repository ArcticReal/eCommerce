...
public class DeleteDocumentAttribute extends Command {

private String toBeDeletedId;
public DeleteDocumentAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("DocumentAttribute", UtilMisc.toMap("documentAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new DocumentAttributeDeleted(success);
