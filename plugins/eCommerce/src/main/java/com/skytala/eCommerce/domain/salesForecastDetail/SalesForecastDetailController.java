package com.skytala.eCommerce.domain.salesForecastDetail;
...
import com.skytala.eCommerce.domain.salesForecastDetail.command.AddSalesForecastDetail;
import com.skytala.eCommerce.domain.salesForecastDetail.command.DeleteSalesForecastDetail;
import com.skytala.eCommerce.domain.salesForecastDetail.command.UpdateSalesForecastDetail;
import com.skytala.eCommerce.domain.salesForecastDetail.event.SalesForecastDetailAdded;
import com.skytala.eCommerce.domain.salesForecastDetail.event.SalesForecastDetailDeleted;
import com.skytala.eCommerce.domain.salesForecastDetail.event.SalesForecastDetailFound;
import com.skytala.eCommerce.domain.salesForecastDetail.event.SalesForecastDetailUpdated;
import com.skytala.eCommerce.domain.salesForecastDetail.mapper.SalesForecastDetailMapper;
import com.skytala.eCommerce.domain.salesForecastDetail.model.SalesForecastDetail;
import com.skytala.eCommerce.domain.salesForecastDetail.query.FindSalesForecastDetailsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/salesForecastDetails")
