...
public class DeleteWebSiteContactList extends Command {

private String toBeDeletedId;
public DeleteWebSiteContactList(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("WebSiteContactList", UtilMisc.toMap("webSiteContactListId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new WebSiteContactListDeleted(success);
