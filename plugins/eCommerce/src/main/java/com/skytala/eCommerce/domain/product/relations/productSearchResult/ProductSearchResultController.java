package com.skytala.eCommerce.domain.product.relations.productSearchResult;
...
import com.skytala.eCommerce.domain.product.relations.productSearchResult.command.AddProductSearchResult;
import com.skytala.eCommerce.domain.product.relations.productSearchResult.command.DeleteProductSearchResult;
import com.skytala.eCommerce.domain.product.relations.productSearchResult.command.UpdateProductSearchResult;
import com.skytala.eCommerce.domain.product.relations.productSearchResult.event.ProductSearchResultAdded;
import com.skytala.eCommerce.domain.product.relations.productSearchResult.event.ProductSearchResultDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productSearchResult.query.FindProductSearchResultsBy;
