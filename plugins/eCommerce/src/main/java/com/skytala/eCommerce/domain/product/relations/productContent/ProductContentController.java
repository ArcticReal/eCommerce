package com.skytala.eCommerce.domain.product.relations.productContent;
...
import com.skytala.eCommerce.domain.product.relations.productContent.command.AddProductContent;
import com.skytala.eCommerce.domain.product.relations.productContent.command.DeleteProductContent;
import com.skytala.eCommerce.domain.product.relations.productContent.command.UpdateProductContent;
import com.skytala.eCommerce.domain.product.relations.productContent.event.ProductContentAdded;
import com.skytala.eCommerce.domain.product.relations.productContent.event.ProductContentDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productContent.query.FindProductContentsBy;
