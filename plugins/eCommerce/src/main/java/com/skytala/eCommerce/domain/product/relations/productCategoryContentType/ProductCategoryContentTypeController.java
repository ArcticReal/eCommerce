package com.skytala.eCommerce.domain.product.relations.productCategoryContentType;
...
import com.skytala.eCommerce.domain.product.relations.productCategoryContentType.command.AddProductCategoryContentType;
import com.skytala.eCommerce.domain.product.relations.productCategoryContentType.command.DeleteProductCategoryContentType;
import com.skytala.eCommerce.domain.product.relations.productCategoryContentType.command.UpdateProductCategoryContentType;
import com.skytala.eCommerce.domain.product.relations.productCategoryContentType.event.ProductCategoryContentTypeAdded;
import com.skytala.eCommerce.domain.product.relations.productCategoryContentType.event.ProductCategoryContentTypeDeleted;
import com.skytala.eCommerce.domain.product.relations.productCategoryContentType.event.ProductCategoryContentTypeFound;
import com.skytala.eCommerce.domain.product.relations.productCategoryContentType.event.ProductCategoryContentTypeUpdated;
import com.skytala.eCommerce.domain.product.relations.productCategoryContentType.mapper.ProductCategoryContentTypeMapper;
import com.skytala.eCommerce.domain.product.relations.productCategoryContentType.model.ProductCategoryContentType;
import com.skytala.eCommerce.domain.product.relations.productCategoryContentType.query.FindProductCategoryContentTypesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/productCategoryContentTypes")
public class ProductCategoryContentTypeController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{productCategoryContentTypeId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{productCategoryContentTypeId}")
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/productCategoryContentType/\" plus one of the following: "
				+ "";
