package com.skytala.eCommerce.domain.order.relations.requirementTypeAttr;
...
import com.skytala.eCommerce.domain.order.relations.requirementTypeAttr.command.AddRequirementTypeAttr;
import com.skytala.eCommerce.domain.order.relations.requirementTypeAttr.command.DeleteRequirementTypeAttr;
import com.skytala.eCommerce.domain.order.relations.requirementTypeAttr.command.UpdateRequirementTypeAttr;
import com.skytala.eCommerce.domain.order.relations.requirementTypeAttr.event.RequirementTypeAttrAdded;
import com.skytala.eCommerce.domain.order.relations.requirementTypeAttr.event.RequirementTypeAttrDeleted;
import com.skytala.eCommerce.domain.order.relations.requirementTypeAttr.event.RequirementTypeAttrFound;
import com.skytala.eCommerce.domain.order.relations.requirementTypeAttr.event.RequirementTypeAttrUpdated;
...
import com.skytala.eCommerce.domain.order.relations.requirementTypeAttr.query.FindRequirementTypeAttrsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/requirementTypeAttrs")
