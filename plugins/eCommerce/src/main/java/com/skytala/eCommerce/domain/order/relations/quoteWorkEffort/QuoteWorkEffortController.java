package com.skytala.eCommerce.domain.order.relations.quoteWorkEffort;
...
import com.skytala.eCommerce.domain.order.relations.quoteWorkEffort.command.AddQuoteWorkEffort;
import com.skytala.eCommerce.domain.order.relations.quoteWorkEffort.command.DeleteQuoteWorkEffort;
import com.skytala.eCommerce.domain.order.relations.quoteWorkEffort.command.UpdateQuoteWorkEffort;
import com.skytala.eCommerce.domain.order.relations.quoteWorkEffort.event.QuoteWorkEffortAdded;
import com.skytala.eCommerce.domain.order.relations.quoteWorkEffort.event.QuoteWorkEffortDeleted;
...
import com.skytala.eCommerce.domain.order.relations.quoteWorkEffort.query.FindQuoteWorkEffortsBy;
