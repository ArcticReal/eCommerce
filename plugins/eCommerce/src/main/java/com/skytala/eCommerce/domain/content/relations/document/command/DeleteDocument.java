...
public DeleteDocument(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("Document", UtilMisc.toMap("documentId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new DocumentDeleted(success);
