...
public class DeleteProductConfigItem extends Command {

private String toBeDeletedId;
public DeleteProductConfigItem(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductConfigItem", UtilMisc.toMap("productConfigItemId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductConfigItemDeleted(success);
