package com.skytala.eCommerce.domain.product.relations.costComponentAttribute;
...
import com.skytala.eCommerce.domain.product.relations.costComponentAttribute.command.AddCostComponentAttribute;
import com.skytala.eCommerce.domain.product.relations.costComponentAttribute.command.DeleteCostComponentAttribute;
import com.skytala.eCommerce.domain.product.relations.costComponentAttribute.command.UpdateCostComponentAttribute;
import com.skytala.eCommerce.domain.product.relations.costComponentAttribute.event.CostComponentAttributeAdded;
import com.skytala.eCommerce.domain.product.relations.costComponentAttribute.event.CostComponentAttributeDeleted;
import com.skytala.eCommerce.domain.product.relations.costComponentAttribute.event.CostComponentAttributeFound;
import com.skytala.eCommerce.domain.product.relations.costComponentAttribute.event.CostComponentAttributeUpdated;
...
import com.skytala.eCommerce.domain.product.relations.costComponentAttribute.query.FindCostComponentAttributesBy;
...
public class CostComponentAttributeController {
	...
	public boolean updateCostComponentAttribute(HttpServletRequest request) throws Exception {
		...
		if (updateCostComponentAttribute(costComponentAttributeToBeUpdated, null).getStatusCode()
...
//		costComponentAttributeToBeUpdated.setnull(null);
