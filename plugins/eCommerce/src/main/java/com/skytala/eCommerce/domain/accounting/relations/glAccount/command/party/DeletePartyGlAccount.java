...
public class DeletePartyGlAccount extends Command {

private String toBeDeletedId;
public DeletePartyGlAccount(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyGlAccount", UtilMisc.toMap("partyGlAccountId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyGlAccountDeleted(success);
