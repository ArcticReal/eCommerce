...
public class DeleteContentMetaData extends Command {

private String toBeDeletedId;
public DeleteContentMetaData(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ContentMetaData", UtilMisc.toMap("contentMetaDataId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ContentMetaDataDeleted(success);
