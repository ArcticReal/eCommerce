package com.skytala.eCommerce.domain.marketing.relations.segmentGroupClassification;
...
import com.skytala.eCommerce.domain.marketing.relations.segmentGroupClassification.command.AddSegmentGroupClassification;
import com.skytala.eCommerce.domain.marketing.relations.segmentGroupClassification.command.DeleteSegmentGroupClassification;
import com.skytala.eCommerce.domain.marketing.relations.segmentGroupClassification.command.UpdateSegmentGroupClassification;
import com.skytala.eCommerce.domain.marketing.relations.segmentGroupClassification.event.SegmentGroupClassificationAdded;
import com.skytala.eCommerce.domain.marketing.relations.segmentGroupClassification.event.SegmentGroupClassificationDeleted;
...
import com.skytala.eCommerce.domain.marketing.relations.segmentGroupClassification.query.FindSegmentGroupClassificationsBy;
...
//		segmentGroupClassificationToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{segmentGroupClassificationId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{segmentGroupClassificationId}")
