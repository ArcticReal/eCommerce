...
public class DeletePartyAttribute extends Command {

private String toBeDeletedId;
public DeletePartyAttribute(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyAttribute", UtilMisc.toMap("partyAttributeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyAttributeDeleted(success);
