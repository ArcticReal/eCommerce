...
public class DeleteSubscriptionCommEvent extends Command {

private String toBeDeletedId;
public DeleteSubscriptionCommEvent(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("SubscriptionCommEvent", UtilMisc.toMap("subscriptionCommEventId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new SubscriptionCommEventDeleted(success);
