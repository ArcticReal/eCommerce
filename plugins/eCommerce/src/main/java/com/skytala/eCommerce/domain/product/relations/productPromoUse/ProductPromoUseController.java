package com.skytala.eCommerce.domain.product.relations.productPromoUse;
...
import com.skytala.eCommerce.domain.product.relations.productPromoUse.command.AddProductPromoUse;
import com.skytala.eCommerce.domain.product.relations.productPromoUse.command.DeleteProductPromoUse;
import com.skytala.eCommerce.domain.product.relations.productPromoUse.command.UpdateProductPromoUse;
import com.skytala.eCommerce.domain.product.relations.productPromoUse.event.ProductPromoUseAdded;
import com.skytala.eCommerce.domain.product.relations.productPromoUse.event.ProductPromoUseDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productPromoUse.query.FindProductPromoUsesBy;
