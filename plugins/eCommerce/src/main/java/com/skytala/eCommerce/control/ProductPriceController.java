...
import com.skytala.eCommerce.command.DeleteProductPrice;
...
public class ProductPriceController {
	...
	public ResponseEntity<Object> createProductPrice(@RequestBody ProductPrice productPriceToBeAdded) {
		...
		if (commandReturnVal.remove(usedTicketId)) {
			...
			return ResponseEntity.status(HttpStatus.CREATED).body("ProductPrice was created successfully.");

		}
		return ResponseEntity.status(HttpStatus.CONFLICT).body("ProductPrice could not be created.");
