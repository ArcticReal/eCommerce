package com.skytala.eCommerce.domain.workeffort.relations.workEffortInventoryProduced;
...
import com.skytala.eCommerce.domain.workeffort.relations.workEffortInventoryProduced.command.AddWorkEffortInventoryProduced;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortInventoryProduced.command.DeleteWorkEffortInventoryProduced;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortInventoryProduced.command.UpdateWorkEffortInventoryProduced;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortInventoryProduced.event.WorkEffortInventoryProducedAdded;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortInventoryProduced.event.WorkEffortInventoryProducedDeleted;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortInventoryProduced.event.WorkEffortInventoryProducedFound;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortInventoryProduced.event.WorkEffortInventoryProducedUpdated;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortInventoryProduced.mapper.WorkEffortInventoryProducedMapper;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortInventoryProduced.model.WorkEffortInventoryProduced;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortInventoryProduced.query.FindWorkEffortInventoryProducedsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/workEffortInventoryProduceds")
...
//		workEffortInventoryProducedToBeUpdated.setnull(null);
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/workEffortInventoryProduced/\" plus one of the following: "
				+ "";
