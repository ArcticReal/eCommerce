...
public class DeleteGlAccountRole extends Command {

private String toBeDeletedId;
public DeleteGlAccountRole(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("GlAccountRole", UtilMisc.toMap("glAccountRoleId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new GlAccountRoleDeleted(success);
