...
public class DeleteAgreement extends Command {

private String toBeDeletedId;
public DeleteAgreement(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("Agreement", UtilMisc.toMap("agreementId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new AgreementDeleted(success);
