...
public class DeleteCommunicationEventOrder extends Command {

private String toBeDeletedId;
public DeleteCommunicationEventOrder(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CommunicationEventOrder", UtilMisc.toMap("communicationEventOrderId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CommunicationEventOrderDeleted(success);
