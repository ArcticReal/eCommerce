package com.skytala.eCommerce.domain.product.relations.productPromo;
...
import com.skytala.eCommerce.domain.product.relations.productPromo.command.AddProductPromo;
import com.skytala.eCommerce.domain.product.relations.productPromo.command.DeleteProductPromo;
import com.skytala.eCommerce.domain.product.relations.productPromo.command.UpdateProductPromo;
import com.skytala.eCommerce.domain.product.relations.productPromo.event.ProductPromoAdded;
import com.skytala.eCommerce.domain.product.relations.productPromo.event.ProductPromoDeleted;
import com.skytala.eCommerce.domain.product.relations.productPromo.event.ProductPromoFound;
import com.skytala.eCommerce.domain.product.relations.productPromo.event.ProductPromoUpdated;
import com.skytala.eCommerce.domain.product.relations.productPromo.mapper.ProductPromoMapper;
import com.skytala.eCommerce.domain.product.relations.productPromo.model.ProductPromo;
import com.skytala.eCommerce.domain.product.relations.productPromo.query.FindProductPromosBy;
