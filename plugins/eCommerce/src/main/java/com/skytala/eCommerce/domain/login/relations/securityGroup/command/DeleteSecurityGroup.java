...
public class DeleteSecurityGroup extends Command {

private String toBeDeletedId;
public DeleteSecurityGroup(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("SecurityGroup", UtilMisc.toMap("securityGroupId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new SecurityGroupDeleted(success);
