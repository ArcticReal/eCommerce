...
public class DeleteCommunicationEventRole extends Command {

private String toBeDeletedId;
public DeleteCommunicationEventRole(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CommunicationEventRole", UtilMisc.toMap("communicationEventRoleId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CommunicationEventRoleDeleted(success);
