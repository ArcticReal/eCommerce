package com.skytala.eCommerce.domain.product.relations.productStoreGroupType;
...
import com.skytala.eCommerce.domain.product.relations.productStoreGroupType.command.AddProductStoreGroupType;
import com.skytala.eCommerce.domain.product.relations.productStoreGroupType.command.DeleteProductStoreGroupType;
import com.skytala.eCommerce.domain.product.relations.productStoreGroupType.command.UpdateProductStoreGroupType;
import com.skytala.eCommerce.domain.product.relations.productStoreGroupType.event.ProductStoreGroupTypeAdded;
import com.skytala.eCommerce.domain.product.relations.productStoreGroupType.event.ProductStoreGroupTypeDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productStoreGroupType.query.FindProductStoreGroupTypesBy;
