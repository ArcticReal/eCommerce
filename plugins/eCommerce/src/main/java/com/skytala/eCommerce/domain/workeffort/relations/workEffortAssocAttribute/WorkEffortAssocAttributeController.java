package com.skytala.eCommerce.domain.workeffort.relations.workEffortAssocAttribute;
...
import com.skytala.eCommerce.domain.workeffort.relations.workEffortAssocAttribute.command.AddWorkEffortAssocAttribute;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortAssocAttribute.command.DeleteWorkEffortAssocAttribute;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortAssocAttribute.command.UpdateWorkEffortAssocAttribute;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortAssocAttribute.event.WorkEffortAssocAttributeAdded;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortAssocAttribute.event.WorkEffortAssocAttributeDeleted;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortAssocAttribute.event.WorkEffortAssocAttributeFound;
import com.skytala.eCommerce.domain.workeffort.relations.workEffortAssocAttribute.event.WorkEffortAssocAttributeUpdated;
...
import com.skytala.eCommerce.domain.workeffort.relations.workEffortAssocAttribute.query.FindWorkEffortAssocAttributesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/workEffortAssocAttributes")
