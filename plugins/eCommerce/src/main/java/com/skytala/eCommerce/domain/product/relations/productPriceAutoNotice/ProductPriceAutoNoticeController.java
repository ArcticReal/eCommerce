package com.skytala.eCommerce.domain.product.relations.productPriceAutoNotice;
...
import com.skytala.eCommerce.domain.product.relations.productPriceAutoNotice.command.AddProductPriceAutoNotice;
import com.skytala.eCommerce.domain.product.relations.productPriceAutoNotice.command.DeleteProductPriceAutoNotice;
import com.skytala.eCommerce.domain.product.relations.productPriceAutoNotice.command.UpdateProductPriceAutoNotice;
import com.skytala.eCommerce.domain.product.relations.productPriceAutoNotice.event.ProductPriceAutoNoticeAdded;
import com.skytala.eCommerce.domain.product.relations.productPriceAutoNotice.event.ProductPriceAutoNoticeDeleted;
import com.skytala.eCommerce.domain.product.relations.productPriceAutoNotice.event.ProductPriceAutoNoticeFound;
import com.skytala.eCommerce.domain.product.relations.productPriceAutoNotice.event.ProductPriceAutoNoticeUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productPriceAutoNotice.query.FindProductPriceAutoNoticesBy;
