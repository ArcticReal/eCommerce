...
public class DeleteMrpEventType extends Command {

private String toBeDeletedId;
public DeleteMrpEventType(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("MrpEventType", UtilMisc.toMap("mrpEventTypeId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new MrpEventTypeDeleted(success);
