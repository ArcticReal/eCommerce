...
@RestController
@RequestMapping("/service/ContentComponentController")
public class ContentComponentServiceController{

	@RequestMapping(method = RequestMethod.POST, value = "/updateSurvey")
	public ResponseEntity<Object> updateSurvey(HttpSession session, @RequestParam(value="surveyId") String surveyId, @RequestParam(value="isAnonymous", required=false) Boolean isAnonymous, @RequestParam(value="comments", required=false) String comments, @RequestParam(value="surveyName", required=false) String surveyName, @RequestParam(value="allowMultiple", required=false) Boolean allowMultiple, @RequestParam(value="responseService", required=false) String responseService, @RequestParam(value="description", required=false) String description, @RequestParam(value="acroFormContentId", required=false) String acroFormContentId, @RequestParam(value="allowUpdate", required=false) Boolean allowUpdate, @RequestParam(value="submitCaption", required=false) String submitCaption) {
	...
	public ResponseEntity<Object> createSurvey(HttpSession session, @RequestParam(value="surveyId") String surveyId, @RequestParam(value="isAnonymous", required=false) Boolean isAnonymous, @RequestParam(value="comments", required=false) String comments, @RequestParam(value="surveyName", required=false) String surveyName, @RequestParam(value="allowMultiple", required=false) Boolean allowMultiple, @RequestParam(value="responseService", required=false) String responseService, @RequestParam(value="description", required=false) String description, @RequestParam(value="acroFormContentId", required=false) String acroFormContentId, @RequestParam(value="allowUpdate", required=false) Boolean allowUpdate, @RequestParam(value="submitCaption", required=false) String submitCaption) {
	...
	public ResponseEntity<Object> createSurveyQuestionCategory(HttpSession session, @RequestParam(value="surveyQuestionCategoryId") String surveyQuestionCategoryId, @RequestParam(value="description", required=false) String description, @RequestParam(value="parentCategoryId", required=false) String parentCategoryId) {
	...
	public ResponseEntity<Object> createSurveyQuestion(HttpSession session, @RequestParam(value="surveyQuestionId") String surveyQuestionId, @RequestParam(value="surveyQuestionTypeId", required=false) String surveyQuestionTypeId, @RequestParam(value="enumTypeId", required=false) String enumTypeId, @RequestParam(value="formatString", required=false) Long formatString, @RequestParam(value="surveyQuestionCategoryId", required=false) String surveyQuestionCategoryId, @RequestParam(value="surveyId", required=false) String surveyId, @RequestParam(value="question", required=false) String question, @RequestParam(value="hint", required=false) String hint, @RequestParam(value="geoId", required=false) String geoId, @RequestParam(value="description", required=false) String description) {
