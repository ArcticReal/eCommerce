...
public class DeleteDataResourceTypeAttr extends Command {

private String toBeDeletedId;
public DeleteDataResourceTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("DataResourceTypeAttr", UtilMisc.toMap("dataResourceTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new DataResourceTypeAttrDeleted(success);
