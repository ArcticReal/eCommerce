package com.skytala.eCommerce.domain.person.model;
...
public class Person {
	...
	public Timestamp getDeceasedDate() {
		return deceasedDate;
	}

	public void setDeceasedDate(Timestamp deceasedDate) {
	...
	public Timestamp getPassportExpireDate() {
		return passportExpireDate;
	}

	public void setPassportExpireDate(Timestamp passportExpireDate) {
