package com.skytala.eCommerce.domain.product.relations.productAssoc;
...
import com.skytala.eCommerce.domain.product.relations.productAssoc.command.AddProductAssoc;
import com.skytala.eCommerce.domain.product.relations.productAssoc.command.DeleteProductAssoc;
import com.skytala.eCommerce.domain.product.relations.productAssoc.command.UpdateProductAssoc;
import com.skytala.eCommerce.domain.product.relations.productAssoc.event.ProductAssocAdded;
import com.skytala.eCommerce.domain.product.relations.productAssoc.event.ProductAssocDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productAssoc.query.FindProductAssocsBy;
