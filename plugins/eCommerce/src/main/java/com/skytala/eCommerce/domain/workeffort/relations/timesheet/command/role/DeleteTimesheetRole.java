...
public class DeleteTimesheetRole extends Command {

private String toBeDeletedId;
public DeleteTimesheetRole(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("TimesheetRole", UtilMisc.toMap("timesheetRoleId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new TimesheetRoleDeleted(success);
