package com.skytala.eCommerce.domain.product.relations.inventoryItemTypeAttr;
...
import com.skytala.eCommerce.domain.product.relations.inventoryItemTypeAttr.command.AddInventoryItemTypeAttr;
import com.skytala.eCommerce.domain.product.relations.inventoryItemTypeAttr.command.DeleteInventoryItemTypeAttr;
import com.skytala.eCommerce.domain.product.relations.inventoryItemTypeAttr.command.UpdateInventoryItemTypeAttr;
import com.skytala.eCommerce.domain.product.relations.inventoryItemTypeAttr.event.InventoryItemTypeAttrAdded;
import com.skytala.eCommerce.domain.product.relations.inventoryItemTypeAttr.event.InventoryItemTypeAttrDeleted;
import com.skytala.eCommerce.domain.product.relations.inventoryItemTypeAttr.event.InventoryItemTypeAttrFound;
import com.skytala.eCommerce.domain.product.relations.inventoryItemTypeAttr.event.InventoryItemTypeAttrUpdated;
...
import com.skytala.eCommerce.domain.product.relations.inventoryItemTypeAttr.query.FindInventoryItemTypeAttrsBy;
