...
public class DeleteZipSalesTaxLookup extends Command {

private String toBeDeletedId;
public DeleteZipSalesTaxLookup(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ZipSalesTaxLookup", UtilMisc.toMap("zipSalesTaxLookupId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ZipSalesTaxLookupDeleted(success);
