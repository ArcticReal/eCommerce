...
public class DeleteProductMaint extends Command {

private String toBeDeletedId;
public DeleteProductMaint(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductMaint", UtilMisc.toMap("productMaintId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductMaintDeleted(success);
