...
public class DeleteOrderContactMech extends Command {

private String toBeDeletedId;
public DeleteOrderContactMech(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderContactMech", UtilMisc.toMap("orderContactMechId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderContactMechDeleted(success);
