package com.skytala.eCommerce.domain.product.relations.subscriptionTypeAttr;
...
import com.skytala.eCommerce.domain.product.relations.subscriptionTypeAttr.command.AddSubscriptionTypeAttr;
import com.skytala.eCommerce.domain.product.relations.subscriptionTypeAttr.command.DeleteSubscriptionTypeAttr;
import com.skytala.eCommerce.domain.product.relations.subscriptionTypeAttr.command.UpdateSubscriptionTypeAttr;
import com.skytala.eCommerce.domain.product.relations.subscriptionTypeAttr.event.SubscriptionTypeAttrAdded;
import com.skytala.eCommerce.domain.product.relations.subscriptionTypeAttr.event.SubscriptionTypeAttrDeleted;
...
import com.skytala.eCommerce.domain.product.relations.subscriptionTypeAttr.query.FindSubscriptionTypeAttrsBy;
