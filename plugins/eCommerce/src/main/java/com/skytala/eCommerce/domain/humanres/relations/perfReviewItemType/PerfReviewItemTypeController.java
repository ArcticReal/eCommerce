package com.skytala.eCommerce.domain.humanres.relations.perfReviewItemType;
...
import com.skytala.eCommerce.domain.humanres.relations.perfReviewItemType.command.AddPerfReviewItemType;
import com.skytala.eCommerce.domain.humanres.relations.perfReviewItemType.command.DeletePerfReviewItemType;
import com.skytala.eCommerce.domain.humanres.relations.perfReviewItemType.command.UpdatePerfReviewItemType;
import com.skytala.eCommerce.domain.humanres.relations.perfReviewItemType.event.PerfReviewItemTypeAdded;
import com.skytala.eCommerce.domain.humanres.relations.perfReviewItemType.event.PerfReviewItemTypeDeleted;
import com.skytala.eCommerce.domain.humanres.relations.perfReviewItemType.event.PerfReviewItemTypeFound;
import com.skytala.eCommerce.domain.humanres.relations.perfReviewItemType.event.PerfReviewItemTypeUpdated;
import com.skytala.eCommerce.domain.humanres.relations.perfReviewItemType.mapper.PerfReviewItemTypeMapper;
import com.skytala.eCommerce.domain.humanres.relations.perfReviewItemType.model.PerfReviewItemType;
import com.skytala.eCommerce.domain.humanres.relations.perfReviewItemType.query.FindPerfReviewItemTypesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/perfReviewItemTypes")
public class PerfReviewItemTypeController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{perfReviewItemTypeId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{perfReviewItemTypeId}")
