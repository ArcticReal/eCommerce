...
public class DeleteContent extends Command {

private String toBeDeletedId;
public DeleteContent(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("Content", UtilMisc.toMap("contentId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ContentDeleted(success);
