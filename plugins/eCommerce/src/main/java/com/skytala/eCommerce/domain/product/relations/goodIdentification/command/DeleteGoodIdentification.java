...
public class DeleteGoodIdentification extends Command {

private String toBeDeletedId;
public DeleteGoodIdentification(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("GoodIdentification", UtilMisc.toMap("goodIdentificationId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new GoodIdentificationDeleted(success);
