...
public class DeleteWebSitePublishPoint extends Command {

private String toBeDeletedId;
public DeleteWebSitePublishPoint(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("WebSitePublishPoint", UtilMisc.toMap("webSitePublishPointId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new WebSitePublishPointDeleted(success);
