package com.skytala.eCommerce.domain.product.relations.productPriceActionType;
...
import com.skytala.eCommerce.domain.product.relations.productPriceActionType.command.AddProductPriceActionType;
import com.skytala.eCommerce.domain.product.relations.productPriceActionType.command.DeleteProductPriceActionType;
import com.skytala.eCommerce.domain.product.relations.productPriceActionType.command.UpdateProductPriceActionType;
import com.skytala.eCommerce.domain.product.relations.productPriceActionType.event.ProductPriceActionTypeAdded;
import com.skytala.eCommerce.domain.product.relations.productPriceActionType.event.ProductPriceActionTypeDeleted;
import com.skytala.eCommerce.domain.product.relations.productPriceActionType.event.ProductPriceActionTypeFound;
import com.skytala.eCommerce.domain.product.relations.productPriceActionType.event.ProductPriceActionTypeUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productPriceActionType.query.FindProductPriceActionTypesBy;
