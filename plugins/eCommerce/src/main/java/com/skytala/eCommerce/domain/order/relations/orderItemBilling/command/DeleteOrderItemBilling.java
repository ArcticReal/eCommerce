...
public class DeleteOrderItemBilling extends Command {

private String toBeDeletedId;
public DeleteOrderItemBilling(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderItemBilling", UtilMisc.toMap("orderItemBillingId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderItemBillingDeleted(success);
