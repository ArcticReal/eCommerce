package com.skytala.eCommerce.domain.product.relations.facilityGroupRole;
...
import com.skytala.eCommerce.domain.product.relations.facilityGroupRole.command.AddFacilityGroupRole;
import com.skytala.eCommerce.domain.product.relations.facilityGroupRole.command.DeleteFacilityGroupRole;
import com.skytala.eCommerce.domain.product.relations.facilityGroupRole.command.UpdateFacilityGroupRole;
import com.skytala.eCommerce.domain.product.relations.facilityGroupRole.event.FacilityGroupRoleAdded;
import com.skytala.eCommerce.domain.product.relations.facilityGroupRole.event.FacilityGroupRoleDeleted;
...
import com.skytala.eCommerce.domain.product.relations.facilityGroupRole.query.FindFacilityGroupRolesBy;
