package com.skytala.eCommerce.domain.order.relations.quoteNote;
...
import com.skytala.eCommerce.domain.order.relations.quoteNote.command.AddQuoteNote;
import com.skytala.eCommerce.domain.order.relations.quoteNote.command.DeleteQuoteNote;
import com.skytala.eCommerce.domain.order.relations.quoteNote.command.UpdateQuoteNote;
import com.skytala.eCommerce.domain.order.relations.quoteNote.event.QuoteNoteAdded;
import com.skytala.eCommerce.domain.order.relations.quoteNote.event.QuoteNoteDeleted;
import com.skytala.eCommerce.domain.order.relations.quoteNote.event.QuoteNoteFound;
import com.skytala.eCommerce.domain.order.relations.quoteNote.event.QuoteNoteUpdated;
...
import com.skytala.eCommerce.domain.order.relations.quoteNote.query.FindQuoteNotesBy;
