package com.skytala.eCommerce.domain.productCategoryType;
...
import com.skytala.eCommerce.domain.productCategoryType.command.AddProductCategoryType;
import com.skytala.eCommerce.domain.productCategoryType.command.DeleteProductCategoryType;
import com.skytala.eCommerce.domain.productCategoryType.command.UpdateProductCategoryType;
import com.skytala.eCommerce.domain.productCategoryType.event.ProductCategoryTypeAdded;
import com.skytala.eCommerce.domain.productCategoryType.event.ProductCategoryTypeDeleted;
import com.skytala.eCommerce.domain.productCategoryType.event.ProductCategoryTypeFound;
import com.skytala.eCommerce.domain.productCategoryType.event.ProductCategoryTypeUpdated;
...
import com.skytala.eCommerce.domain.productCategoryType.query.FindProductCategoryTypesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/productCategoryTypes")
public class ProductCategoryTypeController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{productCategoryTypeId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{productCategoryTypeId}")
