...
public class DeleteTelecomNumber extends Command {

private String toBeDeletedId;
public DeleteTelecomNumber(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("TelecomNumber", UtilMisc.toMap("telecomNumberId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new TelecomNumberDeleted(success);
