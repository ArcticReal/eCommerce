package com.skytala.eCommerce.domain.order.relations.orderTypeAttr;
...
import com.skytala.eCommerce.domain.order.relations.orderTypeAttr.command.AddOrderTypeAttr;
import com.skytala.eCommerce.domain.order.relations.orderTypeAttr.command.DeleteOrderTypeAttr;
import com.skytala.eCommerce.domain.order.relations.orderTypeAttr.command.UpdateOrderTypeAttr;
import com.skytala.eCommerce.domain.order.relations.orderTypeAttr.event.OrderTypeAttrAdded;
import com.skytala.eCommerce.domain.order.relations.orderTypeAttr.event.OrderTypeAttrDeleted;
import com.skytala.eCommerce.domain.order.relations.orderTypeAttr.event.OrderTypeAttrFound;
import com.skytala.eCommerce.domain.order.relations.orderTypeAttr.event.OrderTypeAttrUpdated;
...
import com.skytala.eCommerce.domain.order.relations.orderTypeAttr.query.FindOrderTypeAttrsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/orderTypeAttrs")
public class OrderTypeAttrController {
	...
	public boolean updateOrderTypeAttr(HttpServletRequest request) throws Exception {
		...
		if (updateOrderTypeAttr(orderTypeAttrToBeUpdated, null).getStatusCode()
...
//		orderTypeAttrToBeUpdated.setnull(null);
