...
public class DeleteProdConfItemContent extends Command {

private String toBeDeletedId;
public DeleteProdConfItemContent(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProdConfItemContent", UtilMisc.toMap("prodConfItemContentId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProdConfItemContentDeleted(success);
