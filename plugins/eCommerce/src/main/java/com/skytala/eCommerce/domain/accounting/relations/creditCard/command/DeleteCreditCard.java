...
public class DeleteCreditCard extends Command {

private String toBeDeletedId;
public DeleteCreditCard(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CreditCard", UtilMisc.toMap("creditCardId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CreditCardDeleted(success);
