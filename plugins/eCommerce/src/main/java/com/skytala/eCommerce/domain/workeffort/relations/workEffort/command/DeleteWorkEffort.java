...
public class DeleteWorkEffort extends Command {

private String toBeDeletedId;
public DeleteWorkEffort(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("WorkEffort", UtilMisc.toMap("workEffortId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new WorkEffortDeleted(success);
