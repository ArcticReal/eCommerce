package com.skytala.eCommerce.domain.marketing.relations.webSiteContactList;
...
import com.skytala.eCommerce.domain.marketing.relations.webSiteContactList.command.AddWebSiteContactList;
import com.skytala.eCommerce.domain.marketing.relations.webSiteContactList.command.DeleteWebSiteContactList;
import com.skytala.eCommerce.domain.marketing.relations.webSiteContactList.command.UpdateWebSiteContactList;
import com.skytala.eCommerce.domain.marketing.relations.webSiteContactList.event.WebSiteContactListAdded;
import com.skytala.eCommerce.domain.marketing.relations.webSiteContactList.event.WebSiteContactListDeleted;
import com.skytala.eCommerce.domain.marketing.relations.webSiteContactList.event.WebSiteContactListFound;
import com.skytala.eCommerce.domain.marketing.relations.webSiteContactList.event.WebSiteContactListUpdated;
...
import com.skytala.eCommerce.domain.marketing.relations.webSiteContactList.query.FindWebSiteContactListsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/webSiteContactLists")
...
//		webSiteContactListToBeUpdated.setnull(null);
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/webSiteContactList/\" plus one of the following: "
				+ "";
