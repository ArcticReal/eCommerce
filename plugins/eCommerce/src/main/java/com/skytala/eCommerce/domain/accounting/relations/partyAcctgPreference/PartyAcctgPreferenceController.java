...
@RestController
@CrossOrigin
@RequestMapping("/partyAcctgPreferences")
public class PartyAcctgPreferenceController {
	...
	public ResponseEntity<Object> findPartyAcctgPreferencesBy(@RequestParam(required = false) Map<String, String> allRequestParams) throws Exception {
		...
		if (partyAcctgPreferences.size() == 1) {
			return ResponseEntity.ok().body(partyAcctgPreferences.get(0));
		}
	...
	public ResponseEntity<Object> createPartyAcctgPreference(@RequestBody PartyAcctgPreference partyAcctgPreferenceToBeAdded) throws Exception {
		...
		if (partyAcctgPreference != null) 
			return ResponseEntity.status(HttpStatus.CREATED)
					             .body(partyAcctgPreference);
		else 
			return ResponseEntity.status(HttpStatus.CONFLICT)
					             .body("PartyAcctgPreference could not be created.");
	}
	...
	public boolean updatePartyAcctgPreference(HttpServletRequest request) throws Exception {
		...
		if (updatePartyAcctgPreference(partyAcctgPreferenceToBeUpdated, null).getStatusCode()
	...
	public ResponseEntity<Object> updatePartyAcctgPreference(@RequestBody PartyAcctgPreference partyAcctgPreferenceToBeUpdated,
...
//		partyAcctgPreferenceToBeUpdated.setnull(null);
	...
	public ResponseEntity<Object> findById(@PathVariable String partyAcctgPreferenceId) throws Exception {
		...
		try {
			...
			Object foundPartyAcctgPreference = findPartyAcctgPreferencesBy(requestParams).getBody();
			return ResponseEntity.status(HttpStatus.OK).body(foundPartyAcctgPreference);
		} catch (RecordNotFoundException e) {
	...
	public ResponseEntity<Object> deletePartyAcctgPreferenceByIdUpdated(@PathVariable String partyAcctgPreferenceId) throws Exception {
		...
		return ResponseEntity.status(HttpStatus.CONFLICT).body("PartyAcctgPreference could not be deleted");
