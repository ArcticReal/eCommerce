...
@RestController
@RequestMapping("/service/AccountingPaymentGatewayConfigController")
public class AccountingPaymentGatewayConfigServiceController{
	...
	public ResponseEntity<Object> updatePaymentGatewayConfigWorldPay(HttpSession session, @RequestParam(value="paymentGatewayConfigId") String paymentGatewayConfigId, @RequestParam(value="authMode", required=false) Boolean authMode, @RequestParam(value="instId", required=false) Long instId, @RequestParam(value="redirectUrl", required=false) Long redirectUrl, @RequestParam(value="hideContact", required=false) Boolean hideContact, @RequestParam(value="testMode", required=false) Long testMode, @RequestParam(value="fixContact", required=false) Boolean fixContact, @RequestParam(value="langId", required=false) String langId, @RequestParam(value="hideCurrency", required=false) Boolean hideCurrency, @RequestParam(value="noLanguageMenu", required=false) Boolean noLanguageMenu, @RequestParam(value="withDelivery", required=false) Boolean withDelivery) {
	...
	public ResponseEntity<Object> updatePaymentGatewayConfigPayflowPro(HttpSession session, @RequestParam(value="paymentGatewayConfigId") String paymentGatewayConfigId, @RequestParam(value="redirectUrl", required=false) Long redirectUrl, @RequestParam(value="proxyPassword", required=false) Long proxyPassword, @RequestParam(value="cancelReturnUrl", required=false) Long cancelReturnUrl, @RequestParam(value="enableTransmit", required=false) Long enableTransmit, @RequestParam(value="checkAvs", required=false) Boolean checkAvs, @RequestParam(value="stackTraceOn", required=false) Boolean stackTraceOn, @RequestParam(value="userId", required=false) String userId, @RequestParam(value="checkCvv2", required=false) Boolean checkCvv2, @RequestParam(value="timeout", required=false) Long timeout, @RequestParam(value="proxyPort", required=false) Long proxyPort, @RequestParam(value="proxyLogon", required=false) Long proxyLogon, @RequestParam(value="certsPath", required=false) Long certsPath, @RequestParam(value="partner", required=false) String partner, @RequestParam(value="vendor", required=false) String vendor, @RequestParam(value="logFileName", required=false) Long logFileName, @RequestParam(value="hostPort", required=false) Long hostPort, @RequestParam(value="hostAddress", required=false) Long hostAddress, @RequestParam(value="preAuth", required=false) Boolean preAuth, @RequestParam(value="proxyAddress", required=false) Long proxyAddress, @RequestParam(value="pwd", required=false) Long pwd, @RequestParam(value="returnUrl", required=false) Long returnUrl, @RequestParam(value="loggingLevel", required=false) Long loggingLevel, @RequestParam(value="maxLogFileSize", required=false) Long maxLogFileSize) {
	...
	public ResponseEntity<Object> updatePaymentGatewayConfigSecurePay(HttpSession session, @RequestParam(value="paymentGatewayConfigId") String paymentGatewayConfigId, @RequestParam(value="merchantId", required=false) Long merchantId, @RequestParam(value="serverURL", required=false) Long serverURL, @RequestParam(value="pwd", required=false) Long pwd, @RequestParam(value="processTimeout", required=false) Long processTimeout, @RequestParam(value="enableAmountRound", required=false) Boolean enableAmountRound) {
