...
public class DeleteShipment extends Command {

private String toBeDeletedId;
public DeleteShipment(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("Shipment", UtilMisc.toMap("shipmentId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ShipmentDeleted(success);
