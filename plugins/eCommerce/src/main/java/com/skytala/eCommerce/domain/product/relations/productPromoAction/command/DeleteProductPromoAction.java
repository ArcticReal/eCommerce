...
public class DeleteProductPromoAction extends Command {

private String toBeDeletedId;
public DeleteProductPromoAction(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductPromoAction", UtilMisc.toMap("productPromoActionId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductPromoActionDeleted(success);
