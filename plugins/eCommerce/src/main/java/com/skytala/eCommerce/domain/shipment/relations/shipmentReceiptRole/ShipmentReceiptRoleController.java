package com.skytala.eCommerce.domain.shipment.relations.shipmentReceiptRole;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentReceiptRole.command.AddShipmentReceiptRole;
import com.skytala.eCommerce.domain.shipment.relations.shipmentReceiptRole.command.DeleteShipmentReceiptRole;
import com.skytala.eCommerce.domain.shipment.relations.shipmentReceiptRole.command.UpdateShipmentReceiptRole;
import com.skytala.eCommerce.domain.shipment.relations.shipmentReceiptRole.event.ShipmentReceiptRoleAdded;
import com.skytala.eCommerce.domain.shipment.relations.shipmentReceiptRole.event.ShipmentReceiptRoleDeleted;
import com.skytala.eCommerce.domain.shipment.relations.shipmentReceiptRole.event.ShipmentReceiptRoleFound;
import com.skytala.eCommerce.domain.shipment.relations.shipmentReceiptRole.event.ShipmentReceiptRoleUpdated;
...
import com.skytala.eCommerce.domain.shipment.relations.shipmentReceiptRole.query.FindShipmentReceiptRolesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/shipmentReceiptRoles")
