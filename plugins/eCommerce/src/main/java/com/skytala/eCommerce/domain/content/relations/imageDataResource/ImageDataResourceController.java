package com.skytala.eCommerce.domain.content.relations.imageDataResource;
...
import com.skytala.eCommerce.domain.content.relations.imageDataResource.command.AddImageDataResource;
import com.skytala.eCommerce.domain.content.relations.imageDataResource.command.DeleteImageDataResource;
import com.skytala.eCommerce.domain.content.relations.imageDataResource.command.UpdateImageDataResource;
import com.skytala.eCommerce.domain.content.relations.imageDataResource.event.ImageDataResourceAdded;
import com.skytala.eCommerce.domain.content.relations.imageDataResource.event.ImageDataResourceDeleted;
import com.skytala.eCommerce.domain.content.relations.imageDataResource.event.ImageDataResourceFound;
import com.skytala.eCommerce.domain.content.relations.imageDataResource.event.ImageDataResourceUpdated;
...
import com.skytala.eCommerce.domain.content.relations.imageDataResource.query.FindImageDataResourcesBy;
...
//		imageDataResourceToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{imageDataResourceId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{imageDataResourceId}")
