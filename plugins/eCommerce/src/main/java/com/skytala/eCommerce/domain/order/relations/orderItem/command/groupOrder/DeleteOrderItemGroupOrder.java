...
public class DeleteOrderItemGroupOrder extends Command {

private String toBeDeletedId;
public DeleteOrderItemGroupOrder(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderItemGroupOrder", UtilMisc.toMap("orderItemGroupOrderId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderItemGroupOrderDeleted(success);
