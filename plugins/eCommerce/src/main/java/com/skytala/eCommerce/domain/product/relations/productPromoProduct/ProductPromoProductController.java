package com.skytala.eCommerce.domain.product.relations.productPromoProduct;
...
import com.skytala.eCommerce.domain.product.relations.productPromoProduct.command.AddProductPromoProduct;
import com.skytala.eCommerce.domain.product.relations.productPromoProduct.command.DeleteProductPromoProduct;
import com.skytala.eCommerce.domain.product.relations.productPromoProduct.command.UpdateProductPromoProduct;
import com.skytala.eCommerce.domain.product.relations.productPromoProduct.event.ProductPromoProductAdded;
import com.skytala.eCommerce.domain.product.relations.productPromoProduct.event.ProductPromoProductDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productPromoProduct.query.FindProductPromoProductsBy;
