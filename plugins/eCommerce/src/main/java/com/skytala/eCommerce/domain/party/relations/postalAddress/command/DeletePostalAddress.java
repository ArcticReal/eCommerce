...
public class DeletePostalAddress extends Command {

private String toBeDeletedId;
public DeletePostalAddress(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PostalAddress", UtilMisc.toMap("postalAddressId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PostalAddressDeleted(success);
