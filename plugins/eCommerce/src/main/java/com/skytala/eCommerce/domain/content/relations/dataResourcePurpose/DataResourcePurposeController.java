package com.skytala.eCommerce.domain.content.relations.dataResourcePurpose;
...
import com.skytala.eCommerce.domain.content.relations.dataResourcePurpose.command.AddDataResourcePurpose;
import com.skytala.eCommerce.domain.content.relations.dataResourcePurpose.command.DeleteDataResourcePurpose;
import com.skytala.eCommerce.domain.content.relations.dataResourcePurpose.command.UpdateDataResourcePurpose;
import com.skytala.eCommerce.domain.content.relations.dataResourcePurpose.event.DataResourcePurposeAdded;
import com.skytala.eCommerce.domain.content.relations.dataResourcePurpose.event.DataResourcePurposeDeleted;
import com.skytala.eCommerce.domain.content.relations.dataResourcePurpose.event.DataResourcePurposeFound;
import com.skytala.eCommerce.domain.content.relations.dataResourcePurpose.event.DataResourcePurposeUpdated;
...
import com.skytala.eCommerce.domain.content.relations.dataResourcePurpose.query.FindDataResourcePurposesBy;
