package com.skytala.eCommerce.domain.content.relations.documentAttribute;
...
import com.skytala.eCommerce.domain.content.relations.documentAttribute.command.AddDocumentAttribute;
import com.skytala.eCommerce.domain.content.relations.documentAttribute.command.DeleteDocumentAttribute;
import com.skytala.eCommerce.domain.content.relations.documentAttribute.command.UpdateDocumentAttribute;
import com.skytala.eCommerce.domain.content.relations.documentAttribute.event.DocumentAttributeAdded;
import com.skytala.eCommerce.domain.content.relations.documentAttribute.event.DocumentAttributeDeleted;
import com.skytala.eCommerce.domain.content.relations.documentAttribute.event.DocumentAttributeFound;
import com.skytala.eCommerce.domain.content.relations.documentAttribute.event.DocumentAttributeUpdated;
...
import com.skytala.eCommerce.domain.content.relations.documentAttribute.query.FindDocumentAttributesBy;
...
public class DocumentAttributeController {
	...
	public boolean updateDocumentAttribute(HttpServletRequest request) throws Exception {
		...
		if (updateDocumentAttribute(documentAttributeToBeUpdated, null).getStatusCode()
...
//		documentAttributeToBeUpdated.setnull(null);
