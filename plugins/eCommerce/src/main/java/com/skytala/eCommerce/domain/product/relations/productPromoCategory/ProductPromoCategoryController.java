package com.skytala.eCommerce.domain.product.relations.productPromoCategory;
...
import com.skytala.eCommerce.domain.product.relations.productPromoCategory.command.AddProductPromoCategory;
import com.skytala.eCommerce.domain.product.relations.productPromoCategory.command.DeleteProductPromoCategory;
import com.skytala.eCommerce.domain.product.relations.productPromoCategory.command.UpdateProductPromoCategory;
import com.skytala.eCommerce.domain.product.relations.productPromoCategory.event.ProductPromoCategoryAdded;
import com.skytala.eCommerce.domain.product.relations.productPromoCategory.event.ProductPromoCategoryDeleted;
import com.skytala.eCommerce.domain.product.relations.productPromoCategory.event.ProductPromoCategoryFound;
import com.skytala.eCommerce.domain.product.relations.productPromoCategory.event.ProductPromoCategoryUpdated;
import com.skytala.eCommerce.domain.product.relations.productPromoCategory.mapper.ProductPromoCategoryMapper;
import com.skytala.eCommerce.domain.product.relations.productPromoCategory.model.ProductPromoCategory;
import com.skytala.eCommerce.domain.product.relations.productPromoCategory.query.FindProductPromoCategorysBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/productPromoCategorys")
...
//		productPromoCategoryToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{productPromoCategoryId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{productPromoCategoryId}")
