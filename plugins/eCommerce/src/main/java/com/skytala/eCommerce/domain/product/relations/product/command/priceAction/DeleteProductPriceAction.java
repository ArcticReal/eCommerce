...
public class DeleteProductPriceAction extends Command {

private String toBeDeletedId;
public DeleteProductPriceAction(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductPriceAction", UtilMisc.toMap("productPriceActionId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductPriceActionDeleted(success);
