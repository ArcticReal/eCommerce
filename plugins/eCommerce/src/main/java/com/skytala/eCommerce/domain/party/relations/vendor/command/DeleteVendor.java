...
public class DeleteVendor extends Command {

private String toBeDeletedId;
public DeleteVendor(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("Vendor", UtilMisc.toMap("vendorId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new VendorDeleted(success);
