...
public class DeleteMrpEvent extends Command {

private String toBeDeletedId;
public DeleteMrpEvent(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("MrpEvent", UtilMisc.toMap("mrpEventId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new MrpEventDeleted(success);
