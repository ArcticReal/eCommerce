package com.skytala.eCommerce.domain.accounting.relations.finAccountAttribute;
...
import com.skytala.eCommerce.domain.accounting.relations.finAccountAttribute.command.AddFinAccountAttribute;
import com.skytala.eCommerce.domain.accounting.relations.finAccountAttribute.command.DeleteFinAccountAttribute;
import com.skytala.eCommerce.domain.accounting.relations.finAccountAttribute.command.UpdateFinAccountAttribute;
import com.skytala.eCommerce.domain.accounting.relations.finAccountAttribute.event.FinAccountAttributeAdded;
import com.skytala.eCommerce.domain.accounting.relations.finAccountAttribute.event.FinAccountAttributeDeleted;
import com.skytala.eCommerce.domain.accounting.relations.finAccountAttribute.event.FinAccountAttributeFound;
import com.skytala.eCommerce.domain.accounting.relations.finAccountAttribute.event.FinAccountAttributeUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.finAccountAttribute.query.FindFinAccountAttributesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/finAccountAttributes")
public class FinAccountAttributeController {
	...
	public boolean updateFinAccountAttribute(HttpServletRequest request) throws Exception {
		...
		if (updateFinAccountAttribute(finAccountAttributeToBeUpdated, null).getStatusCode()
...
//		finAccountAttributeToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{finAccountAttributeId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{finAccountAttributeId}")
