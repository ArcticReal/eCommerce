...
public class DeleteAgreementRole extends Command {

private String toBeDeletedId;
public DeleteAgreementRole(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("AgreementRole", UtilMisc.toMap("agreementRoleId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new AgreementRoleDeleted(success);
