...
@RestController
@RequestMapping("/service/AccountingController")
public class AccountingServiceController{
	...
	public ResponseEntity<Object> createFixedAssetStdCostType(HttpSession session, @RequestParam(value="parentTypeId", required=false) String parentTypeId, @RequestParam(value="fixedAssetStdCostTypeId", required=false) String fixedAssetStdCostTypeId, @RequestParam(value="hasTable", required=false) Boolean hasTable, @RequestParam(value="description", required=false) String description) {
