...
public class DeleteUserLoginHistory extends Command {

private String toBeDeletedId;
public DeleteUserLoginHistory(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("UserLoginHistory", UtilMisc.toMap("userLoginHistoryId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new UserLoginHistoryDeleted(success);
