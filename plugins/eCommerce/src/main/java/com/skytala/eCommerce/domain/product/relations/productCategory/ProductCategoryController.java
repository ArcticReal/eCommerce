package com.skytala.eCommerce.domain.product.relations.productCategory;
...
import com.skytala.eCommerce.domain.product.relations.productCategory.command.AddProductCategory;
import com.skytala.eCommerce.domain.product.relations.productCategory.command.DeleteProductCategory;
import com.skytala.eCommerce.domain.product.relations.productCategory.command.UpdateProductCategory;
import com.skytala.eCommerce.domain.product.relations.productCategory.event.ProductCategoryAdded;
import com.skytala.eCommerce.domain.product.relations.productCategory.event.ProductCategoryDeleted;
import com.skytala.eCommerce.domain.product.relations.productCategory.event.ProductCategoryFound;
import com.skytala.eCommerce.domain.product.relations.productCategory.event.ProductCategoryUpdated;
import com.skytala.eCommerce.domain.product.relations.productCategory.mapper.ProductCategoryMapper;
import com.skytala.eCommerce.domain.product.relations.productCategory.model.ProductCategory;
import com.skytala.eCommerce.domain.product.relations.productCategory.query.FindProductCategorysBy;
