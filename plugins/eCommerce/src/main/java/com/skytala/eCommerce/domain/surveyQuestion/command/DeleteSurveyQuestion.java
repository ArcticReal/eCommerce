...
public class DeleteSurveyQuestion extends Command {

private String toBeDeletedId;
public DeleteSurveyQuestion(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("SurveyQuestion", UtilMisc.toMap("surveyQuestionId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new SurveyQuestionDeleted(success);
