...
public class DeletePartyProfileDefault extends Command {

private String toBeDeletedId;
public DeletePartyProfileDefault(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyProfileDefault", UtilMisc.toMap("partyProfileDefaultId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyProfileDefaultDeleted(success);
