package com.skytala.eCommerce.domain.product.relations.productStorePaymentSetting;
...
import com.skytala.eCommerce.domain.product.relations.productStorePaymentSetting.command.AddProductStorePaymentSetting;
import com.skytala.eCommerce.domain.product.relations.productStorePaymentSetting.command.DeleteProductStorePaymentSetting;
import com.skytala.eCommerce.domain.product.relations.productStorePaymentSetting.command.UpdateProductStorePaymentSetting;
...
import com.skytala.eCommerce.domain.product.relations.productStorePaymentSetting.event.ProductStorePaymentSettingUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productStorePaymentSetting.query.FindProductStorePaymentSettingsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/productStorePaymentSettings")
...
//		productStorePaymentSettingToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{productStorePaymentSettingId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{productStorePaymentSettingId}")
