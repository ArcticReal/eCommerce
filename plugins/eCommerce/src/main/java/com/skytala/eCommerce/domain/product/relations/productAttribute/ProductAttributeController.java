package com.skytala.eCommerce.domain.product.relations.productAttribute;
...
import com.skytala.eCommerce.domain.product.relations.productAttribute.command.AddProductAttribute;
import com.skytala.eCommerce.domain.product.relations.productAttribute.command.DeleteProductAttribute;
import com.skytala.eCommerce.domain.product.relations.productAttribute.command.UpdateProductAttribute;
import com.skytala.eCommerce.domain.product.relations.productAttribute.event.ProductAttributeAdded;
import com.skytala.eCommerce.domain.product.relations.productAttribute.event.ProductAttributeDeleted;
import com.skytala.eCommerce.domain.product.relations.productAttribute.event.ProductAttributeFound;
import com.skytala.eCommerce.domain.product.relations.productAttribute.event.ProductAttributeUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productAttribute.query.FindProductAttributesBy;
