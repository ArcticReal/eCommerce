...
public class DeleteEmployment extends Command {

private String toBeDeletedId;
public DeleteEmployment(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("Employment", UtilMisc.toMap("employmentId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new EmploymentDeleted(success);
