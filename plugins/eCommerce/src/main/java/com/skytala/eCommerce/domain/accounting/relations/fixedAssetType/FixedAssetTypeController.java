package com.skytala.eCommerce.domain.accounting.relations.fixedAssetType;
...
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetType.command.AddFixedAssetType;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetType.command.DeleteFixedAssetType;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetType.command.UpdateFixedAssetType;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetType.event.FixedAssetTypeAdded;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetType.event.FixedAssetTypeDeleted;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetType.event.FixedAssetTypeFound;
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetType.event.FixedAssetTypeUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.fixedAssetType.query.FindFixedAssetTypesBy;
...
public class FixedAssetTypeController {
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/fixedAssetType/\" plus one of the following: "
				+ "";
