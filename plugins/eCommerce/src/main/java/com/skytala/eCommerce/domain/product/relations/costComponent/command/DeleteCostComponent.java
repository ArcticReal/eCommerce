...
public class DeleteCostComponent extends Command {

private String toBeDeletedId;
public DeleteCostComponent(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("CostComponent", UtilMisc.toMap("costComponentId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new CostComponentDeleted(success);
