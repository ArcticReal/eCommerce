package com.skytala.eCommerce.domain.product.relations.productAssocType;
...
import com.skytala.eCommerce.domain.product.relations.productAssocType.command.AddProductAssocType;
import com.skytala.eCommerce.domain.product.relations.productAssocType.command.DeleteProductAssocType;
import com.skytala.eCommerce.domain.product.relations.productAssocType.command.UpdateProductAssocType;
import com.skytala.eCommerce.domain.product.relations.productAssocType.event.ProductAssocTypeAdded;
import com.skytala.eCommerce.domain.product.relations.productAssocType.event.ProductAssocTypeDeleted;
import com.skytala.eCommerce.domain.product.relations.productAssocType.event.ProductAssocTypeFound;
import com.skytala.eCommerce.domain.product.relations.productAssocType.event.ProductAssocTypeUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productAssocType.query.FindProductAssocTypesBy;
