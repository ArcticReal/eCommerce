package com.skytala.eCommerce.domain.product.relations.inventoryItemLabel;
...
import com.skytala.eCommerce.domain.product.relations.inventoryItemLabel.command.AddInventoryItemLabel;
import com.skytala.eCommerce.domain.product.relations.inventoryItemLabel.command.DeleteInventoryItemLabel;
import com.skytala.eCommerce.domain.product.relations.inventoryItemLabel.command.UpdateInventoryItemLabel;
import com.skytala.eCommerce.domain.product.relations.inventoryItemLabel.event.InventoryItemLabelAdded;
import com.skytala.eCommerce.domain.product.relations.inventoryItemLabel.event.InventoryItemLabelDeleted;
import com.skytala.eCommerce.domain.product.relations.inventoryItemLabel.event.InventoryItemLabelFound;
import com.skytala.eCommerce.domain.product.relations.inventoryItemLabel.event.InventoryItemLabelUpdated;
...
import com.skytala.eCommerce.domain.product.relations.inventoryItemLabel.query.FindInventoryItemLabelsBy;
