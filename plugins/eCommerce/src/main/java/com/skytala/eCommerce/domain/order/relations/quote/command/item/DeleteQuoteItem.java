...
public class DeleteQuoteItem extends Command {

private String toBeDeletedId;
public DeleteQuoteItem(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("QuoteItem", UtilMisc.toMap("quoteItemId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new QuoteItemDeleted(success);
