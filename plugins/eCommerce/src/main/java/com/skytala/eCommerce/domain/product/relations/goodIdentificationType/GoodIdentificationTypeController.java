package com.skytala.eCommerce.domain.product.relations.goodIdentificationType;
...
import com.skytala.eCommerce.domain.product.relations.goodIdentificationType.command.AddGoodIdentificationType;
import com.skytala.eCommerce.domain.product.relations.goodIdentificationType.command.DeleteGoodIdentificationType;
import com.skytala.eCommerce.domain.product.relations.goodIdentificationType.command.UpdateGoodIdentificationType;
import com.skytala.eCommerce.domain.product.relations.goodIdentificationType.event.GoodIdentificationTypeAdded;
import com.skytala.eCommerce.domain.product.relations.goodIdentificationType.event.GoodIdentificationTypeDeleted;
import com.skytala.eCommerce.domain.product.relations.goodIdentificationType.event.GoodIdentificationTypeFound;
import com.skytala.eCommerce.domain.product.relations.goodIdentificationType.event.GoodIdentificationTypeUpdated;
...
import com.skytala.eCommerce.domain.product.relations.goodIdentificationType.query.FindGoodIdentificationTypesBy;
