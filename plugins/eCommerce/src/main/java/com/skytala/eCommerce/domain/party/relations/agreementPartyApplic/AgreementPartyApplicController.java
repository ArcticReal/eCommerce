package com.skytala.eCommerce.domain.party.relations.agreementPartyApplic;
...
import com.skytala.eCommerce.domain.party.relations.agreementPartyApplic.command.AddAgreementPartyApplic;
import com.skytala.eCommerce.domain.party.relations.agreementPartyApplic.command.DeleteAgreementPartyApplic;
import com.skytala.eCommerce.domain.party.relations.agreementPartyApplic.command.UpdateAgreementPartyApplic;
import com.skytala.eCommerce.domain.party.relations.agreementPartyApplic.event.AgreementPartyApplicAdded;
import com.skytala.eCommerce.domain.party.relations.agreementPartyApplic.event.AgreementPartyApplicDeleted;
import com.skytala.eCommerce.domain.party.relations.agreementPartyApplic.event.AgreementPartyApplicFound;
...
import com.skytala.eCommerce.domain.party.relations.agreementPartyApplic.query.FindAgreementPartyApplicsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/agreementPartyApplics")
