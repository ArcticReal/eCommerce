package com.skytala.eCommerce.domain.accounting.relations.paymentGlAccountTypeMap;
...
import com.skytala.eCommerce.domain.accounting.relations.paymentGlAccountTypeMap.command.AddPaymentGlAccountTypeMap;
import com.skytala.eCommerce.domain.accounting.relations.paymentGlAccountTypeMap.command.DeletePaymentGlAccountTypeMap;
import com.skytala.eCommerce.domain.accounting.relations.paymentGlAccountTypeMap.command.UpdatePaymentGlAccountTypeMap;
import com.skytala.eCommerce.domain.accounting.relations.paymentGlAccountTypeMap.event.PaymentGlAccountTypeMapAdded;
import com.skytala.eCommerce.domain.accounting.relations.paymentGlAccountTypeMap.event.PaymentGlAccountTypeMapDeleted;
...
import com.skytala.eCommerce.domain.accounting.relations.paymentGlAccountTypeMap.query.FindPaymentGlAccountTypeMapsBy;
...
//		paymentGlAccountTypeMapToBeUpdated.setnull(null);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{paymentGlAccountTypeMapId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{paymentGlAccountTypeMapId}")
