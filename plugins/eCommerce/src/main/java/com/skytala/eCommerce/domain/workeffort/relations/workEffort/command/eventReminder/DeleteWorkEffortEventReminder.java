...
public class DeleteWorkEffortEventReminder extends Command {

private String toBeDeletedId;
public DeleteWorkEffortEventReminder(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("WorkEffortEventReminder", UtilMisc.toMap("workEffortEventReminderId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new WorkEffortEventReminderDeleted(success);
