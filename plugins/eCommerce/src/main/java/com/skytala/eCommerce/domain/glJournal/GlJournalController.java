package com.skytala.eCommerce.domain.glJournal;
...
import com.skytala.eCommerce.domain.glJournal.command.AddGlJournal;
import com.skytala.eCommerce.domain.glJournal.command.DeleteGlJournal;
import com.skytala.eCommerce.domain.glJournal.command.UpdateGlJournal;
import com.skytala.eCommerce.domain.glJournal.event.GlJournalAdded;
import com.skytala.eCommerce.domain.glJournal.event.GlJournalDeleted;
import com.skytala.eCommerce.domain.glJournal.event.GlJournalFound;
import com.skytala.eCommerce.domain.glJournal.event.GlJournalUpdated;
...
import com.skytala.eCommerce.domain.glJournal.query.FindGlJournalsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/glJournals")
public class GlJournalController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{glJournalId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{glJournalId}")
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/glJournal/\" plus one of the following: "
				+ "";
