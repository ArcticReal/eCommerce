...
public class DeleteProtectedView extends Command {

private String toBeDeletedId;
public DeleteProtectedView(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProtectedView", UtilMisc.toMap("protectedViewId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProtectedViewDeleted(success);
