...
public class DeleteBudgetScenarioRule extends Command {

private String toBeDeletedId;
public DeleteBudgetScenarioRule(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("BudgetScenarioRule", UtilMisc.toMap("budgetScenarioRuleId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new BudgetScenarioRuleDeleted(success);
