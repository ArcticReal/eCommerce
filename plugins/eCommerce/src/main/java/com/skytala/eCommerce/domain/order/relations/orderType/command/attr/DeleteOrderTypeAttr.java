...
public class DeleteOrderTypeAttr extends Command {

private String toBeDeletedId;
public DeleteOrderTypeAttr(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderTypeAttr", UtilMisc.toMap("orderTypeAttrId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderTypeAttrDeleted(success);
