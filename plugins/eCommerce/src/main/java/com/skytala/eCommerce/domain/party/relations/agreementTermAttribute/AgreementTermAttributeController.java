package com.skytala.eCommerce.domain.party.relations.agreementTermAttribute;
...
import com.skytala.eCommerce.domain.party.relations.agreementTermAttribute.command.AddAgreementTermAttribute;
import com.skytala.eCommerce.domain.party.relations.agreementTermAttribute.command.DeleteAgreementTermAttribute;
import com.skytala.eCommerce.domain.party.relations.agreementTermAttribute.command.UpdateAgreementTermAttribute;
import com.skytala.eCommerce.domain.party.relations.agreementTermAttribute.event.AgreementTermAttributeAdded;
import com.skytala.eCommerce.domain.party.relations.agreementTermAttribute.event.AgreementTermAttributeDeleted;
import com.skytala.eCommerce.domain.party.relations.agreementTermAttribute.event.AgreementTermAttributeFound;
import com.skytala.eCommerce.domain.party.relations.agreementTermAttribute.event.AgreementTermAttributeUpdated;
...
import com.skytala.eCommerce.domain.party.relations.agreementTermAttribute.query.FindAgreementTermAttributesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/agreementTermAttributes")
public class AgreementTermAttributeController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{agreementTermAttributeId}")
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/{agreementTermAttributeId}")
