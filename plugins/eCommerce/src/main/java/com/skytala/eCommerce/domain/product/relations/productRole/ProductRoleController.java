package com.skytala.eCommerce.domain.product.relations.productRole;
...
import com.skytala.eCommerce.domain.product.relations.productRole.command.AddProductRole;
import com.skytala.eCommerce.domain.product.relations.productRole.command.DeleteProductRole;
import com.skytala.eCommerce.domain.product.relations.productRole.command.UpdateProductRole;
import com.skytala.eCommerce.domain.product.relations.productRole.event.ProductRoleAdded;
import com.skytala.eCommerce.domain.product.relations.productRole.event.ProductRoleDeleted;
import com.skytala.eCommerce.domain.product.relations.productRole.event.ProductRoleFound;
import com.skytala.eCommerce.domain.product.relations.productRole.event.ProductRoleUpdated;
...
import com.skytala.eCommerce.domain.product.relations.productRole.query.FindProductRolesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/productRoles")
public class ProductRoleController {
	...
	public boolean updateProductRole(HttpServletRequest request) throws Exception {
		...
		if (updateProductRole(productRoleToBeUpdated, null).getStatusCode()
...
//		productRoleToBeUpdated.setnull(null);
