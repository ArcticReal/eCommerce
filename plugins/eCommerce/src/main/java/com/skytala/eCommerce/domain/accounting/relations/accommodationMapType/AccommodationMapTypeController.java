package com.skytala.eCommerce.domain.accounting.relations.accommodationMapType;
...
import com.skytala.eCommerce.domain.accounting.relations.accommodationMapType.command.AddAccommodationMapType;
import com.skytala.eCommerce.domain.accounting.relations.accommodationMapType.command.DeleteAccommodationMapType;
import com.skytala.eCommerce.domain.accounting.relations.accommodationMapType.command.UpdateAccommodationMapType;
import com.skytala.eCommerce.domain.accounting.relations.accommodationMapType.event.AccommodationMapTypeAdded;
import com.skytala.eCommerce.domain.accounting.relations.accommodationMapType.event.AccommodationMapTypeDeleted;
import com.skytala.eCommerce.domain.accounting.relations.accommodationMapType.event.AccommodationMapTypeFound;
import com.skytala.eCommerce.domain.accounting.relations.accommodationMapType.event.AccommodationMapTypeUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.accommodationMapType.query.FindAccommodationMapTypesBy;
