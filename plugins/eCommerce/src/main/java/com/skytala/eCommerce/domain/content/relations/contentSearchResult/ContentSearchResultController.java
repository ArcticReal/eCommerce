package com.skytala.eCommerce.domain.content.relations.contentSearchResult;
...
import com.skytala.eCommerce.domain.content.relations.contentSearchResult.command.AddContentSearchResult;
import com.skytala.eCommerce.domain.content.relations.contentSearchResult.command.DeleteContentSearchResult;
import com.skytala.eCommerce.domain.content.relations.contentSearchResult.command.UpdateContentSearchResult;
import com.skytala.eCommerce.domain.content.relations.contentSearchResult.event.ContentSearchResultAdded;
import com.skytala.eCommerce.domain.content.relations.contentSearchResult.event.ContentSearchResultDeleted;
import com.skytala.eCommerce.domain.content.relations.contentSearchResult.event.ContentSearchResultFound;
import com.skytala.eCommerce.domain.content.relations.contentSearchResult.event.ContentSearchResultUpdated;
...
import com.skytala.eCommerce.domain.content.relations.contentSearchResult.query.FindContentSearchResultsBy;
