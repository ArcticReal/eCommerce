...
public class DeleteInventoryItemStatus extends Command {

private String toBeDeletedId;
public DeleteInventoryItemStatus(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("InventoryItemStatus", UtilMisc.toMap("inventoryItemStatusId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new InventoryItemStatusDeleted(success);
