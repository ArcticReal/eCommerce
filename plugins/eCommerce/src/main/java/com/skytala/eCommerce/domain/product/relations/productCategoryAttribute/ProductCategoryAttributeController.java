package com.skytala.eCommerce.domain.product.relations.productCategoryAttribute;
...
import com.skytala.eCommerce.domain.product.relations.productCategoryAttribute.command.AddProductCategoryAttribute;
import com.skytala.eCommerce.domain.product.relations.productCategoryAttribute.command.DeleteProductCategoryAttribute;
import com.skytala.eCommerce.domain.product.relations.productCategoryAttribute.command.UpdateProductCategoryAttribute;
import com.skytala.eCommerce.domain.product.relations.productCategoryAttribute.event.ProductCategoryAttributeAdded;
import com.skytala.eCommerce.domain.product.relations.productCategoryAttribute.event.ProductCategoryAttributeDeleted;
...
import com.skytala.eCommerce.domain.product.relations.productCategoryAttribute.query.FindProductCategoryAttributesBy;
