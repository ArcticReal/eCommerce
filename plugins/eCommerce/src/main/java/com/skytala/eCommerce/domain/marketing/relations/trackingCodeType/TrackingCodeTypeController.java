package com.skytala.eCommerce.domain.marketing.relations.trackingCodeType;
...
import com.skytala.eCommerce.domain.marketing.relations.trackingCodeType.command.AddTrackingCodeType;
import com.skytala.eCommerce.domain.marketing.relations.trackingCodeType.command.DeleteTrackingCodeType;
import com.skytala.eCommerce.domain.marketing.relations.trackingCodeType.command.UpdateTrackingCodeType;
import com.skytala.eCommerce.domain.marketing.relations.trackingCodeType.event.TrackingCodeTypeAdded;
import com.skytala.eCommerce.domain.marketing.relations.trackingCodeType.event.TrackingCodeTypeDeleted;
...
import com.skytala.eCommerce.domain.marketing.relations.trackingCodeType.query.FindTrackingCodeTypesBy;
