...
public class DeleteProductStoreGroupRole extends Command {

private String toBeDeletedId;
public DeleteProductStoreGroupRole(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductStoreGroupRole", UtilMisc.toMap("productStoreGroupRoleId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductStoreGroupRoleDeleted(success);
