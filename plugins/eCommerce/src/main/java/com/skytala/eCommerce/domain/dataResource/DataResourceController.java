package com.skytala.eCommerce.domain.dataResource;
...
import com.skytala.eCommerce.domain.dataResource.command.AddDataResource;
import com.skytala.eCommerce.domain.dataResource.command.DeleteDataResource;
import com.skytala.eCommerce.domain.dataResource.command.UpdateDataResource;
import com.skytala.eCommerce.domain.dataResource.event.DataResourceAdded;
import com.skytala.eCommerce.domain.dataResource.event.DataResourceDeleted;
...
import com.skytala.eCommerce.domain.dataResource.query.FindDataResourcesBy;
