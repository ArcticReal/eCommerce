...
public class DeleteProductSubscriptionResource extends Command {

private String toBeDeletedId;
public DeleteProductSubscriptionResource(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductSubscriptionResource", UtilMisc.toMap("productSubscriptionResourceId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductSubscriptionResourceDeleted(success);
