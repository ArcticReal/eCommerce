...
public class DeleteSurveyPage extends Command {

private String toBeDeletedId;
public DeleteSurveyPage(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("SurveyPage", UtilMisc.toMap("surveyPageId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new SurveyPageDeleted(success);
