package com.skytala.eCommerce.domain.product.relations.productCategoryContent;
...
import com.skytala.eCommerce.domain.product.relations.productCategoryContent.command.AddProductCategoryContent;
import com.skytala.eCommerce.domain.product.relations.productCategoryContent.command.DeleteProductCategoryContent;
import com.skytala.eCommerce.domain.product.relations.productCategoryContent.command.UpdateProductCategoryContent;
import com.skytala.eCommerce.domain.product.relations.productCategoryContent.event.ProductCategoryContentAdded;
import com.skytala.eCommerce.domain.product.relations.productCategoryContent.event.ProductCategoryContentDeleted;
import com.skytala.eCommerce.domain.product.relations.productCategoryContent.event.ProductCategoryContentFound;
...
import com.skytala.eCommerce.domain.product.relations.productCategoryContent.query.FindProductCategoryContentsBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/productCategoryContents")
...
//		productCategoryContentToBeUpdated.setnull(null);
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/productCategoryContent/\" plus one of the following: "
				+ "";
