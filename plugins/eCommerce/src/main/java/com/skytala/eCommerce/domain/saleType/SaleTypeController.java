package com.skytala.eCommerce.domain.saleType;
...
import com.skytala.eCommerce.domain.saleType.command.AddSaleType;
import com.skytala.eCommerce.domain.saleType.command.DeleteSaleType;
import com.skytala.eCommerce.domain.saleType.command.UpdateSaleType;
import com.skytala.eCommerce.domain.saleType.event.SaleTypeAdded;
import com.skytala.eCommerce.domain.saleType.event.SaleTypeDeleted;
import com.skytala.eCommerce.domain.saleType.event.SaleTypeFound;
import com.skytala.eCommerce.domain.saleType.event.SaleTypeUpdated;
import com.skytala.eCommerce.domain.saleType.mapper.SaleTypeMapper;
import com.skytala.eCommerce.domain.saleType.model.SaleType;
import com.skytala.eCommerce.domain.saleType.query.FindSaleTypesBy;
...
public class SaleTypeController {
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/saleType/\" plus one of the following: "
				+ "";
