package com.skytala.eCommerce.domain.accounting.relations.paymentGatewayPayPal;
...
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayPayPal.command.AddPaymentGatewayPayPal;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayPayPal.command.DeletePaymentGatewayPayPal;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayPayPal.command.UpdatePaymentGatewayPayPal;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayPayPal.event.PaymentGatewayPayPalAdded;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayPayPal.event.PaymentGatewayPayPalDeleted;
...
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayPayPal.query.FindPaymentGatewayPayPalsBy;
...
//		paymentGatewayPayPalToBeUpdated.setnull(null);
	...
	public ResponseEntity<Object> returnErrorPage(HttpServletRequest request) {
		...
		String returnVal = "Error 404: Page not found! Valid pages are: \"eCommerce/api/paymentGatewayPayPal/\" plus one of the following: "
				+ "";
