...
public class DeleteProductPromoProduct extends Command {

private String toBeDeletedId;
public DeleteProductPromoProduct(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("ProductPromoProduct", UtilMisc.toMap("productPromoProductId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new ProductPromoProductDeleted(success);
