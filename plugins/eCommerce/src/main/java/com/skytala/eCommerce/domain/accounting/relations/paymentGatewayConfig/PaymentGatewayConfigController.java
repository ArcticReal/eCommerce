package com.skytala.eCommerce.domain.accounting.relations.paymentGatewayConfig;
...
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayConfig.command.AddPaymentGatewayConfig;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayConfig.command.DeletePaymentGatewayConfig;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayConfig.command.UpdatePaymentGatewayConfig;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayConfig.event.PaymentGatewayConfigAdded;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayConfig.event.PaymentGatewayConfigDeleted;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayConfig.event.PaymentGatewayConfigFound;
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayConfig.event.PaymentGatewayConfigUpdated;
...
import com.skytala.eCommerce.domain.accounting.relations.paymentGatewayConfig.query.FindPaymentGatewayConfigsBy;
