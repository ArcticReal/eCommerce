...
public class DeletePartyIdentification extends Command {

private String toBeDeletedId;
public DeletePartyIdentification(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("PartyIdentification", UtilMisc.toMap("partyIdentificationId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new PartyIdentificationDeleted(success);
