...
public class DeleteGiftCard extends Command {

private String toBeDeletedId;
public DeleteGiftCard(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("GiftCard", UtilMisc.toMap("giftCardId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new GiftCardDeleted(success);
