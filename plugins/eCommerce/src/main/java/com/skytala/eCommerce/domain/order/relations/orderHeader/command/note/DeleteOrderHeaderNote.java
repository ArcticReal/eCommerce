...
public class DeleteOrderHeaderNote extends Command {

private String toBeDeletedId;
public DeleteOrderHeaderNote(String toBeDeletedId){
...
try{
int countRemoved = delegator.removeByAnd("OrderHeaderNote", UtilMisc.toMap("orderHeaderNoteId", toBeDeletedId));
if(countRemoved > 0) {
success = true;
}
else{
...
Event resultingEvent = new OrderHeaderNoteDeleted(success);
