package com.skytala.eCommerce.domain.marketing.relations.segmentGroupRole;
...
import com.skytala.eCommerce.domain.marketing.relations.segmentGroupRole.command.AddSegmentGroupRole;
import com.skytala.eCommerce.domain.marketing.relations.segmentGroupRole.command.DeleteSegmentGroupRole;
import com.skytala.eCommerce.domain.marketing.relations.segmentGroupRole.command.UpdateSegmentGroupRole;
import com.skytala.eCommerce.domain.marketing.relations.segmentGroupRole.event.SegmentGroupRoleAdded;
import com.skytala.eCommerce.domain.marketing.relations.segmentGroupRole.event.SegmentGroupRoleDeleted;
...
import com.skytala.eCommerce.domain.marketing.relations.segmentGroupRole.query.FindSegmentGroupRolesBy;
import com.skytala.eCommerce.framework.exceptions.RecordNotFoundException;
import com.skytala.eCommerce.framework.pubsub.Scheduler;

@RestController
@RequestMapping("/segmentGroupRoles")
public class SegmentGroupRoleController {
	...
	public boolean updateSegmentGroupRole(HttpServletRequest request) throws Exception {
		...
		if (updateSegmentGroupRole(segmentGroupRoleToBeUpdated, null).getStatusCode()
...
//		segmentGroupRoleToBeUpdated.setnull(null);
